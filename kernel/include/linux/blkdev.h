...
extern void blk_dio_ck(struct gendisk *target_disk,
	ktime_t dio_start, int dio_op, int dio_page_count);
extern void blk_mq_tagset_vl_setup(
...
static inline void blk_dio_ck(struct gendisk *target_disk,
	ktime_t dio_start, int dio_op, int dio_page_count)
{
}

static inline void blk_mq_tagset_vl_setup(
	struct blk_mq_tag_set *tag_set, u64 device_capacity)
{
}
#endif /* CONFIG_HISI_BLK */
