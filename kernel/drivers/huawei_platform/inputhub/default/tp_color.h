...
TCS3701_ALS_PARA_TABLE tcs3701_als_para_diff_tp_color_table[] = {
	...
	{ BAH3, V3, DEFAULT_TPLCD, BLACK,
	 { 100, 799, 1110, -299, -2352, 908, 0, 800, 536, -475, -98, -396,
	   ...
	   3210, 30000, 200 } },
	// BAH3 use tcs3701 device but transform tcs3707 parameter and use tcs3707 code
};
...
TSL2591_ALS_PARA_TABLE tsl2591_als_para_diff_tp_color_table[] = {
	...
	{ YAL, V3, BOE_TPLCD, BLACK,
	  { 2337, 1600, 6813, 11378, 2836, 37175, 65535, 500, 380, 180,
	...
	{ JEF, V3, TS_PANEL_UNKNOWN, OTHER,
	  { 2177, 1510, 7194, 12791, 6645, 18607, 0, 450, 380, 200, 691,
	    94, 53, 40, 103, 10000, 100, 150, 50, 25 }
	},
...
als_para_normal_table stk3338_als_para_diff_tp_color_table[] = {
	...
	{ CDY, V3, TM_TPLCD, STK3338_PARA_SIZE,
	  { 1000, 3000, 1800, 94, 117, 149, 10518, 7500, 200 }
	},
	{ CDY, V3, BOE_TPLCD, STK3338_PARA_SIZE,
	  { 1000, 7500, 3600, 270, 380, 748, 2107, 7500, 200 }
	},
	{ CDY, V3, CSOT_TPLCD, STK3338_PARA_SIZE,
	  { 1000, 7200, 3300, 357, 503, 779, 2024, 7500, 200 }
	},
...
als_para_normal_table ltr2568_als_para_diff_tp_color_table[] = {
	...
	{ CDY, V3, TM_TPLCD, LTR2568_PARA_SIZE,
	  { 150, 30, 406, 403, 363, 0, 5639, 477, 7500, 200 }
	},
	{ CDY, V3, BOE_TPLCD, LTR2568_PARA_SIZE,
	  { 700, 50, 99, 120, 127, 0, 1978, 252, 7500, 200 }
	},
	{ CDY, V3, CSOT_TPLCD, LTR2568_PARA_SIZE,
	  { 450, 50, 118, 185, 223, 0, 3454, 238, 7500, 200 }
	},
...
als_para_normal_table syh399_als_para[] = {
	{ TEL, V3, TCL_TPLCD, SYH399_PARA_SIZE,
	  { 2055, 23009, 20, 120, 300, 7422, 10000, 2680, 3856, 9004, 804, 10000, 100, 600, 230, 25 }
	},

	{ TEL, V3, TM_TPLCD, SYH399_PARA_SIZE,
	  { 2189, 24089, 20, 120, 300, 7413, 10000, 3605, 3356, 8450, 768, 10000, 100, 600, 230, 25 }
	},
