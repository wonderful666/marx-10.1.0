...
#define LPMCU_THERMAL_PARA_SIZE (0x100)
...
#define LPMCU_MODEM_SEC_SIZE (0x2400)
    ...
    #define MODEM_SERDES_BASE (AON_STORAGE_SOCP_BASE + AON_STORAGE_SOCP_SIZE)
    #define MODEM_SERDES_SIZE (0x8)
    #define MODEM_LR_UPVOLT_EFUSE_FLAG_BASE (MODEM_SERDES_BASE + MODEM_SERDES_SIZE)
    #define MODEM_LR_UPVOLT_EFUSE_FLAG_SIZE (0x8)
    #define MODEM_PARA_BASE (MODEM_LR_UPVOLT_EFUSE_FLAG_BASE + MODEM_LR_UPVOLT_EFUSE_FLAG_SIZE)
...
#define LPMCU_DDR_DATA_SEC_SIZE (0xA800)
    ...
    #define DDR_TRAINNING_SIZE (0x6500)
    ...
    #define DDR_DMSS_AXI_SIZE (0x520)
...
#define AON_SYS_RESERVED_SIZE (0x00)
#define AON_SYS_SIZE (0xB000 - AON_SYS_RESERVED_SIZE)
...
#define SYS_CODE_SEC_RESERVED_SIZE (0x600)
#define SYS_CODE_SEC_SIZE (0x1F800-SYS_CODE_SEC_RESERVED_SIZE)
#define INT_TSK_BACKUP_BASE (SYS_CODE_SEC_BASE + SYS_CODE_SEC_SIZE + SYS_CODE_SEC_RESERVED_SIZE)
#define INT_TSK_BACKUP_SIZE (0x1000)
#define SYS_BSS_SEC_BASE (INT_TSK_BACKUP_BASE + INT_TSK_BACKUP_SIZE)
#define SYS_BSS_SEC_RESERVED_SIZE (0x400)
#define SYS_BSS_SEC_SIZE (0x6000-SYS_BSS_SEC_RESERVED_SIZE)
...
#define LPMCU_DDR_MNTN_SIZE (0x1400)
    ...
    #define DDRC_SAVE_TMP_SIZE (0x120)
...
#endif
#if ((LPMCU_DDR_MNTN_BASE + LPMCU_DDR_MNTN_SIZE) > (M3_SRAM_BASE + 288*1024))
