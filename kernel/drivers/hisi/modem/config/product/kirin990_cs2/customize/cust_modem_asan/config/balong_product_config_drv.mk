# MD5: 0c031bfa05329d756f9f86af9e188fc4
CFG_ENABLE_BUILD_VARS := YES
CFG_FEATURE_UPGRADE_TL := YES
CFG_PRODUCT_NAME                      :="kirin990_cs2"
CFG_PRODUCT_CFG_CHIP_SOLUTION_NAME    :="Balong"
CFG_CCPU_OS                           := RTOSCK_SMP
CFG_HCC_VERSION                       := 7.3
CFG_PLATFORM := kirin990_cs2
CFG_PLATFORM_HISI_BALONG :=kirin990_cs2
CFG_CONFIG_VERSION_STUB             :=NO
CFG_HW_VERSION_STUB                 :=0x36F5FC42
...
CFG_TLPHY_IMAGE_LOAD_ADDR_ATE := 0x87000000
CFG_TLPHY_IMAGE_LOAD_SIZE_ATE := 0x400000
...
CFG_HAC_LLRAM_SIZE := 0x180000
CFG_HAC_LLRAM_UNCACHED_SIZE := 0xC0000
...
CFG_NRCCPU_LLRAM_BASE_SIZE := 0x000A0000
CFG_NRCCPU_SRAM_SIZE  := 0x2800
...
CFG_FEATURE_SOCP_VIC := NO
CFG_SOCP_DECODE_ENABLE := NO
CFG_CONFIG_VER_3_TLBBP_DS_BOSTON_AND_LATER := YES
...
CFG_CONFIG_DDRC_AUTOGT_BYPASS := YES
...
CFG_CONFIG_PERF_STAT_DEBUG := NO
CFG_CONFIG_AXIMEM_BALONG := YES
...
CFG_CONFIG_EICC_V110 := YES
CFG_CONFIG_EICC_DEBUG := YES
...
CFG_DDR_NRPHY_IMAGE_SIZE  := 0x800000
...
CFG_DDR_SDR_NR_SIZE       := 0x1400000
CFG_DDR_CBBE_IMAGE_SIZE   := 0x0
CFG_DDR_HARQ_UP_SIZE      := 0xC0000
CFG_DDR_HARQ_NRUL_SIZE    := 0x180000
...
CFG_DDR_MAA_MDM_SIZE      := 0x1A00000
CFG_DDR_FULLSTACK_MEM_SIZE := 0x500000
CFG_DDR_LPMCU_IMAGE_SIZE  := 0x40000
CFG_DDR_EMU_HAC_LOAD_SIZE         := 0x180000
CFG_DDR_MTD_MEM_SIZE      := 0x0
CFG_DDR_MCORE_UNCACHE_SIZE:=0x04000000
...
CFG_DDR_LRCCPU_DTS_SIZE := 0x60000
CFG_DDR_LPMCU_DTS_SIZE := 0x60000
CFG_DDR_NRCCPU_DTS_SIZE := 0x60000
CFG_DDR_L2CPU_DTS_SIZE := 0x60000
CFG_DDR_MDTS_TOTAL_SIZE := $(CFG_DDR_LRCCPU_DTS_SIZE) + $(CFG_DDR_LPMCU_DTS_SIZE) + $(CFG_DDR_NRCCPU_DTS_SIZE) + $(CFG_DDR_L2CPU_DTS_SIZE)
...
CFG_MODEM_SANITIZER_ADDR_OFFSET:=0xBE00000
CFG_MODEM_SANITIZER_NR_ADDR_OFFSET:=0xEAC0000
CFG_MDM_SANTIZIER_MEM_SIZE:=0x04000000
CFG_MDM_SANTIZIER_NR_MEM_SIZE:=0x00800000
...
CFG_SHM_SIZE_HAC_PM                 := (DDR_SHA_SEC_MEM_SIZE - SHA_SEC_ICC_DDR_SIZE - SHM_SIZE_NR_PM)
