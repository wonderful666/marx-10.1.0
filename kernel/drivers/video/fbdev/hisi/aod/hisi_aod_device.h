...
#define AOD_IOCTL_AOD_SET_DIAL_DYNAMIC_FB	_IOW(0xB2, 0x11, unsigned long)
#define AOD_IOCTL_AOD_FREE_BUF_DIAL_DYNAMIC_FB	_IOW(0xB2, 0x12, unsigned long)
#define AOD_IOCTL_AOD_GET_DIAL_DYNAMIC_FB_FLAG	_IOW(0xB2, 0x13, unsigned long)
#endif
...
#if defined(CONFIG_HISI_FB_V510) || defined(CONFIG_HISI_FB_V350) || defined(CONFIG_HISI_FB_V501)
...
typedef struct aod_config_info_mcu {
	...
	int32_t fp_count;
#if defined(CONFIG_HISI_FB_V501)
	uint32_t dial_fb_offset;
	uint32_t dial_fb_size;
	uint32_t dial_fb_addr;
#endif
...
#if defined(CONFIG_HISI_FB_V501)
	unsigned long extra_smem_size;
	bool dail_fb_mem_flag;
#endif
};
#endif
