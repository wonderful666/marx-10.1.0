...
__attribute__((weak)) int hisifb_esd_recover_disable(int value)
{
	return 0;
}
...
__attribute__((weak)) int hisi_charger_type_notifier_register(
	struct notifier_block *nb)
{
	return 0;
}

__attribute__((weak)) int hisi_charger_type_notifier_unregister(
	struct notifier_block *nb)
{
	return 0;
}

__attribute__((weak)) enum hisi_charger_type hisi_get_charger_type(void)
{
	return 0;
}
