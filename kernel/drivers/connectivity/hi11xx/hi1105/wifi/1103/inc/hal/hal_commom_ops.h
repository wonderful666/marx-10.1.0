...
#define HAL_SNIFFER_RX_DSCR_TH      350
#endif
...
#if (((((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1105_DEV)))) ||  \
     (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST))
#define HAL_VAP_ID_IS_VALID(_vap_id) \
    (((_vap_id) == 0) || ((_vap_id) == 1) || ((_vap_id) == 2) || ((_vap_id) == 3) || ((_vap_id) == 4))
#else
...
typedef enum {
    HAL_BTCOEX_SCO_PRIORITY_HIGH = 0,           /* BT SCO业务全部高优先级 */
    HAL_BTCOEX_SCO_PRIORITY_RETRY_MIDDLE = 1,   /* BT SCO业务重传帧中优先级 */
    HAL_BTCOEX_SCO_PRIORITY_PART_MIDDLE = 2,    /* BT SCO业务部分帧中优先级 */
    HAL_BTCOEX_SCO_20DBM_BLACKLIST = 3,         /* BT SCO业务不进20dbm */

    HAL_BTCOEX_SCO_PRIORITY_BUTT
} hal_coex_sco_priority_enum;
typedef oal_uint8 hal_coex_sco_priority_enum_uint8;
...
typedef enum {
    ...
    HAL_P2P_FIX_FREQ_TYPE_SINK = BIT2,
    HAL_BTCOEX_FIX_FREQ_TYPE_SCO = BIT3,

    HAL_BTCOEX_FIX_FREQ_TYPE_BUTT
} hal_fix_freq_type_enum;
typedef oal_uint8 hal_fix_freq_type_enum_uint8;
...
#define HAL_POW_RATE_POW_CODE_TABLE_5G_LEN (HAL_POW_11B_RATE_NUM + HAL_POW_11G_RATE_NUM + \
    HAL_POW_11AC_20M_NUM + HAL_POW_11AC_40M_NUM + \
    HAL_POW_11AC_80M_NUM + HAL_POW_11AC_160M_NUM) /* rate-tpccode table中速率个数 */
/* mcs32 rate idx值 */
#define HAL_POW_RATE_MCS32_IDX    \
    (HAL_POW_11B_RATE_NUM + HAL_POW_11G_RATE_NUM + HAL_POW_11AC_20M_NUM + HAL_POW_11AC_40M_NUM - 1)
#define HAL_POW_11AX_RATE_NUM     (12)
#define HAL_160M_MCS_PRE_RATE_NUM \
    (HAL_POW_11B_RATE_NUM + HAL_POW_11G_RATE_NUM + HAL_POW_11AC_20M_NUM + HAL_POW_11AC_40M_NUM + HAL_POW_11AC_80M_NUM)
#define HAL_80M_MCS_PRE_RATE_NUM  \
    (HAL_POW_11B_RATE_NUM + HAL_POW_11G_RATE_NUM + HAL_POW_11AC_20M_NUM + HAL_POW_11AC_40M_NUM)
...
#define HAL_VAP_ID_IS_VALID_PSTA(_vap_id) \
    (((_vap_id) < WLAN_HAL_OHTER_BSS_ID) || \
    (((_vap_id) >= WLAN_PROXY_STA_START_ID) && ((_vap_id) <= WLAN_PROXY_STA_END_ID)))
...
/* PHY相关的定制化能力 */
#define HAL_PHY_CAP_POWER_GATING_MASK      0x1
#define HAL_PHY_CAP_POWER_SAVING_OFFSET    1
#define HAL_PHY_CAP_POWER_SAVING_MASK      0x2
#define HAL_PHY_CAP_INTERLEAVED_ADC_OFFSET 2
#define HAL_PHY_CAP_INTERLEAVED_ADC_MASK   0x4
#define HAL_PHY_CAP_MANUAL_FOC_SCO_MASK    0x8
#define HAL_PHY_CAP_40M_MODE_160M_FS       0x10
#define HAL_PHY_CAP_11B_DOUBLE_CHAIN       0x20
...
#define HAL_POW_LPF_BASE_IDX(_en_band) \
    (((_en_band) == WLAN_BAND_2G) ? HAL_POW_2G_LPF_BASE_IDX : HAL_POW_5G_LPF_BASE_IDX) /* 基准LPF Index */
#define HAL_POW_DAC_BASE_IDX(_en_band) \
    (((_en_band) == WLAN_BAND_2G) ? HAL_POW_2G_DAC_BASE_IDX : HAL_POW_5G_DAC_BASE_IDX) /* 基准DAC Index */
...
/* Trailor上报phase绝对偏差最大值 */
#define HI1103_PHASE_DET_REFINE_PHASE_FACTOR 100
#define HI1103_PHASE_DET_REFINE_PHASE_MAX (160  * HI1103_PHASE_DET_REFINE_PHASE_FACTOR)
#endif

#if ((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1105_DEV))
#ifdef _PRE_WLAN_110X_PILOT
#define HAL_GET_DPD_ENABLE_FROM_POW_CODE(_ul_pow_code) \
    ((oal_uint8)(OAL_GET_BITS((_ul_pow_code), NUM_1_BITS, BIT_OFFSET_22)))
#define HAL_GET_DELTA_DBB_SCALING_FROM_POW_CODE(_ul_pow_code) \
    ((oal_uint16)(OAL_GET_BITS((_ul_pow_code), NUM_10_BITS, BIT_OFFSET_12)))
#define HAL_GET_DAC_GAIN_LVL_FROM_POW_CODE(_ul_pow_code) \
    ((oal_uint8)(OAL_GET_BITS((_ul_pow_code), NUM_2_BITS, BIT_OFFSET_10)))
#define HAL_GET_PA_GAIN_LVL_FROM_POW_CODE(_ul_pow_code) \
    ((oal_uint8)(OAL_GET_BITS((_ul_pow_code), NUM_2_BITS, BIT_OFFSET_8)))
#define HAL_GET_LPF_GAIN_LVL_FROM_POW_CODE(_ul_pow_code) \
    ((oal_uint8)(OAL_GET_BITS((_ul_pow_code), NUM_3_BITS, BIT_OFFSET_5)))
#define HAL_GET_UPC_GAIN_LVL_FROM_POW_CODE(_ul_pow_code) \
    ((oal_uint8)(OAL_GET_BITS((_ul_pow_code), NUM_1_BITS, BIT_OFFSET_4)))
#define HAL_GET_CFR_IDEX_FROM_POW_CODE(_ul_pow_code) \
    ((oal_uint8)(OAL_GET_BITS((_ul_pow_code), NUM_2_BITS, BIT_OFFSET_2)))
#define HAL_GET_DPD_TPC_LVL_FROM_POW_CODE(_ul_pow_code) \
    ((oal_uint8)(OAL_GET_BITS((_ul_pow_code), NUM_2_BITS, BIT_OFFSET_0)))
...
#define HAL_POW_CODE_COMB(_uc_upc_idx, _uc_lpf_idx, _uc_pa_idx, \
                          _uc_dac_idx, _uc_dbb_scale2_c0_idx, _uc_dbb_scale2_c1_idx) \
    ((((oal_uint32)(_uc_upc_idx) & 0x1f) | (((oal_uint32)(_uc_lpf_idx) & 0x7) << 5) |  \
         (((oal_uint32)(_uc_pa_idx) & 0x3) << 8) | (((oal_uint32)(_uc_dac_idx) & 0x3) << 10) |  \
         (((oal_uint32)(_uc_dbb_scale2_c0_idx) & 0xf) << 12) | (((oal_uint32)(_uc_dbb_scale2_c1_idx) & 0xf) << 16)) & \
        0xfffff)
...
#define HAL_POW_FILL_UPC_DATA_REG(_uc_data1, _uc_data2, _uc_data3, _uc_data4) \
    (((oal_uint32)((_uc_data1) << (oal_uint32)24)) | ((oal_uint32)((_uc_data2) << (oal_uint32)16)) | \
    ((oal_uint32)(_uc_data3) << (oal_uint32)8) | (_uc_data4))
...
#define GET_RSSI_MIN(_c_rssi_ant0, _c_rssi_ant1)      \
    ((OAL_RSSI_INIT_VALUE == (_c_rssi_ant0)) ? \
    (_c_rssi_ant1) : (OAL_RSSI_INIT_VALUE == (_c_rssi_ant1)) ? \
    (_c_rssi_ant0) : OAL_MIN((_c_rssi_ant0), (_c_rssi_ant1)))
...
#define GET_DEV_RX_DSCR_AVRG_PKTS(_pst_hal_dev, _uc_queue_id) \
    ...
    0 : (GET_DEV_RX_DSCR_AVRAGE_PKTS(_pst_hal_dev, _uc_queue_id)))

#define GET_DEV_RX_DSCR_THRES(_pst_hal_dev, _uc_queue_id)                                         \
    (((alg_rx_dscr_ctl_alg_info_stru *)((_pst_hal_dev)->st_rx_dscr_ctl.pst_rx_dscr_ctl_alg_info + \
                                        (_uc_queue_id)))->us_rx_dscr_alg_thres)
...
#define HAL_DEV_GET_PER_RATE_MAX_POW_CTRL(_pst_hal_dev, _uc_rate_idx, _en_freq_band, _uc_subband_idx) \
    ((oal_uint8)(((HAL_DEV_GET_TX_PWR_CTRL(_pst_hal_dev)).pst_max_tx_pow_per_rate_ctrl->auc_rate_max_tx_pow_ctrl_table[OAL_MIN(HAL_POW_RATE_CODE_TBL_LEN - 1, _uc_rate_idx)][(_en_freq_band)]) \
...
/* 获取tpc档位对应的目标功率增益 */
#define HAL_DEV_GET_IDX_TARGET_POW_GAIN(_pst_hal_dev, _pow_idx, _freq_band) \
    ((HAL_DEV_GET_TX_PWR_CTRL(_pst_hal_dev)).pst_tpc_lvl_vs_gain_ctrl->as_pow_level_table[(_pow_idx)][(_freq_band)])
...
/* 设置tpc档位对应的实际功率增益 */
#define HAL_DEV_SET_PER_RATE_TPC_GAIN_BY_LVL(_pst_hal_dev, _en_freq_band, _rate_idx, _pow_idx, _s_pow_gain) \
    do { \
        if (WLAN_BAND_2G == (_en_freq_band)) { \
            (HAL_DEV_GET_TX_PWR_CTRL(_pst_hal_dev).pst_rate_pow_table_2g[(_rate_idx)].as_pow_gain_level[(_pow_idx)]) = \
                (oal_int16)(_s_pow_gain); \
        } else { \
            (HAL_DEV_GET_TX_PWR_CTRL(_pst_hal_dev).pst_rate_pow_table_5g[(_rate_idx)].as_pow_gain_level[(_pow_idx)]) = \
                (oal_int16)(_s_pow_gain); \
        }  \
    } while (0)
...
#define HAL_DEV_SET_PER_RATE_MAX_POW_CTRL(_pst_hal_dev, _uc_rate_idx, _en_freq_band) \
    ((HAL_DEV_GET_TX_PWR_CTRL(_pst_hal_dev)).pst_max_tx_pow_per_rate_ctrl->auc_rate_max_tx_pow_ctrl_table[OAL_MIN(HAL_POW_RATE_CODE_TBL_LEN - 1, _uc_rate_idx)][(_en_freq_band)])

/* 计算PAPA=5.5时，对应的功率补偿值 单位0.1dBm */
/*
 * 根据实验室测试数据，一次拟合得到计算功率偏差公式0.25+0.03*delt_power，
 * 推导对应6M&MCS0有如下功率补偿值计算公式，小于-0.5dB时不需要补偿
 */
#define HAL_DEV_CFR_GET_COMPSEN_BY_DELTPOW(_c_delt_pow) \
    ((oal_uint8)(((_c_delt_pow) < -5) ? 0 : (((3 * (_c_delt_pow) + 25) + 5) / 10)))
...
#define HAL_AC_TO_Q_NUM(_ac) ( \
    ((_ac) == WLAN_WME_AC_VO) ? HAL_TX_QUEUE_VO : ((_ac) == WLAN_WME_AC_VI) ? \
    HAL_TX_QUEUE_VI : ((_ac) == WLAN_WME_AC_BK) ? HAL_TX_QUEUE_BK : ((_ac) == WLAN_WME_AC_BE) ? \
    HAL_TX_QUEUE_BE : ((_ac) == WLAN_WME_AC_MGMT) ? HAL_TX_QUEUE_HI : ((_ac) == WLAN_WME_AC_PSM) ? \
    HAL_TX_QUEUE_MC : HAL_TX_QUEUE_BK)
#else
#define HAL_AC_TO_Q_NUM(_ac) ( \
    ((_ac) == WLAN_WME_AC_VO) ? HAL_TX_QUEUE_VO : ((_ac) == WLAN_WME_AC_VI) ? \
    HAL_TX_QUEUE_VI : ((_ac) == WLAN_WME_AC_BK) ? HAL_TX_QUEUE_BK : ((_ac) == WLAN_WME_AC_BE) ? \
    HAL_TX_QUEUE_BE : ((_ac) == WLAN_WME_AC_MGMT) ? HAL_TX_QUEUE_HI : HAL_TX_QUEUE_BK)
#endif

#ifndef _PRE_WLAN_MAC_BUGFIX_MCAST_HW_Q
#define HAL_Q_NUM_TO_AC(_q) ( \
    ((_q) == HAL_TX_QUEUE_VO) ? WLAN_WME_AC_VO : ((_q) == HAL_TX_QUEUE_VI) ? \
    WLAN_WME_AC_VI : ((_q) == HAL_TX_QUEUE_BK) ? WLAN_WME_AC_BK : ((_q) == HAL_TX_QUEUE_BE) ? \
    WLAN_WME_AC_BE : ((_q) == HAL_TX_QUEUE_HI) ? WLAN_WME_AC_MGMT : ((_q) == HAL_TX_QUEUE_MC) ? \
    WLAN_WME_AC_PSM : WLAN_WME_AC_BE)
#else
#define HAL_Q_NUM_TO_AC(_q) ( \
    ((_q) == HAL_TX_QUEUE_VO) ? WLAN_WME_AC_VO : ((_q) == HAL_TX_QUEUE_VI) ? \
    WLAN_WME_AC_VI : ((_q) == HAL_TX_QUEUE_BK) ? WLAN_WME_AC_BK : ((_q) == HAL_TX_QUEUE_BE) ? \
    WLAN_WME_AC_BE : ((_q) == HAL_TX_QUEUE_HI) ? WLAN_WME_AC_MGMT : WLAN_WME_AC_BE)
#endif
...
typedef enum {
    ...
    /* 收到sounding帧，矩阵长度错误（矩阵长度为0，或者矩阵长度比bfrp里指示的长度大） */
    HAL_MAC_ERROR_SOUND_MATRIX_LEN_ERR = 54,
#endif
...
typedef enum {
    ...
    HAL_EVENT_DMAC_MISC_ALG_ANTI_INFI_TBTT,
#endif
#ifdef _PRE_WLAN_FEATURE_BTCOEX
    HAL_EVENT_DMAC_BT_ON_OFF,
#endif
...
typedef enum {
    HAL_DEBUG_TX_ENCAP_AMPDU = BIT0,

    HAL_DEBUG_BUTT,
} hal_debug_bitmap_enum;
typedef oal_uint8 hal_debug_bitmap_enum_uint8;
...
/* 7.0 寄存器配置结构 */
/*lint -e958*/
#if (_PRE_WLAN_CHIP_VERSION == _PRE_WLAN_CHIP_UT) /* End of _PRE_WLAN_CHIP_FPGA_HI1101RF */
...
typedef struct {
    ...
    /* 如果是本设备或者对端设备不是VHT设备，或者寄存器设置的速率为non-HT速率，那么该字段无意义（可填0) */
    oal_uint8 dyn_bandwidth_in_non_ht;
    /* 如果本设备和对端设备都为VHT设备，并且寄存器设置的速率为non-HT速率，那么该字段填1 */
...
#ifdef _PRE_WLAN_FEATURE_HIEX
    oal_uint32 ul_tx_himit_flag;
    oal_uint32 ul_tx_himit_dscr_addr;
    hiex_tx_himit_dscr_stru st_hiex_tx_himit_dscr; /* himit描述符地址 */
#endif
...
*****************************************************************************/
typedef struct {
    hal_rate_pow_code_gain_tbl_stru *pst_rate_pow_table; /* 速率-TPC code&TPC gain对应表 */
#ifndef _PRE_WLAN_FEATURE_TPC_OPT
...
*****************************************************************************/
typedef struct {
    hal_rate_pow_code_gain_tbl_stru *pst_rate_pow_table; /* EVM功率表单结构体指针 */
...
struct mac_rx_ctl {
    ...
    oal_uint8 bit_hiex_traced : 1; /* 用于标记hiex帧 */
    oal_uint8 bit_tid : 1;
...
typedef struct {
    ...
    // 每个20M空闲功率时间统计上报(对应p2m_per_20m_cca_st[0] ~ p2m_per_20m_cca_st[7]),单位:51.2us
    oal_uint32 auc_free_chn_per20m_time[8];
...
#define RADAR_MIN_ETSI_CHIRP_PULSE_NUM 4  /* ETSI chirp最小脉冲个数 */
...
typedef struct {
    ...
    oal_uint8 auc_5g_cali_upc_code[WLAN_RF_CHANNEL_NUMS][WLAN_5G_CALI_SUB_BAND_NUM]; /* 5G校准的UPC Code(区分20M 80M) */
...
typedef struct {
    ...
    /* 记录当前信道的扫描次数，第一次发送广播ssid的probe req帧，后面发送指定ssid的probe req帧 */
    oal_uint8 uc_curr_channel_scan_count;
...
typedef oal_void (*p_dmac_scan_one_channel_start_cb)(struct tag_hal_to_dmac_device_stru *pst_hal_device,
...
typedef struct {
    wlan_m2s_mode_ext_stru st_m2s_ext_mode;
} hal_m2s_fsm_rom_stru;
...
typedef struct {
    ...
    /* 20M/40M/80M/160M分别定义不同值，2g80M/160M不使用,便于处理保留 */
    hal_nrcoex_wifi_intf_judge_tbl_stru ast_intf_judge_tbl[NRCOEX_INI_TBL_BANDWIDTH_NUM];
...
typedef struct {
    ...
    /* WiFi发给Modem的优先级(由于RSSI高时发送的优先级和wifi侧优先级不同) */
    hal_nrcoex_wifi_priority_enum_uint8 en_modem_priority;
...
typedef struct {
    ...
    oal_uint8 uc_ac_suspend_bitmap; /* UL OFDMA时,哪些AC支持suspend */
    oal_uint8 uc_ac_alg_priv;   /* HIEX私有对通时针对每个AC的速率选择优化 */
#else
...
#ifdef _PRE_WLAN_FEATURE_TPC_OPT
typedef struct {
    oal_uint8 auc_rate_max_tx_pow_ctrl_table[HAL_POW_RATE_CODE_TBL_LEN][WLAN_BAND_BUTT];
    oal_uint8 auc_rev[2];
...
#pragma pack(push, 1)
typedef union {
    oal_uint32 ul_tb_max_pow_val;
    struct {
        oal_uint8 uc_tb_bw;            /*  TB PPDU的RU bw */
        oal_uint8 uc_ru_size;          /*  TB PPDU的RU */
        oal_uint8 uc_tb_su_max_pow;    /*  TB PPDU的MCS POW */
        oal_uint8 uc_rsv;
    } st_tb_max_pow_params;
} hal_tb_max_pow_params_union;
#endif
...
typedef struct {
...
#ifdef _PRE_WLAN_110X_PILOT
#if (_PRE_PRODUCT_ID ==_PRE_PRODUCT_ID_HI1103_DEV)
    oal_uint16 aus_resv[NUM_OF_NV_MAX_TXPOWER - 8]; // 预留长度2*(NUM_OF_NV_MAX_TXPOWER - 8)
#else
    oal_uint16 aus_resv[NUM_OF_NV_MAX_TXPOWER - 11]; // 预留长度2*(NUM_OF_NV_MAX_TXPOWER - 11)
#if defined(_PRE_WLAN_FEATURE_11AX)
    hal_tb_max_pow_params_union  un_tb_max_pow_param;
    /* 取LLTF在频域的量化到20M的RSSI用于tb功率计算 */
    oal_int8 c_ant0_lltf_rssi;
    oal_int8 c_ant1_lltf_rssi;
#endif
#endif
    ...
    hal_rate_pow_code_gain_tbl_stru *pst_rate_pow_table_2g;
    hal_rate_pow_code_gain_tbl_stru *pst_rate_pow_table_5g;
...
typedef struct {
    oal_uint8 bit_ps_on : 1,          /* ps软件机制: 0=关闭, 1=打开 */
              ...
              bit_ps_slot_detect : 1, /* 是否使能动态slot探测功能，delba逻辑触发速率达到标准时打开vap侧 0不使能,1使能 */
              bit_btcoex_wl0_tx_slv_on : 1, /* btcoex下wl0 tx slv配置开关 */
              bit_sco_priority: 2;        /* btcoex下bt sco业务优先级 0:高优先级 1:重传帧中优先级 2:部分帧中优先级 */
...
typedef struct {
    ...
    oal_bool_enum_uint8 en_delay_swi_miso_hold;
    ...
    oal_bool_enum_uint8 en_modem_on;
    oal_bool_enum_uint8 en_modem_siso_cmd_on;
...
typedef struct {
    ...
    hal_coex_s2m_mode_bitmap_stru st_s2m_mode_bitmap;
    /* 需要切回mimo的超时处理函数里面才用此bit来清m2s标记，防止ldac结束时，6slot来了又切siso流程 */
    hal_coex_s2m_mode_bitmap_stru st_s2m_wait_bitmap;

    oal_bool_enum_uint8 en_ps_occu_down_delay; /* ps帧occu拉低是否需要有动态slot来拉低 */
    oal_bool_enum_uint8 en_log_print_on;       /* slot detect日志打印是否开启 */
    oal_uint8 uc_btcoex_tx_max_aggr_num;       /* 用于c1 siso切换场景下wifi上行ldac和6slot下限制聚合个数，提高兼容性 */
...
typedef struct {
    ...
    oal_uint32  ul_rx_su_ppdu_cnt;                      /* SU PPDU接收帧总数 */
    oal_uint32  ul_rx_er_su_ppdu_cnt;                   /* ER SU PPDU接收帧总数 */
} dmac_rx_frame_statistics_stru;

/* 发送端数据统计结构体 */
typedef struct {
    oal_uint32  ul_tx_frame_succ_not_tb_cnt;        /* 发送成功的非tb帧 */
    oal_uint32  ul_tx_frame_succ_tb_all_mpdu_cnt;   /* 发送成功的tb帧,且全部聚合包已发送 */
    oal_uint32  ul_tx_frame_succ_tb_part_mpdu_cnt;  /* 发送成功的tb帧,只有部分聚合包发送 */
    oal_uint32  ul_tx_frame_fail_not_tb_cnt;        /* 发送失败的非tb帧 */
    oal_uint32  ul_tx_frame_fail_tb_all_mpdu_cnt;   /* 发送失败的tb帧,且全部聚合包已发送 */
    oal_uint32  ul_tx_frame_fail_tb_part_mpdu_cnt;  /* 发送失败的tb帧,只有部分聚合包发送 */
    oal_uint32  ul_retx_tb_ppdu_cnt;                /* TB PPDU的重传次数 */
    oal_uint32  ul_tx_su_ppdu_cnt;                  /* SU PPDU的发送次数 */
    oal_uint32  ul_retx_su_ppdu_cnt;                /* SU PPDU的重传次数 */
    oal_uint32  ul_tx_er_su_ppdu_cnt;               /* ER PPDU的发送次数 */
    oal_uint32  ul_retx_er_su_ppdu_cnt;             /* ER PPDU的重传次数 */
    oal_uint32  ul_tx_drop_ppdu_cnt;                /* 报文丢弃个数 */
...
typedef union {
    ...
    struct {
        ...
        oal_uint16  us_ul_bw          : 2;
        oal_uint16  us_ltf_gi_type    : 2;       /* AP指定gi */
        oal_uint16  us_mcs            : 4;       /* AP指定mcs */
        oal_uint16  us_nss            : 3;       /* AP指定nss */
        oal_uint16  us_ru_type        : 3;       /* AP指定ru size */
        oal_uint16  us_ltf_num        : 2;       /* AP指定ltf num */
    }st_basic_trig_para;
} hal_tx_ul_ofdma_para_stru;

typedef struct {
oal_uint64 bit_trigger_type : 4,
           bit_ul_length : 12,
           bit_more_tf : 1,
           bit_cs_required : 1,
           bit_ul_bw : 2,
           bit_gi_and_ltf_type : 2,
           bit_mu_mimo_ltf_mode : 1,
           bit_number_of_he_ltf_symbols : 3,
           bit_ul_stbc : 1,
           bit_ldpc_extra_symbol_segment : 1,
           bit_ap_tx_power : 6,
           bit_pre_fec_padding_factor : 2,
           bit_pe_disambiguity : 1,
           bit_ul_spatial_reuse : 16,
           bit_doppler : 1,
           bit_ul_he_sig_a2_reserved : 9,
           bit_reserved : 1;
} hal_trig_common_info_field_stru;

typedef struct {
oal_uint64 bit_aid12 : 12,
           bit_ru_channel_offset : 1,
           bit_ru_allocation : 7,
           bit_ul_fec_coding_type : 1,
           bit_ul_mcs : 4,
           bit_ul_dcm : 1,
           bit_ss_allocation : 3,
           bit_nss : 3,
           bit_ul_target_rssi : 7,
           bit_reserved : 25;
...
#ifdef _PRE_WLAN_FEATURE_HIEX
typedef struct {
    oal_uint8 uc_ersru_en;
    oal_uint8 uc_cur_timeslot;  /* 只是当前时隙suspend su or enable su */
    oal_uint8 uc_timer_loop;  /* 是否需要主动退出ersru */
    oal_int8  c_cur_rssi;     /* 维测用,不初始化 */

    oal_uint16 fragLen; /* 分片门限 */
    oal_uint16 pmLoop;  /* 暗屏周期累计 */

    oal_uint8  staScreenState; /* 亮暗屏状态 */
    oal_uint8  staPmState;
    oal_uint8  staPmFlag;
    oal_uint8  resv;

    oal_void *pst_arg_vap;
    oal_void *pst_arg_user;
    frw_timeout_stru st_ersru_timer; /* 动态窄带设置定时器 */
} hal_hiex_ersru_stru;
...
typedef struct {
    ...
    oal_uint8 bit_rx_trig_flag : 1;
    oal_uint8 bit_rx_trig_gap  : 4;
    oal_uint8 uc_ac_suspend_flag;
    oal_uint8 auc_resv1[2];  /* 2代表reserve */
    ...
    oal_int32  l_cfo_phase_avg;
    oal_uint32 ul_phase_det_cnt;
    oal_uint32 ul_last_trigger_time;
    oal_uint16 us_foc_err_cnt;
    oal_uint16 us_freq_factor;
    oal_uint16 us_tb_ppdu_len;
    oal_uint8  uc_tb_trig_subband;
#endif
...
#ifdef _PRE_WLAN_FEATURE_HIEX
    oal_uint32 ul_hiex_last_chs_ts; /* 上次上报本地信道测量的时间戳 */
    hal_hiex_ersru_stru st_ersru;  /* 动态窄带特性 */
    hal_hiex_cap_stru hal_hiex_cap;
#endif
...
#ifdef _PRE_WLAN_FEATURE_11AX
    dmac_rx_frame_statistics_stru        st_rx_frame_statistics;  /* 接收帧统计 */
    dmac_tx_frame_statistics_stru        st_tx_frame_statistics;  /* 发送帧统计 */
#endif
    frw_timeout_stru                     st_chr_stat_timer;       /* chr定时上报定时器 */
#ifdef _PRE_WLAN_RX_LISTEN_POWER_SAVING
    oal_void *pst_hal_ps_fsm;
#endif
    oal_void *pst_tid_sch;    /* 用于调度异常的处理 */
    oal_int8   c_intf_det_avg_rssi_20;           /* pri20 RSSI平均值 */
    oal_int8   c_intf_det_avg_rssi_40;           /* pri40 RSSI平均值 */
    oal_int8   c_intf_det_avg_rssi_80;           /* 80M RSSI平均值 */
    oal_int8   c_intf_det_avg_rssi_160;          /* 160M RSSI平均值 */
...
typedef struct tag_hal_to_dmac_device_stru {
    ...
    oal_int16  s_det_refine_phase;
    oal_uint8  uc_ac_suspend_bitmap;  /* AIFSN=0静默AC对应的TID打分板 */
    oal_uint8  uc_debug_bitmap; /* 日志开关 */
    ...
    oal_uint8 en_current_11ax_working; /* 长发长收用,当前hal dev是否11ax */
    oal_uint8 uc_trig_mcs_idx;
    oal_uint8 uc_trig_current_band;
#endif
} hal_to_dmac_device_stru;

#ifdef _PRE_WLAN_FEATURE_DOUBLE_TX_QUEUE
#define HAL_GET_TX_QUENE(pst_hal_dev, uc_q_offset_id, uc_q_num) \
    (&((pst_hal_dev)->ast_tx_dscr_queue[uc_q_offset_id][(uc_q_num)]))
#else
...
extern oal_void hi1103_set_sifs_resp_rate(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_rate_restrict);
extern oal_void hi1103_set_tx_lifetime_check(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_bool_enum_uint8 en_rate_restrict);
...
#endif
extern oal_void hi1103_tx_fill_basic_ctrl_dscr(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_tx_get_dscr_seqnum(hal_tx_dscr_stru *pst_tx_dscr,
                                          oal_uint16 *pus_seqnum,
                                          oal_uint8 *puc_valid);
#endif
...
extern oal_void hi1103_tx_non_ucast_data_set_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                  ...
                                                  hal_tx_txop_alg_stru *pst_txop_alg,
                                                  hal_tx_ppdu_feature_stru *pst_ppdu_feature);
extern oal_void hi1103_tx_set_dscr_modify_mac_header_length(hal_tx_dscr_stru *pst_tx_dscr,
                                                            oal_uint8 uc_mac_header_length);
extern oal_void hi1103_tx_set_dscr_seqno_sw_generate(hal_tx_dscr_stru *pst_tx_dscr,
                                                     oal_uint8 uc_sw_seqno_generate);
extern oal_void hi1103_tx_get_size_dscr(oal_uint8 us_msdu_num, oal_uint32 *pul_dscr_one_size,
                                        oal_uint32 *pul_dscr_two_size);
extern oal_void hi1103_tx_get_vap_id(hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 *puc_vap_id);
extern oal_void hi1103_tx_get_dscr_ctrl_one_param(hal_tx_dscr_stru *pst_tx_dscr,
                                                  hal_tx_dscr_ctrl_one_param *pst_tx_dscr_one_param);
extern oal_void hi1103_tx_update_dscr_para_hw(hal_tx_dscr_stru *pst_tx_dscr,
                                              hal_tx_dscr_ctrl_one_param *pst_tx_dscr_one_param);
...
extern oal_void hi1103_tx_retry_clear_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_tx_dscr_stru *pst_tx_dscr);
#ifdef _PRE_WLAN_FIT_BASED_REALTIME_CALI
extern oal_void hi1103_tx_set_pdet_en(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_tx_dscr_stru *pst_tx_dscr,
                                      oal_bool_enum_uint8 en_pdet_en_flag);
extern oal_void hi1103_dyn_cali_tx_pow_ch_set(hal_to_dmac_device_stru *pst_hal_device,
                                              hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1103_dyn_cali_tx_pa_ppa_swtich(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_bool_enum_uint8 en_ppa_working);
extern oal_void hi1103_dyn_cali_al_tx_config_amend(hal_to_dmac_device_stru *pst_hal_device,
                                                   hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1103_dyn_cali_vdet_val_amend(hal_to_dmac_device_stru *pst_hal_device,
                                               wlan_channel_band_enum_uint8 en_freq,
                                               oal_uint8 uc_rf_id, oal_int16 s_vdet_val_in,
                                               oal_int16 *ps_det_val_out, oal_int16 s_vdet_offset);
extern oal_int16 hi1103_dyn_cali_get_gm_val(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_rf_id);
extern oal_void hi1103_dyn_cali_get_tx_power_dc(hal_to_dmac_device_stru *pst_hal_device,
                                                wlan_channel_band_enum_uint8 en_freq,
                                                oal_uint8 uc_rf_id, oal_int16 *ps_tx_power_dc,
                                                oal_bool_enum_uint8 en_ppa_working);
#endif
extern oal_void hi1103_tx_get_bw_mode(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_tx_get_dscr_send_rate_rank(hal_tx_dscr_stru *pst_tx_dscr,
                                                  oal_uint8 *puc_send_rate_rank);
extern oal_void hi1103_tx_get_dscr_chiper_type(hal_tx_dscr_stru *pst_tx_dscr,
                                               oal_uint8 *puc_chiper_type,
...
extern oal_void hi1103_tx_put_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                   hal_tx_queue_type_enum_uint8 en_tx_queue_type, hal_tx_dscr_stru *past_tx_dscr);
extern oal_void hi1103_get_tx_q_status(hal_to_dmac_device_stru *pst_hal_device,
                                       oal_uint32 *pul_status,
                                       oal_uint8 uc_qnum);
extern oal_void hi1103_get_tx_multi_q_status(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_status,
                                             oal_uint8 uc_qnum);
extern oal_void hi1103_tx_get_ampdu_len(hal_to_dmac_device_stru *pst_hal_device,
                                        hal_tx_dscr_stru *pst_dscr,
                                        oal_uint32 *pul_ampdu_len);
extern oal_void hi1103_set_bcn_timeout_multi_q_enable(hal_to_dmac_vap_stru *pst_hal_vap,
                                                      oal_uint8 uc_enable);
extern oal_void hi1103_get_prot_datarate(oal_uint8 uc_prot_rate_index, oal_uint32 *pul_value);
extern oal_void hi1103_tx_get_protocol_mode(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_tx_dscr_stru *pst_dscr, oal_uint8 *puc_protocol_mode);
extern oal_void hi1103_rx_get_info_dscr(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_get_hal_vap(hal_to_dmac_device_stru *pst_hal_device,
                                   oal_uint8 uc_vap_id,
                                   hal_to_dmac_vap_stru **ppst_hal_vap);
extern oal_void hi1103_rx_get_netbuffer_addr_dscr(oal_uint32 *pul_rx_dscr,
                                                  oal_netbuf_stru **ppul_mac_hdr_addr);
extern oal_void hi1103_rx_show_dscr_queue_info(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_rx_dscr_queue_id_enum_uint8 en_rx_dscr_type);
extern oal_void hi1103_rx_print_phy_debug_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_rx_dscr,
                                               hal_rx_status_stru *pst_rx_status,
                                               hal_rx_statistic_stru *pst_rx_statistics);
extern oal_void hi1103_rx_record_frame_status_info(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint32 *pul_rx_dscr,
                                                   hal_rx_dscr_queue_id_enum_uint8 en_queue_id);
extern oal_void hi1103_rx_free_dscr_list(hal_to_dmac_device_stru *pst_hal_device,
                                         hal_rx_dscr_queue_id_enum_uint8 en_queue_num,
                                         oal_uint32 *pul_rx_dscr);
extern oal_void hi1103_dump_tx_dscr(oal_uint32 *pul_tx_dscr);
extern oal_void hi1103_reg_write(hal_to_dmac_device_stru *pst_hal_device,
                                 oal_uint32 ul_addr,
                                 oal_uint32 ul_val);
extern oal_void hi1103_reg_write16(hal_to_dmac_device_stru *pst_hal_device,
                                   oal_uint32 ul_addr,
                                   oal_uint16 us_val);
#ifdef _PRE_WLAN_FEATURE_DATA_SAMPLE
extern oal_void hi1103_set_sample_memory(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint32 **pul_start_addr,
                                         oal_uint32 *pul_reg_num);
...
extern oal_void hi1103_get_single_psd_sample(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint16 us_index,
                                             oal_int8 *pc_psd_val);
...
extern oal_void hi1103_set_psd_ofdm_det_en(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint32 ul_reg_value);
extern oal_void hi1103_set_psd_wifi_work_en(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1103_set_psd_the_bottom_noise(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_int32 l_reg_value);
extern oal_void hi1103_set_psd_the_num_nb(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_uint32 ul_reg_value);
extern oal_void hi1103_set_psd_the_power_nb(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1103_set_psd_the_rssi_nb(hal_to_dmac_device_stru *pst_hal_device, oal_int32 l_reg_value);
extern oal_void hi1103_get_psd_data(hal_to_dmac_device_stru *pst_hal_device,
                                    oal_int8 *pc_start_addr,
                                    oal_uint32 *pul_psd_data_len);
extern oal_void hi1103_set_sync_data_path_div_num(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1103_set_force_reg_clk_on(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
...
#endif
#ifdef _PRE_WLAN_FEATURE_11AX
extern oal_void hi1103_set_queue_size(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_uint16 us_qos_ctrl_fld,
...
extern oal_void hi1103_set_dev_support_11ax(hal_to_dmac_device_stru *pst_hal_device,
    hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 uc_reg_value);
extern oal_void hi1103_set_mu_edca_lifetime(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint8 uc_ac_type,
                                            oal_uint8 uc_lifetime);
extern oal_void hi1103_set_mu_edca_aifsn(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint8 uc_bk,
                                         oal_uint8 uc_be,
                                         oal_uint8 uc_vi,
                                         oal_uint8 uc_vo);
extern oal_void hi1103_set_mu_edca_cw(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_ac_type,
                                      oal_uint8 uc_cwmax, oal_uint8 uc_cwmin);
extern oal_void hi1103_set_bss_color(hal_to_dmac_device_stru *pst_hal_device,
                                     hal_to_dmac_vap_stru *pst_hal_vap,
                                     oal_uint8 uc_bss_color);
extern oal_void hi1103_set_partial_bss_color(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_to_dmac_vap_stru *pst_hal_vap,
                                             oal_uint8 uc_partial_bss_color);
extern oal_void hi1103_get_mu_edca_print(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1103_enable_phase_accum(hal_to_dmac_device_stru *pst_hal_device,
                                          hal_phase_accum_select_enum_uint8 en_select);
extern oal_void hi1103_set_obss_pd_lv(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_int8 c_pd_level,
                                      oal_int8 c_pd_min_default);
extern oal_void hi1103_set_mac_rx_clken(hal_to_dmac_device_stru *pst_hal_device,
    oal_bool_enum_uint8 en_wctrl_enable);
extern oal_void hi1103_set_srg_bss_color_bitmap(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint32 ul_bitmap_low, oal_uint32 ul_bitmap_high);
extern oal_void hi1103_set_srg_partial_bssid_bitmap(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint32 ul_bitmap_low,
                                                    oal_uint32 ul_bitmap_high);
extern oal_void hi1103_set_spatial_reuse_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 en_flag);
extern oal_void hi1103_set_he_trigger_insert_htc_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_bool_enum_uint8 en_flag);
...
extern oal_void hi1103_get_phy_csi_info(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_get_pktmem_start_addr(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 **pul_reg_num);
extern oal_void hi1103_get_pktmem_end_addr(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint32 **pul_reg_num);

extern oal_void hi1103_get_csi_frame_type(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_uint8 *puc_he_flag,
                                          oal_uint8 *puc_frame_type);
...
extern oal_void hi1103_set_machw_rx_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 ul_rx_dscr,
                                              hal_rx_dscr_queue_id_enum_uint8 en_queue_num);
extern oal_uint32 hi1103_set_machw_rx_buff_addr_sync(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 *ul_rx_dscr,
                                                     hal_rx_dscr_queue_id_enum_uint8 en_queue_num);
extern oal_void hi1103_rx_add_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                   hal_rx_dscr_queue_id_enum_uint8 en_queue_num,
                                   oal_uint16 us_handle_type);
extern oal_void hi1103_tx_get_dscr_trigger_based_flag(hal_tx_dscr_stru *pst_ba_dscr,
                                                      oal_uint8 *puc_trigger_flag);
extern oal_void hi1103_rx_add_dscr_th(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_rx_dscr_queue_id_enum_uint8 en_queue_num,
                                      oal_uint16 us_rx_dscr_num);
extern oal_void hi1103_rx_update_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_rx_dscr_queue_id_enum_uint8 en_queue_num,
                                      oal_uint16 us_rx_dscr_num);
extern oal_void hi1103_recycle_rx_isr_list(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_reset_phy_machw(hal_to_dmac_device_stru *pst_hal_device,
...
#ifdef _PRE_WLAN_FEATURE_AMPDU_TX_HW
extern oal_void hi1103_set_ampdu_tx_hw_on(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_enable, oal_uint8 uc_snd_type);
#endif
extern oal_void hi1103_initialize_machw_common(hal_to_dmac_device_stru *pst_hal_device);

extern oal_void hi1103_set_freq_band(hal_to_dmac_device_stru *pst_hal_device,
                                     wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1103_set_bandwidth_mode(hal_to_dmac_device_stru *pst_hal_device,
...
#endif
extern oal_void hi1103_set_primary_channel(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint8 uc_channel_num,
                                           wlan_channel_band_enum_uint8 en_band,
                                           oal_uint8 uc_channel_idx,
                                           wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_uint8 hi1103_set_mac_phy_freq(hal_to_dmac_device_stru *pst_hal_device,
                                         wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
extern oal_void hi1103_set_phy_tx_scale(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_bool_enum_uint8 en_2g_11ac);
#endif
...
extern oal_void hi1103_remove_machw_ba_lut_entry(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint8 uc_lut_index);
extern oal_void hi1103_get_machw_ba_params(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index,
                                           ...
                                           oal_uint32 *pst_bitmap_h, oal_uint32 *pst_bitmap_l,
                                           oal_uint32 *pst_ba_para);
extern oal_void hi1103_restore_machw_ba_params(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 uc_index, oal_uint32 ul_addr_h,
                                               oal_uint32 ul_addr_l, oal_uint32 ul_ba_para);
extern oal_void hi1103_machw_seq_num_index_update_per_tid(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint8 uc_lut_index,
                                                          oal_uint8 uc_qos_flag);
extern oal_void hi1103_set_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index,
                                           oal_uint8 uc_tid, oal_uint8 uc_qos_flag,
                                           oal_uint32 ul_val_write, oal_uint8 uc_vap_index);
extern oal_void hi1103_get_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index,
                                           oal_uint8 uc_tid, oal_uint8 uc_qos_flag,
                                           oal_uint8 uc_vap_index, oal_uint32 *pst_val_read);
extern oal_void hi1103_get_tx_seq_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index,
                                      oal_uint8 uc_tid, oal_uint8 uc_qos_flag,
                                      oal_uint8 uc_vap_index, oal_uint16 *pst_val_read);
extern oal_void hi1103_set_phy_freq_factor(
                hal_to_dmac_device_stru          *pst_hal_device,
                oal_uint8                         uc_channel_num,
                wlan_channel_band_enum_uint8      en_band,
                wlan_channel_bandwidth_enum_uint8 en_bandwidth);
#ifdef _PRE_WLAN_FEATURE_AMPDU_TX_HW
extern oal_void hi1103_save_tx_ba_para(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_reset_reg_restore(hal_to_dmac_device_stru *pst_hal_device,
                                         hal_reset_hw_type_enum_uint8 en_type);
extern oal_void hi1103_reset_reg_save(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_reset_hw_type_enum_uint8 en_type);
extern oal_void hi1103_reset_reg_dma_save(hal_to_dmac_device_stru *pst_hal, oal_uint8 *uc_dmach0,
                                          oal_uint8 *uc_dmach1, oal_uint8 *uc_dmach2);
extern oal_void hi1103_reset_reg_dma_restore(hal_to_dmac_device_stru *pst_hal, oal_uint8 *uc_dmach0,
                                             oal_uint8 *uc_dmach1, oal_uint8 *uc_dmach2);
...
extern oal_void hi1103_radar_config_reg(hal_to_dmac_device_stru *pst_hal_device,
                                        hal_dfs_radar_type_enum_uint8 en_dfs_domain);
extern oal_void hi1103_radar_config_reg_bw(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_dfs_radar_type_enum_uint8 en_radar_type,
                                           wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void hi1103_radar_enable_chirp_det(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 en_chirp_det);
...
extern oal_void hi1103_pow_set_rf_regctl_enable(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_bool_enum_uint8 en_rf_linectl);
extern oal_void hi1103_pow_set_resp_frame_tx_power(hal_to_dmac_device_stru *pst_hal_device,
                                                   ...
                                                   hal_rate_pow_code_gain_tbl_stru *pst_rate_pow_table);
...
extern oal_void hi1103_pow_set_user_resp_frame_tx_power(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint8 uc_lut_index,
                                                        oal_uint8 uc_rssi_distance);
extern oal_void hi1103_pow_oper_machw_resp_power_lut_entry(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index,
    hal_oper_pow_lut_oper_type_enum_uint8 en_rsp_pow_oper);
extern oal_void hi1103_pow_set_user_resp_frm_phy_tx_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                         wlan_channel_band_enum_uint8 en_band,
...
extern oal_void hi1103_pow_cfg_no_margin_pow_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_pow_mode);
extern oal_void hi1103_pow_cfg_show_log(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_update_upc_amend_by_tas(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 uc_chn_idx,
...
#endif
extern oal_void hi1103_cali_matrix_data_send_func(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 *puc_matrix_data,
                                                  oal_uint16 us_frame_len,
                                                  oal_uint16 us_remain);
extern oal_void hi1103_cali_send_func(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 *puc_cali_data,
...
extern oal_void hi1103_get_mac_error_int_status(hal_to_dmac_device_stru *pst_hal_device,
                                                hal_error_state_stru *pst_state);
extern oal_void hi1103_clear_mac_error_int_status(hal_to_dmac_device_stru *pst_hal_device,
                                                  hal_error_state_stru *pst_status);
extern oal_void hi1103_unmask_mac_init_status(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_add_vap(hal_to_dmac_device_stru *pst_hal_device, wlan_vap_mode_enum_uint8 vap_mode,
                               oal_uint8 uc_mac_vap_id, hal_to_dmac_vap_stru **ppst_hal_vap);
extern oal_void hi1103_del_vap(hal_to_dmac_device_stru *pst_hal_device,
                               wlan_vap_mode_enum_uint8 vap_mode,
                               oal_uint8 vap_id);
#ifdef _PRE_WLAN_FEATURE_M2S
extern oal_void hi1103_update_datarate_by_chain(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint8 uc_resp_tx_chain);
#endif

#ifdef _PRE_WLAN_FEATURE_PROXYSTA
extern oal_void hi1103_set_proxysta_enable(hal_to_dmac_device_stru *pst_hal_device, oal_int32 l_enable);
#endif
extern oal_void hi1103_config_eifs_time(hal_to_dmac_device_stru *pst_hal_device,
                                        wlan_protocol_enum_uint8 en_protocol);
extern oal_void hi1103_register_alg_isr_hook(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_isr_type_enum_uint8 en_isr_type,
                                             hal_alg_noify_enum_uint8 en_alg_notify,
                                             p_hal_alg_isr_func p_func);
extern oal_void hi1103_unregister_alg_isr_hook(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_isr_type_enum_uint8 en_isr_type,
                                               hal_alg_noify_enum_uint8 en_alg_notify);
extern oal_void hi1103_register_gap_isr_hook(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_isr_type_enum_uint8 en_isr_type, p_hal_alg_isr_func p_func);
extern oal_void hi1103_unregister_gap_isr_hook(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_isr_type_enum_uint8 en_isr_type);
extern oal_void hi1103_rx_set_trlr_report_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 *auc_config_val,
                                               oal_uint8 uc_trlr_switch);
extern oal_void hi1103_one_packet_start(struct tag_hal_to_dmac_device_stru *pst_hal_device,
                                        hal_one_packet_cfg_stru *pst_cfg);
extern oal_void hi1103_one_packet_stop(struct tag_hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1103_one_packet_get_status(struct tag_hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_mask_interrupt(struct tag_hal_to_dmac_device_stru *pst_hal_device,
                                      oal_uint32 ul_offset);
extern oal_void hi1103_unmask_interrupt(struct tag_hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint32 ul_offset);
extern oal_void hi1103_reg_info(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_addr, oal_uint32 *pul_val);
extern oal_void hi1103_reg_info16(hal_to_dmac_device_stru *pst_hal_device,
                                  oal_uint32 ul_addr,
                                  oal_uint16 *pus_val);
extern oal_void hi1103_read_rf_reg(hal_to_dmac_device_stru *pst_hal_device,
                                   oal_uint16 us_reg_addr,
                                   oal_uint16 *pus_reg_val);
extern oal_void hi1103_write_rf_reg(hal_to_dmac_device_stru *pst_hal_device,
                                    oal_uint16 us_rf_addr_offset,
                                    oal_uint16 us_rf_16bit_data);

#ifdef _PRE_WLAN_ONLINE_DPD
extern oal_void hi1103_dpd_config(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 *puc_val);
extern oal_void hi1103_dpd_cfr_set_work_mode(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint8 uc_set_type,
                                             oal_uint8 uc_value);
extern oal_bool_enum_uint8 hi1103_device_dpd_is_on(hal_to_dmac_device_stru *pst_hal_device,
                                                   wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1103_dpd_cfr_switch_config(hal_to_dmac_device_stru *pst_hal_device,
    wlan_channel_band_enum_uint8 en_band);
#endif

extern oal_void hi1103_get_all_tx_q_status(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_val);
extern oal_void hi1103_get_ampdu_bytes(hal_to_dmac_device_stru *pst_hal_device,
                                       oal_uint32 *pul_tx_bytes,
...
extern oal_void hi1103_mac_error_msg_report(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_mac_error_type_enum_uint8 en_error_type);
extern oal_void hi1103_get_dieid(hal_to_dmac_device_stru *pst_hal_device,
                                 oal_uint32 *pul_dieid,
                                 oal_uint32 *pul_length);
...
extern oal_void hi1103_ce_add_key(hal_to_dmac_device_stru *pst_hal_device,
                                  hal_security_key_stru *pst_security_key,
                                  oal_uint8 *puc_addr);
extern oal_void hi1103_ce_del_key(hal_to_dmac_device_stru *pst_hal_device,
                                  hal_security_key_stru *pst_security_key);
extern oal_void hi1103_ce_get_key(hal_to_dmac_device_stru *pst_hal_device,
                                  hal_security_key_stru *pst_security_key);
extern oal_void hi1103_disable_ce(hal_to_dmac_device_stru *pst_device);
extern oal_void hi1103_ce_add_peer_macaddr(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint8 uc_lut_idx,
                                           oal_uint8 *puc_addr);
extern oal_void hi1103_ce_del_peer_macaddr(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint8 uc_lut_idx);
...
extern oal_void hi1103_tx_get_dscr_phy_mode_one(hal_tx_dscr_stru *pst_tx_dscr,
                                                oal_uint32 *pul_phy_mode_one);
extern oal_void hi1103_tx_get_ra_lut_index(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_tx_dscr_stru *pst_dscr, oal_uint8 *puc_ra_lut_index);
extern oal_void hi1103_init_ptk_tx_pn(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_security_key_stru *pst_security_key,
                                      oal_uint32 ul_pn_msb);
#endif
...
extern oal_void hi1103_set_ch_measurement_period(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint8 uc_period);
extern oal_void hi1103_get_ch_statics_result(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_ch_statics_irq_event_stru *pst_ch_statics);
extern oal_void hi1103_get_ch_measurement_result_ram(hal_to_dmac_device_stru *pst_hal_device,
                                                     hal_ch_statics_irq_event_stru *pst_ch_statics);
extern oal_void hi1103_get_ch_measurement_result(hal_to_dmac_device_stru *pst_hal_device,
                                                 hal_ch_statics_irq_event_stru *pst_ch_statics);
...
extern oal_void hi1103_get_radar_det_result(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_radar_det_event_stru *pst_radar_info);
extern oal_void hi1103_radar_get_pulse_info(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_update_rts_rate_params(hal_to_dmac_device_stru *pst_hal_device,
                                              wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1103_set_rts_rate_params(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_cfg_rts_tx_param_stru *pst_hal_rts_tx_param);
extern oal_void hi1103_set_txbf_sounding_rate(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint8 uc_txbf_sounding_rate);
extern oal_void hi1103_set_rts_rate_selection_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 uc_rts_rate_select_mode);
extern oal_void hi1103_set_agc_track_ant_sel(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_agc_track_ant_sel);
extern oal_void hi1103_get_agc_track_ant_sel(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_agc_track_ant_sel);
extern oal_void hi1103_set_prot_resp_frame_chain(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint8 uc_chain_val);
...
extern oal_void hi1103_set_spec_frm_phy_tx_mode(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_rf_regctl_enable_set_regs(hal_to_dmac_device_stru *pst_hal_device,
                                                 wlan_channel_band_enum_uint8 en_freq_band, oal_uint8 uc_cur_ch_num,
                                                 wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
extern oal_void hi1103_set_legacy_matrix_buf_pointer(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 ul_matrix);
extern oal_void hi1103_get_legacy_matrix_buf_pointer(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_set_vht_report_phy_mode(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_set_ndpa_duration(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint32 ul_ndpa_duration);
extern oal_void hi1103_set_ndp_group_id(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint8 uc_group_id,
                                        oal_uint16 us_partial_id);
extern oal_void hi1103_set_phy_legacy_bf_en(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1103_set_phy_txbf_legacy_en(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 ul_reg_value);
...
extern oal_void hi1103_set_ht_buffer_pointer(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_reg_value);
extern oal_void hi1103_delete_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index);
extern oal_void hi1103_set_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint8 uc_lut_index,
                                         oal_uint32 ul_reg_value);
extern oal_void hi1103_get_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint8 uc_lut_index,
                                         oal_uint32 *pst_reg_value);
extern oal_void hi1103_set_h_matrix_timeout(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1103_set_dl_mumimo_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_enable);
extern oal_void hi1103_get_dl_mumimo_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 *en_enable);
extern oal_void hi1103_set_mu_aid_matrix_info(hal_to_dmac_device_stru *pst_hal_device,
                                              hal_to_dmac_vap_stru *pst_hal_vap,
                                              oal_uint16 us_aid);
extern oal_void hi1103_set_sta_membership_status_63_32(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 value);
extern oal_void hi1103_set_sta_membership_status_31_0(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint32 ul_value);
...
extern oal_void hi1103_set_bfer_subcarrier_ng(hal_to_dmac_device_stru *pst_hal_device,
                                              wlan_bw_cap_enum_uint8 en_user_bw);
extern oal_void hi1103_set_txbf_vht_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
                                              hal_to_dmac_vap_stru *pst_hal_vap, oal_uint32 ul_addr,
                                              oal_uint16 us_buffer_len);
#ifdef _PRE_WLAN_FEATURE_11AX
extern oal_void hi1103_set_txbf_he_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_to_dmac_vap_stru *pst_hal_vap, oal_uint32 ul_addr,
                                             oal_uint16 us_buffer_len);
#endif
extern oal_void hi1103_set_bfee_h2v_beamforming_ng(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 uc_user_bw);
extern oal_void hi1103_set_bfee_grouping_codebook(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_lut_index, oal_uint8 uc_min_group,
                                                  oal_uint8 uc_txbf_mode, oal_uint8 uc_user_bw);

extern oal_void hi1103_set_bfee_sounding_en(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint8 uc_txbf_mode,
                                            oal_uint8 uc_bfee_enable);
extern oal_void hi1103_rf_second_agc_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                          wlan_channel_band_enum_uint8 en_band);

#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
extern oal_void hi1103_set_bfee_bypass_clk_gating(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_enable);
#endif
#endif

extern oal_void hi1103_enable_smart_antenna_gpio_set_default_antenna(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1103_delete_smart_antenna_value(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_lut_index);
extern oal_void hi1103_set_smart_antenna_value(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 uc_lut_index, oal_uint16 ul_reg_value);
extern oal_void hi1103_get_smart_antenna_value(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 uc_lut_index, oal_uint32 *pst_reg_value);
/* phy debug信息中trailer信息上报设置寄存器 */
extern oal_void hi1103_rx_set_trlr_report_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 *auc_config_val, oal_uint8 uc_trlr_switch);
extern oal_void hi1103_rf_tone_transmit_entrance(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint16 us_data_len, oal_uint8 uc_chain_idx);
...
extern oal_void hi1103_get_weak_intf_rssi_th(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pst_reg_value);
extern oal_void hi1103_set_agc_unlock_min_th(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_int32 l_tx_reg_val,
                                             oal_int32 l_rx_reg_val);
extern oal_void hi1103_get_agc_unlock_min_th(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pst_reg_value);
extern oal_void hi1103_set_nav_max_duration(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint16 us_bss_dur,
...
extern oal_void hi1103_set_extlna_chg_cfg(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_extlna_chg_bypass);
#ifdef _PRE_WLAN_FEATURE_EDCA_OPT
extern oal_void hi1103_set_counter1_clear(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1103_get_txrx_frame_time(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_ch_mac_statics_stru *pst_ch_statics);
extern oal_void hi1103_set_mac_clken(hal_to_dmac_device_stru *pst_hal_device,
                                     oal_bool_enum_uint8 en_wctrl_enable);
#endif

extern oal_void hi1103_set_80m_resp_mode(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_debug_en);
extern oal_void hi1103_get_mac_statistics_data(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_set_noise_comb_close(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1103_set_zf_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1103_set_dyn_bypass_extlna_pm_flag(hal_to_dmac_device_stru *pst_hal_device,
                                                     wlan_channel_band_enum_uint8 en_band,
...
extern oal_void hi1103_set_ed_high_th(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_alg_cca_th_stru *pst_cca_th_opt);
extern oal_void hi1103_set_cca_prot_th(hal_to_dmac_device_stru *pst_hal_device,
                                       hal_alg_cca_th_stru *pst_cca_th_opt);
extern oal_void hi1103_set_cca_th_default(hal_to_dmac_device_stru *pst_hal_device,
                                          wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1103_enable_sync_error_counter(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_get_cca_reg_th(hal_to_dmac_device_stru *pst_hal_device,
                                      wlan_channel_band_enum_uint8 uc_band,
                                      oal_int8 *ac_reg_val);
#endif
#ifdef _PRE_WLAN_FEATURE_MWO_DET
extern oal_void hi1103_set_mac_anti_intf_period(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint32 ul_reg_val);
extern oal_void hi1103_get_mac_anti_intf_period(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint32 *pul_reg_val);
extern oal_void hi1103_set_mac_anti_intf_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 ul_reg_val);
extern oal_void hi1103_get_mac_mwo_cycle_time(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 *pul_tx_comp_mwo_cyc_time);
...
extern oal_void hi1103_get_phy_mwo_det_rssithr(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_reg_val);
extern oal_void hi1103_restore_phy_mwo_det_rssithr(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint32 ul_reg_val);
extern oal_void hi1103_set_phy_mwo_det_timethr(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 ul_reg_val);
extern oal_void hi1103_get_phy_mwo_det_timethr(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_reg_val);
#endif
extern oal_void hi1103_set_soc_lpm(hal_to_dmac_device_stru *pst_hal_device, hal_lpm_soc_set_enum_uint8 en_type,
...
extern oal_void hi1103_set_psm_listen_interval_count(hal_to_dmac_vap_stru *pst_hal_vap,
...
extern oal_void hi1103_set_psm_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                             oal_uint32 ul_beacon_period);
extern oal_void hi1103_soc_set_pcie_l1s(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint8 uc_on_off,
...
extern oal_void hi1103_set_txop_ps_partial_aid(hal_to_dmac_vap_stru *pst_hal_vap,
                                               oal_uint32 ul_partial_aid);
extern oal_void hi1103_get_txop_ps_partial_aid(hal_to_dmac_vap_stru *pst_hal_vap,
                                               oal_uint32 *pul_partial_aid);
#endif
...
extern oal_void hi1103_set_wow_en(hal_to_dmac_device_stru *pst_hal_device,
                                  oal_uint32 ul_set_bitmap,
                                  hal_wow_param_stru *pst_para);
extern oal_void hi1103_set_lpm_state(hal_to_dmac_device_stru *pst_hal_device,
                                     hal_lpm_state_enum_uint8 uc_state_from, hal_lpm_state_enum_uint8 uc_state_to,
                                     oal_void *pst_para, oal_void *pst_wow_para);
...
extern oal_void hi1103_set_coex_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                     oal_uint32 ul_mac_ctrl,
                                     oal_uint32 ul_rf_ctrl);
extern oal_void hi1103_get_hw_version(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_hw_vsn,
...
extern oal_void hi1103_freq_adjust(hal_to_dmac_device_stru *pst_hal_device,
                                   oal_uint16 us_pll_int,
                                   oal_uint16 us_pll_frac);
#endif
extern oal_void hi1103_set_tx_dscr_field(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint32 ul_data,
                                         hal_rf_test_sect_enum_uint8 en_sect);
extern oal_void hi1103_get_tx_dscr_field(hal_to_dmac_device_stru *pst_hal_device,
                                         hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1103_set_phy_max_bw_field(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_data,
                                            hal_phy_max_bw_sect_enmu_uint8 en_sect);
extern oal_void hi1103_rf_test_disable_al_tx(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1103_rf_test_enable_al_tx(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1103_set_daq_mac_reg(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_addr,
...
extern oal_void hi1103_set_dac_lpf_gain(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint8 en_band, oal_uint8 en_bandwidth, oal_uint8 uc_chan_number,
                                        oal_uint8 en_protocol_mode, oal_uint8 en_rate);
extern oal_void hi1103_get_pwr_comp_val(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint32 ul_tx_ratio,
...
extern oal_void hi1103_set_rx_filter_reg(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint32 ul_rx_filter_command);
extern oal_void hi1103_get_rx_filter(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pst_reg_value);
extern oal_void hi1103_set_beacon_timeout_val(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint16 us_value);
...
extern oal_void hi1103_vap_tsf_get_64bit(hal_to_dmac_vap_stru *pst_hal_vap,
                                         oal_uint32 *pul_tsf_hi,
                                         oal_uint32 *pul_tsf_lo);
extern oal_void hi1103_vap_tsf_set_64bit(hal_to_dmac_vap_stru *pst_hal_vap,
                                         oal_uint32 ul_tsf_hi,
                                         oal_uint32 ul_tsf_lo);
extern oal_void hi1103_vap_send_beacon_pkt(hal_to_dmac_vap_stru *pst_hal_vap,
...
extern oal_void hi1103_vap_set_opmode(hal_to_dmac_vap_stru *pst_hal_vap,
                                      wlan_vap_mode_enum_uint8 en_vap_mode);

extern oal_void hi1103_vap_clr_opmode(hal_to_dmac_vap_stru *pst_hal_vap,
                                      wlan_vap_mode_enum_uint8 en_vap_mode);
extern oal_void hi1103_vap_set_machw_aifsn_all_ac(hal_to_dmac_vap_stru *pst_hal_vap,
                                                  oal_uint8 uc_bk,
                                                  oal_uint8 uc_be,
                                                  oal_uint8 uc_vi,
                                                  oal_uint8 uc_vo);
...
extern oal_void hi1103_vap_set_edca_machw_cw(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 uc_cwmax,
                                             oal_uint8 uc_cwmin, oal_uint8 uc_ac_type);
extern oal_void hi1103_vap_set_edca_machw_cw_wfa(hal_to_dmac_vap_stru *pst_hal_vap,
                                                 oal_uint8 uc_cwmaxmin, oal_uint8 uc_ac_type,
                                                 wlan_wme_ac_type_enum_uint8 en_wfa_lock);
extern oal_void hi1103_vap_get_edca_machw_cw(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 *puc_cwmax,
                                             oal_uint8 *puc_cwmin, oal_uint8 uc_ac_type);
extern oal_void hi1103_vap_set_machw_txop_limit_bkbe(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 us_be, oal_uint16 us_bk);
extern oal_void hi1103_vap_get_machw_txop_limit_bkbe(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 *pus_be, oal_uint16 *pus_bk);
extern oal_void hi1103_vap_set_machw_txop_limit_vivo(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 us_vo, oal_uint16 us_vi);
extern oal_void hi1103_vap_get_machw_txop_limit_vivo(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 *pus_vo, oal_uint16 *pus_vi);
extern oal_void hi1103_vap_set_machw_edca_bkbe_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                        oal_uint16 us_be, oal_uint16 us_bk);
extern oal_void hi1103_vap_get_machw_edca_bkbe_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                        oal_uint16 *pus_be, oal_uint16 *pus_bk);
extern oal_void hi1103_vap_set_machw_edca_vivo_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                        oal_uint16 us_vo, oal_uint16 us_vi);
extern oal_void hi1103_vap_get_machw_edca_vivo_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                        oal_uint16 *pus_vo, oal_uint16 *pus_vi);
...
extern oal_void hi1103_vap_set_machw_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                                   oal_uint16 us_beacon_period);
extern oal_void hi1103_vap_update_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                                oal_uint16 us_beacon_period);
extern oal_void hi1103_vap_get_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
...
extern oal_void hi1103_vap_set_twt(hal_to_dmac_vap_stru *pst_hal_vap,
...
extern oal_void hi1103_vap_set_noa(hal_to_dmac_vap_stru *pst_hal_vap,
...
#ifdef _PRE_WLAN_FEATURE_P2P
extern oal_void hi1103_vap_set_ops(hal_to_dmac_vap_stru *pst_hal_vap,
                                   oal_uint8 en_ops_ctrl,
                                   oal_uint8 uc_ct_window);
extern oal_void hi1103_vap_enable_p2p_absent_suspend(hal_to_dmac_vap_stru *pst_hal_vap,
...
extern oal_void hi1103_mwo_det_enable_mac_counter(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_int32 l_enable_reg_val);
#ifdef _PRE_WLAN_110X_PILOT
extern oal_void hi1103_tx_enable_resp_ps_bit_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_lut_index);
extern oal_void hi1103_tx_enable_resp_ps_bit_ctrl_all(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1103_tx_disable_resp_ps_bit_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 uc_lut_index);
extern oal_void hi1103_tx_disable_resp_ps_bit_ctrl_all(hal_to_dmac_device_stru *pst_hal_device);
#endif
extern oal_void hi1103_tx_enable_peer_sta_ps_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_lut_index);
extern oal_void hi1103_tx_disable_peer_sta_ps_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 uc_lut_index);
extern oal_void hi1103_cfg_slottime_type(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_slottime_type);
extern oal_void hi1103_get_hw_status(hal_to_dmac_device_stru *pst_hal_device,
                                     oal_uint32 *ul_cali_check_hw_status);
extern oal_void hi1103_pm_wlan_get_service_id(hal_to_dmac_vap_stru *pst_hal_vap,
                                              oal_uint8 *uc_service_id);
extern oal_void hi1103_pm_enable_front_end(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_get_beacon_miss_value(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_val);
...
extern oal_void hi1103_get_tx_hi_pri_mpdu_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 *pul_val);
#endif
...
extern oal_void hi1103_get_btcoex_abort_qos_null_seq_num(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint32 *ul_qosnull_seq_num);
extern oal_void hi1103_get_btcoex_occupied_period(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint16 *us_occupied_period);
extern oal_void hi1103_get_btcoex_pa_status(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 *ul_pa_status);
...
extern oal_void hi1103_get_btcoex_statistic(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_bool_enum_uint8 en_enable_abort_stat);
extern oal_uint32 hi1103_mpw_soc_write_reg(oal_uint32 ulQuryRegAddrTemp, oal_uint16 usQuryRegValueTemp);
extern oal_void hi1103_btcoex_update_ap_beacon_count(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 *pul_beacon_count);
extern oal_void hi1103_btcoex_post_event(hal_to_dmac_chip_stru *pst_hal_chip,
                                         hal_dmac_misc_sub_type_enum_uint8 en_sub_type);
extern oal_void hi1103_btcoex_have_small_ampdu(hal_to_dmac_device_stru *pst_hal_device,
...
extern oal_void hi1103_btcoex_set_wl0_antc_switch(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_bool_enum_uint8 en_tx_slv);
#ifdef _PRE_WLAN_FEATURE_BTCOEX_SLV_TX_BUGFIX
extern oal_void hi1103_btcoex_set_wl0_tx_slv_en(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_bool_enum_uint8 en_tx_slv);
extern oal_void hi1103_btcoex_set_pta0_wl0_selected_sel(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_bool_enum_uint8 en_sw_ctl);
extern oal_void hi1103_btcoex_set_wl0_rx_status_byp(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_bool_enum_uint8 en_rx_byp);
#endif
extern oal_void hi1103_btcoex_get_bt_acl_status(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_bool_enum_uint8 *en_acl_status);
extern oal_void hi1103_btcoex_get_bt_sco_status(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_bool_enum_uint8 *en_sco_status);
extern oal_void hi1103_btcoex_get_slna_status(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 *en_sco_status);
extern oal_void hi1103_btcoex_get_ps_service_status(hal_to_dmac_device_stru *pst_hal_device,
                                                    hal_btcoex_ps_status_enum_uint8 *en_ps_status);
extern oal_void hi1103_btcoex_set_slna_en(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_slna);
extern oal_void hi1103_btcoex_set_ba_resp_pri(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 en_occu);
#ifdef _PRE_WLAN_110X_PILOT
...
#endif
extern oal_void hi1103_set_btcoex_abort_preempt_frame_param(hal_to_dmac_device_stru *pst_hal_device,
                                                            oal_uint16 us_preempt_param);
extern oal_void hi1103_set_btcoex_abort_null_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 ul_abort_null_buff_addr);
extern oal_void hi1103_set_btcoex_tx_abort_preempt_type(hal_to_dmac_device_stru *pst_hal_device,
                                                        hal_coex_hw_preempt_mode_enum_uint8 en_preempt_type);
extern oal_void hi1103_set_btcoex_abort_qos_null_seq_num(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint32 ul_qosnull_seq_num);
extern oal_void hi1103_set_btcoex_hw_rx_priority_dis(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_bool_enum_uint8 en_hw_rx_prio_dis);
extern oal_void hi1103_set_btcoex_hw_priority_en(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_bool_enum_uint8 en_hw_prio_en);
extern oal_void hi1103_set_btcoex_priority_period(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint16 us_priority_period);
extern oal_void hi1103_set_btcoex_occupied_period(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint16 us_occupied_period);
extern oal_void hi1103_btcoex_get_rf_control(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint16 ul_occupied_period, oal_uint32 *pul_wlbt_mode_sel,
                                             oal_uint16 us_wait_cnt);
extern oal_void hi1103_set_btcoex_sw_all_abort_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_bool_enum_uint8 en_sw_abort_ctrl);
extern oal_void hi1103_set_btcoex_sw_priority_flag(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_bool_enum_uint8 en_sw_prio_flag);
extern oal_void hi1103_set_btcoex_soc_gpreg0(oal_uint8 uc_val, oal_uint16 us_mask, oal_uint8 uc_offset);
extern oal_void hi1103_set_btcoex_soc_gpreg0_replace(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 uc_val, oal_uint16 us_mask, oal_uint8 uc_offset);
extern oal_void hi1103_set_btcoex_soc_gpreg1(oal_uint8 uc_val, oal_uint16 us_mask,
                                             oal_uint8 uc_offset);
extern oal_void hi1103_set_btcoex_soc_gpreg1_replace(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 uc_val, oal_uint16 us_mask,
                                                     oal_uint8 uc_offset);
extern oal_void hi1103_set_btcoex_soc_gpreg2(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_val,
    oal_uint16 us_mask, oal_uint8 uc_offset);
extern oal_void hi1103_btcoex_restore_reg(oal_void);
extern oal_void hi1103_btcoex_recover_reg(oal_void);
#endif

extern oal_void hi1103_tx_get_dscr_iv_word(hal_tx_dscr_stru *pst_dscr, oal_uint32 *pul_iv_ms_word,
                                           oal_uint32 *pul_iv_ls_word, oal_uint8 uc_chiper_type,
                                           oal_uint8 uc_chiper_keyid);
#ifdef _PRE_WLAN_DFT_STAT
extern oal_void hi1103_dft_get_machw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pst_machw_stat, oal_uint8 us_bank_select,
                                               oal_uint32 *pul_len);
extern oal_void hi1103_dft_set_phy_stat_node(hal_to_dmac_device_stru *pst_hal_device,
                                             oam_stats_phy_node_idx_stru *pst_phy_node_idx);
extern oal_void hi1103_dft_get_phyhw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pst_phyhw_stat, oal_uint8 us_bank_select,
                                               oal_uint32 *pul_len);
extern oal_void hi1103_dft_get_rfhw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 *pul_rfhw_stat, oal_uint32 *pul_len,
                                              oal_uint8 uc_rf_select);
extern oal_void hi1103_dft_get_sochw_reg_info(oal_uint32 ul_reg_start_addr, oal_uint32 ul_reg_end_addr,
                                              oal_uint16 **ppus_sochw_stat, oal_uint32 *pul_len);
extern oal_void hi1103_dft_get_sochw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint16 *pst_sochw_stat, oal_uint32 *pul_len,
                                               oal_uint8 uc_bank_select);
...
extern oal_void hi1103_dft_force_report_all_reg_state(hal_to_dmac_device_stru *pst_hal_device);
#endif
...
extern oal_void hi1103_get_cw_signal_reg(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint8 uc_chain_idx, wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1103_revert_cw_signal_reg(hal_to_dmac_device_stru *pst_hal_device,
                                            wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1103_check_test_value_reg(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint16 us_value,
...
extern oal_void hi1103_get_rate_idx_pow(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_pow_idx,
                                        ...
                                        oal_uint8 uc_channel_idx, oal_uint8 uc_chn_idx);
extern oal_void hi1103_get_target_tx_power_by_tx_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                      hal_tx_dscr_ctrl_one_param *pst_tx_dscr_one,
                                                      hal_pdet_info_stru *pst_pdet_info,
                                                      oal_int16 *ps_tx_pow);
extern oal_void hi1103_device_get_5g_min_level_tx_pow(hal_to_dmac_device_stru *pst_hal_device,
                                                      wlan_channel_band_enum_uint8 en_freq_band,
                                                      oal_int16 *ps_tx_pow);
extern oal_void hi1103_device_set_5g_min_level_lowpower(hal_to_dmac_device_stru *pst_hal_device,
                                                        wlan_channel_band_enum_uint8 en_freq_band,
                                                        oal_uint8 uc_switch_flag, oal_uint8 uc_use_type);
...
extern oal_void hi1103_config_update_scaling_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint16 *paus_dbb_scale);
extern oal_void hi1103_config_update_dsss_scaling_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint16 *paus_dbb_scale, oal_uint8 uc_distance);
...
extern oal_void hi1103_config_set_cus_nvram_params(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 *puc_param);
...
extern oal_void hi1103_al_tx_hw_cfg(hal_to_dmac_device_stru *pst_hal_device,
                                    oal_uint32 ul_mode,
                                    oal_uint32 ul_rate);
#ifdef _PRE_WLAN_FEATURE_FTM
...
extern oal_void hi1103_get_ftm_ctrl_status(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint32 *pul_ftm_status);
extern oal_void hi1103_get_ftm_config_status(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_ftm_status);
extern oal_void hi1103_set_ftm_ctrl_status(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint32 ul_ftm_status);
extern oal_void hi1103_set_ftm_config_status(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_ftm_status);
extern oal_void hi1103_set_ftm_enable(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_bool_enum_uint8 en_ftm_status);
extern oal_void hi1103_set_ftm_sample(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_bool_enum_uint8 en_ftm_status);
extern oal_void hi1103_get_ftm_dialog(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_uint8 *puc_dialog);
extern oal_void hi1103_get_ftm_cali_rx_time(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 *pul_ftm_cali_rx_time);
extern oal_void hi1103_get_ftm_cali_rx_intp_time(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint32 *pul_ftm_cali_rx_time);
extern oal_void hi1103_get_ftm_cali_tx_time(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 *pul_ftm_cali_tx_time);
extern oal_void hi1103_set_ftm_cali(hal_to_dmac_device_stru *pst_hal_device,
                                    hal_tx_dscr_stru *pst_tx_dscr,
                                    oal_bool_enum_uint8 en_ftm_cali);
extern oal_void hi1103_set_ftm_tx_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_tx_dscr_stru *pst_tx_dscr,
                                      oal_uint8 uc_ftm_tx_cnt);
extern oal_void hi1103_set_ftm_bandwidth(hal_to_dmac_device_stru *pst_hal_device,
                                         hal_tx_dscr_stru *pst_tx_dscr,
                                         wlan_bw_cap_enum_uint8 en_band_cap);
extern oal_void hi1103_set_ftm_protocol(hal_to_dmac_device_stru *pst_hal_device,
                                        hal_tx_dscr_stru *pst_tx_dscr,
                                        wlan_phy_protocol_enum_uint8 uc_prot_format);
extern oal_void hi1103_set_ftm_m2s(hal_to_dmac_device_stru *pst_hal_device,
                                   hal_tx_dscr_stru *pst_tx_dscr,
                                   oal_uint8 uc_tx_chain_selection);
extern oal_void hi1103_set_ftm_m2s_phy(hal_to_dmac_device_stru *pst_hal_device,
...
#ifdef _PRE_WLAN_FTM_PPU_SUPPORT
extern oal_void hi1103_set_ftm_flag(hal_to_dmac_device_stru *pst_hal_device,
                                    hal_tx_dscr_stru *pst_tx_dscr,
                                    oal_bool_enum_uint8 en_ftm_flag);
extern oal_uint8 hi1103_get_ftm_rx_add1(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 *puc_addr1);
extern oal_void hi1103_set_ftm_buf_base_addr(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_ftm_info_addr);

extern oal_void hi1103_set_ftm_buf_size(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint16 us_cfg_ftm_buf_size);
extern oal_uint32 hi1103_set_ftm_white_list(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint8 uc_index,
                                            oal_uint8 *puc_addr);
#endif
#endif
...
extern oal_int16 hi1103_get_tx_pdet_by_pow(hal_to_dmac_device_stru *OAL_CONST pst_hal_device,
...
extern oal_void hi1103_config_set_dyn_cali_dscr_interval(hal_to_dmac_device_stru *pst_hal_device,
                                                         wlan_channel_band_enum_uint8 uc_band,
                                                         oal_uint16 us_param_val);
#ifdef _PRE_WLAN_DPINIT_CALI
extern oal_void hi1103_config_get_dyn_cali_dpinit_val(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint16 us_param_val);
#endif
extern oal_void hi1103_rf_cali_realtime_entrance(hal_to_dmac_device_stru *OAL_CONST pst_hal_device,
                                                 hal_pdet_info_stru *OAL_CONST pst_pdet_info,
                                                 hal_dyn_cali_usr_record_stru *OAL_CONST pst_user_pow,
...
#ifdef _PRE_WLAN_DFT_REG
extern oal_uint32 hi1103_debug_refresh_reg_ext(hal_to_dmac_device_stru *pst_hal_device,
                                               oam_reg_evt_enum_uint32 en_evt_type,
                                               oal_uint32 *pul_ret);
extern oal_void hi1103_debug_frw_evt(hal_to_dmac_device_stru *pst_hal_device);
#endif

extern oal_void hi1103_get_wow_enable_status(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_status);

#ifdef _PRE_WLAN_CHIP_TEST
extern oal_void hi1103_set_tx_dscr_long_nav_enable(hal_tx_dscr_stru *pst_tx_dscr,
                                                   oal_uint8 uc_en_status);
#endif

#ifdef _PRE_WLAN_CACHE_COHERENT_SUPPORT
extern oal_void hi1103_get_tx_msdu_address_params(hal_tx_dscr_stru *pst_dscr,
                                                  hal_tx_msdu_address_params **ppst_tx_dscr_msdu_subtable,
...
extern oal_void hi1103_flush_rx_queue_complete_irq(hal_to_dmac_device_stru *pst_hal_dev,
                                                   hal_rx_dscr_queue_id_enum_uint8 en_queue_num);
...
extern oal_void hi1103_device_get_tx_pow_from_rate_idx(hal_to_dmac_device_stru *pst_hal_device,
                                                       hal_user_pow_info_stru *pst_hal_user_pow_info,
                                                       wlan_channel_band_enum_uint8 en_freq_band,
...
#ifdef _PRE_WLAN_1103_CHR
extern oal_void hi1103_get_phy_mac_chr_info(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_phy_mac_chr_info_stru *pst_phy_mac_chr_info);
#endif
extern oal_uint32 hi1103_get_subband_index(wlan_channel_band_enum_uint8 en_band,
                                           oal_uint8 uc_channel_idx,
...
extern oal_void hi1103_get_abort_timers_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint8 *uc_abort_cnt);
#if ((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1105_DEV))
#ifdef _PRE_WLAN_FEATURE_BT_20DBM
extern oal_uint16 hi1103_bt20dbm_enable_status(oal_void);
extern oal_void hi1103_bt20dbm_occupy_set_process(oal_bool_enum_uint8 en_occupy,
                                                  hal_btcoex_rf_20dbm_occu_enum_uint8 en_type);
#endif
extern oal_uint32 hi1103_comb_pow_code(oal_bool_enum_uint8 en_dpd_enable, oal_uint8 uc_upc_idx,
                                       oal_uint8 uc_pa_idx, oal_uint8 uc_dac_idx,
                                       oal_uint8 uc_lpf_idx, oal_uint16 us_delta_dbb_scaling,
...
extern oal_void hi1103_get_phy_power0_ref_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_status);
extern oal_void hi1103_get_phy_extlna_gain_info(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint32 *pul_gain0_status, oal_uint32 *pul_gain1_status);
extern oal_void hi1103_get_phy_adc_pin_code_info(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint32 *pul_status);
extern oal_void hi1103_get_11b_rate_code(hal_wlan_11b_rate_enum_uint8 en_rate_index,
                                         oal_uint8 *puc_rate_code);
extern oal_void hi1103_get_11ag_rate_code(hal_wlan_legacy_ofdm_rate_enum en_rate_index,
                                          oal_uint8 *puc_rate_code);
...
#endif
extern oal_void hi1103_get_efuse_reg_value(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint16 *pus_value_buf,
                                           oal_uint8 uc_buf_size);
#ifdef _PRE_WLAN_FEATURE_FULL_QUAN_PROD_CAL
extern oal_void hi1103_set_pdet_info_report_param(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 en_report_flag,
                                                  oal_uint8 uc_full_data_coll_idx);
extern oal_void hi1103_pow_refresh_full_cali_pro_line_data(hal_to_dmac_device_stru *pst_hal_device,
                                                           hal_pdet_info_stru *OAL_CONST pst_pdet_info);
#endif
#ifdef _PRE_WLAN_FEATURE_MLD_AGC_BUGFIX
extern oal_void hi1103_set_agc_target_adjust(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_phy_agc_target_adjust_enmu_uint8 en_agc_target_adjust_type);
#endif
extern oal_void hi1103_set_ru_test(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint16 us_aid,
                                   oal_uint16 us_rudir, oal_uint32 *pul_ret);
#endif




#if ((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1105_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1105_HOST))
/* 1105 degin */
/************************  1103  CHIP********************************************/
#define HAL_CHIP_LEVEL_FUNC_EXTERN
...
extern oal_void hi1105_set_sifs_resp_rate(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_rate_restrict);
extern oal_void hi1105_set_tx_lifetime_check(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_bool_enum_uint8 en_rate_restrict);
...
#endif
extern oal_void hi1105_tx_fill_basic_ctrl_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_tx_dscr_stru *p_tx_dscr,
                                               hal_tx_mpdu_stru *pst_mpdu);
extern oal_void hi1105_tx_ctrl_dscr_link(hal_tx_dscr_stru *pst_tx_dscr_prev,
                                         hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1105_get_tx_dscr_next(hal_tx_dscr_stru *pst_tx_dscr,
                                        hal_tx_dscr_stru **ppst_tx_dscr_next);
...
#ifdef _PRE_WLAN_FEATURE_AMPDU_TX_HW
extern oal_void hi1105_tx_get_dscr_seqnum(hal_tx_dscr_stru *pst_tx_dscr,
                                          oal_uint16 *pus_seqnum,
                                          oal_uint8 *puc_valid);
#endif
...
extern oal_void hi1105_tx_non_ucast_data_set_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                  ...
                                                  hal_tx_txop_alg_stru *pst_txop_alg,
                                                  hal_tx_ppdu_feature_stru *pst_ppdu_feature);
extern oal_void hi1105_tx_set_dscr_modify_mac_header_length(hal_tx_dscr_stru *pst_tx_dscr,
                                                            oal_uint8 uc_mac_header_length);
extern oal_void hi1105_tx_set_dscr_seqno_sw_generate(hal_tx_dscr_stru *pst_tx_dscr,
                                                     oal_uint8 uc_sw_seqno_generate);
extern oal_void hi1105_tx_get_size_dscr(oal_uint8 us_msdu_num,
                                        oal_uint32 *pul_dscr_one_size,
                                        oal_uint32 *pul_dscr_two_size);
extern oal_void hi1105_tx_get_vap_id(hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 *puc_vap_id);
extern oal_void hi1105_tx_get_dscr_ctrl_one_param(hal_tx_dscr_stru *pst_tx_dscr,
                                                  hal_tx_dscr_ctrl_one_param *pst_tx_dscr_one_param);
extern oal_void hi1105_tx_update_dscr_para_hw(hal_tx_dscr_stru *pst_tx_dscr,
                                              hal_tx_dscr_ctrl_one_param *pst_tx_dscr_one_param);
...
extern oal_void hi1105_tx_retry_clear_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_tx_dscr_stru *pst_tx_dscr);
#ifdef _PRE_WLAN_FIT_BASED_REALTIME_CALI
extern oal_void hi1105_tx_set_pdet_en(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_tx_dscr_stru *pst_tx_dscr,
                                      oal_bool_enum_uint8 en_pdet_en_flag);
extern oal_void hi1105_dyn_cali_tx_pow_ch_set(hal_to_dmac_device_stru *pst_hal_device,
                                              hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1105_dyn_cali_tx_pa_ppa_swtich(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_bool_enum_uint8 en_ppa_working);
extern oal_void hi1105_dyn_cali_al_tx_config_amend(hal_to_dmac_device_stru *pst_hal_device,
                                                   hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1105_dyn_cali_vdet_val_amend(hal_to_dmac_device_stru *pst_hal_device,
                                               wlan_channel_band_enum_uint8 en_freq,
                                               oal_uint8 uc_rf_id, oal_int32 l_vdet_val_in,
                                               oal_int16 *ps_det_val_out, oal_int16 s_vdet_offset);
extern oal_int16 hi1105_dyn_cali_get_gm_val(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_rf_id);
extern oal_void hi1105_dyn_cali_get_tx_power_dc(hal_to_dmac_device_stru *pst_hal_device,
                                                wlan_channel_band_enum_uint8 en_freq,
                                                oal_uint8 uc_rf_id, oal_int16 *ps_tx_power_dc,
                                                oal_bool_enum_uint8 en_ppa_working);
#endif
extern oal_void hi1105_tx_get_bw_mode(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_tx_dscr_stru *pst_dscr,
                                      wlan_bw_cap_enum_uint8 *pen_bw_mode);
extern oal_void hi1105_tx_get_dscr_status(hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 *puc_status);
extern oal_void hi1105_tx_get_dscr_send_rate_rank(hal_tx_dscr_stru *pst_tx_dscr,
                                                  oal_uint8 *puc_send_rate_rank);
extern oal_void hi1105_tx_get_dscr_chiper_type(hal_tx_dscr_stru *pst_tx_dscr,
                                               oal_uint8 *puc_chiper_type,
                                               oal_uint8 *puc_chiper_key_id);
...
extern oal_void hi1105_tx_put_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                   hal_tx_queue_type_enum_uint8 en_tx_queue_type,
                                   hal_tx_dscr_stru *past_tx_dscr);
extern oal_void hi1105_get_tx_q_status(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_status,
                                       oal_uint8 uc_q_offset, oal_uint8 uc_qnum);
extern oal_void hi1105_get_tx_multi_q_status(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_status,
                                             oal_uint8 uc_q_offset,
                                             oal_uint8 uc_qnum);
extern oal_void hi1105_tx_get_ampdu_len(hal_to_dmac_device_stru *pst_hal_device, hal_tx_dscr_stru *pst_dscr,
                                        oal_uint32 *pul_ampdu_len);
extern oal_void hi1105_set_bcn_timeout_multi_q_enable(hal_to_dmac_vap_stru *pst_hal_vap,
                                                      oal_uint8 uc_enable);
extern oal_void hi1105_get_prot_datarate(oal_uint8 uc_prot_rate_index, oal_uint32 *pul_value);
extern oal_void hi1105_tx_get_protocol_mode(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_tx_dscr_stru *pst_dscr,
                                            oal_uint8 *puc_protocol_mode);
extern oal_void hi1105_dscr_addr_check(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 *hwq);
extern oal_void hi1105_rx_get_info_dscr(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_rx_dscr,
                                        hal_rx_ctl_stru *pst_rx_ctl, hal_rx_status_stru *pst_rx_status,
                                        hal_rx_statistic_stru *pst_rx_statistics);
extern oal_void hi1105_get_hal_vap(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_vap_id,
                                   hal_to_dmac_vap_stru **ppst_hal_vap);
extern oal_void hi1105_rx_get_netbuffer_addr_dscr(oal_uint32 *pul_rx_dscr,
                                                  oal_netbuf_stru **ppul_mac_hdr_addr);
extern oal_void hi1105_rx_show_dscr_queue_info(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_rx_dscr_queue_id_enum_uint8 en_rx_dscr_type);
extern oal_void hi1105_rx_print_phy_debug_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_rx_dscr,
                                               hal_rx_status_stru *pst_rx_status,
                                               hal_rx_statistic_stru *pst_rx_statistics);
extern oal_void hi1105_rx_record_frame_status_info(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint32 *pul_rx_dscr,
                                                   hal_rx_dscr_queue_id_enum_uint8 en_queue_id);
extern oal_void hi1105_rx_free_dscr_list(hal_to_dmac_device_stru *pst_hal_device,
                                         hal_rx_dscr_queue_id_enum_uint8 en_queue_num,
                                         oal_uint32 *pul_rx_dscr);
...
extern oal_void hi1105_reg_write16(hal_to_dmac_device_stru *pst_hal_device,
                                   oal_uint32 ul_addr,
                                   oal_uint16 us_val);
#ifdef _PRE_WLAN_FEATURE_DATA_SAMPLE
extern oal_void hi1105_set_sample_memory(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint32 **pul_start_addr,
                                         oal_uint32 *pul_reg_num);
...
extern oal_void hi1105_get_single_psd_sample(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint16 us_index,
                                             oal_int8 *pc_psd_val);
...
extern oal_void hi1105_set_psd_ofdm_det_en(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint32 ul_reg_value);
...
extern oal_void hi1105_set_psd_ofdm_disable(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1105_set_psd_fft_priority(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1105_set_psd_p2dbm_offset(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_int32 l_reg_value);
extern oal_void hi1105_set_bypass_auto_pg(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_uint32 ul_reg_value);
extern oal_void hi1105_set_psd_the_bottom_noise(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_int32 l_reg_value);
extern oal_void hi1105_set_psd_the_num_nb(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_uint32 ul_reg_value);
extern oal_void hi1105_set_psd_the_power_nb(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1105_set_psd_the_rssi_nb(hal_to_dmac_device_stru *pst_hal_device, oal_int32 l_reg_value);
extern oal_void hi1105_get_psd_data(hal_to_dmac_device_stru *pst_hal_device,
                                    oal_int8 *pc_start_addr,
                                    oal_uint32 *pul_psd_data_len);
extern oal_void hi1105_set_sync_data_path_div_num(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_set_force_reg_clk_on(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1105_get_psd_info(hal_to_dmac_device_stru *pst_hal_device);
#endif
extern oal_void  hi1105_rx_get_evm_info(oal_uint8 uc_origin_data, oal_int8 *pc_evm);
extern oal_void  hi1105_rx_get_snr_info(oal_uint8 uc_origin_data, oal_int8 *pc_snr);

#ifdef _PRE_WLAN_FEATURE_HIEX
extern void hi1105_set_himit_ctrl(hal_to_dmac_device_stru *pst_hal_device);
extern void hi1105_set_himit_info_report_reg(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_set_peer_sta_himit_en(hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_himit_enable, oal_uint16 us_lut_idx);
extern oal_uint32 hi1105_set_himit_dscr(hal_to_dmac_device_stru *pst_hal_device, hal_tx_dscr_stru *pst_tx_dscr,
    hal_tx_ppdu_feature_stru *pst_ppdu_feature, OAL_CONST oal_void *hiex_report_data,
    mac_hiex_msg_type_enum_uint8 en_type, oal_uint8 uc_size);
extern oal_void hi1105_tx_complete_get_himit_dscr(hal_tx_dscr_stru *pst_tx_dscr,
    hal_tx_dscr_ctrl_one_param *pst_tx_dscr_one_param);
extern oal_void hi1105_himit_free_tx_dscr(hiex_tx_himit_dscr_stru *pst_tx_dscr);
extern oal_uint32 hi1105_rx_get_himit_info(oal_uint32 *pul_rx_dscr, hiex_rx_himit_dscr_stru *pst_rx_himit_dscr);
#ifdef _PRE_WLAN_FEATURE_HIEX_DBG
extern oal_void hi1105_tx_complete_himit_dump(hal_tx_dscr_stru *pst_tx_dscr);
#endif
#endif

extern oal_void hi1105_pg_efficiency_statistics_enable(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 ul_switch);
extern oal_void hi1105_report_pg_efficiency_info(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint32 ul_report_switch);

extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_status(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_bw(hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_protocol(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_fr_type(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_fr_sub_type(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_ampdu(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_psdu(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint8 uc_index,
                                                           oal_uint32 ul_value);
extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_hw_retry(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_tx_common_cnt_ctrl_reg_clear(hal_to_dmac_device_stru *pst_hal_device,
                                                            oal_uint8 uc_index,
                                                            oal_uint32 ul_value);

extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_status(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_bw(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint8 uc_index,
                                                         oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_protocol(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_fr_type(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_fr_sub_type(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_ampdu(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_psdu(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint8 uc_index,
                                                           oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_vap_mode(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_bss(hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_direct(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index, oal_uint32 ul_value);
extern oal_void hi1105_set_mac_rx_common_cnt_ctrl_reg_clear(hal_to_dmac_device_stru *pst_hal_device,
                                                            oal_uint8 uc_index, oal_uint32 ul_value);
...
#ifdef _PRE_WLAN_FEATURE_11AX
#ifdef _PRE_WLAN_FEATURE_BQRP
extern oal_void hi1105_set_he_bqr_htc_fld(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_uint8 uc_available_ch_bitmap);
#endif
extern oal_void hi1105_set_he_tb_ndp_feedback_status(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 uc_ndp_feedback_status);
extern oal_void hi1105_set_queue_size(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_uint16 us_qos_ctrl_fld,
                                      oal_uint8 uc_ac_type);
extern oal_void hi1105_get_tb_basic_trigger_txtime(hal_to_dmac_device_stru *pst_hal_device,
    hal_tx_ul_ofdma_para_stru *pst_tb_para);
extern oal_void hi1105_get_tb_ppdu_pwr_para(hal_to_dmac_device_stru *pst_device,
                                            hal_tb_ppdu_tpc_code_stru *pst_tb_tpc_ctrl);
extern oal_void hi1105_set_dev_support_11ax(hal_to_dmac_device_stru *pst_hal_device,
    hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 uc_reg_value);
extern oal_void hi1105_set_mu_edca_lifetime(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint8 uc_ac_type,
                                            oal_uint8 uc_lifetime);
extern oal_void hi1105_set_mu_edca_aifsn(hal_to_dmac_device_stru *pst_hal_device,
                                         ...
                                         oal_uint8 uc_vi,
                                         oal_uint8 uc_vo);
extern oal_void hi1105_set_mu_edca_cw(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_ac_type,
                                      oal_uint8 uc_cwmax, oal_uint8 uc_cwmin);
...
extern oal_void hi1105_set_su_edca_suspend(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint8 uc_ac_type, oal_uint8 uc_suspend);
extern oal_void hi1105_set_bss_color(hal_to_dmac_device_stru *pst_hal_device,
                                     hal_to_dmac_vap_stru *pst_hal_vap,
                                     oal_uint8 uc_bss_color);
extern oal_void hi1105_set_partial_bss_color(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_to_dmac_vap_stru *pst_hal_vap,
                                             oal_uint8 uc_partial_bss_color);
extern oal_void hi1105_get_mu_edca_print(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_enable_phase_accum(hal_to_dmac_device_stru *pst_hal_device,
                                          hal_phase_accum_select_enum_uint8 en_select);
extern oal_void hi1105_set_obss_pd_lv(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_int8 c_pd_level,
                                      oal_int8 c_pd_min_default);
extern oal_void hi1105_set_mac_rx_clken(hal_to_dmac_device_stru *pst_hal_device,
    oal_bool_enum_uint8 en_wctrl_enable);

extern oal_void hi1105_set_srg_bss_color_bitmap(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint32 ul_bitmap_low,
                                                oal_uint32 ul_bitmap_high);
extern oal_void hi1105_set_srg_partial_bssid_bitmap(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint32 ul_bitmap_low,
                                                    oal_uint32 ul_bitmap_high);
extern oal_void hi1105_set_spatial_reuse_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 en_flag);
extern oal_void hi1105_set_he_trigger_insert_htc_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_bool_enum_uint8 en_flag);
...
extern oal_void hi1105_set_he_tb_tx_uph_sw_en(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 en_flag);
extern oal_void hi1105_set_he_tb_htc_uph_allow_id(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_uph_allow_id);
extern oal_void hi1105_pow_get_he_trig_max_pow_params(hal_to_dmac_device_stru *pst_device,
    hal_tx_ul_ofdma_para_stru *pst_ul_ofdma_para);
extern oal_void hi1105_set_he_rom_en(hal_to_dmac_device_stru *pst_hal_device,
                                     oal_bool_enum_uint8 en_rx_om);
...
extern oal_void hi1105_set_sta_multi_bssid_en(hal_to_dmac_vap_stru *pst_hal_vap,
                                              oal_bool_enum_uint8 en_status);
extern oal_void hi1105_set_multi_bss_mgmt_flt_en(hal_to_dmac_vap_stru *pst_hal_vap,
                                                 oal_bool_enum_uint8 en_status);
extern oal_void hi1105_set_multi_bss_data_flt_en(hal_to_dmac_vap_stru *pst_hal_vap,
                                                 oal_bool_enum_uint8 en_status);
#endif
#ifdef _PRE_WLAN_FEATURE_CSI
extern oal_void hi1105_set_csi_buf_base_addr(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_ftm_info_addr);
extern oal_void hi1105_set_csi_buf_size(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint16 us_cfg_csi_buf_size);
...
extern oal_void hi1105_set_csi_sample_period(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_reg_value);
extern oal_void hi1105_set_csi_phy_report_mode(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 uc_reg_value);
...
extern oal_void hi1105_get_phy_csi_info(hal_to_dmac_device_stru *pst_hal_device,
                                        wlan_channel_bandwidth_enum_uint8 *pen_bandwidth,
                                        oal_uint8 *puc_frame_type);
...
extern oal_void hi1105_get_pktmem_start_addr(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 **pul_reg_num);
extern oal_void hi1105_get_pktmem_end_addr(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint32 **pul_reg_num);

extern oal_void hi1105_get_csi_frame_type(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_uint8 *puc_he_flag,
                                          oal_uint8 *puc_frame_type);
...
extern oal_void hi1105_get_beacon_miss_value(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_val);
...
extern oal_void hi1105_get_tx_hi_pri_mpdu_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 *pul_val);
#endif
...
extern oal_void hi1105_set_machw_rx_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 ul_rx_dscr,
                                              hal_rx_dscr_queue_id_enum_uint8 en_queue_num);
extern oal_uint32 hi1105_set_machw_rx_buff_addr_sync(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 *ul_rx_dscr,
                                                     hal_rx_dscr_queue_id_enum_uint8 en_queue_num);
extern oal_void hi1105_rx_add_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                   hal_rx_dscr_queue_id_enum_uint8 en_queue_num,
                                   oal_uint16 us_rx_dscr_num);
extern oal_void hi1105_tx_get_dscr_trigger_based_flag(hal_tx_dscr_stru *pst_ba_dscr,
                                                      oal_uint8 *puc_trigger_flag);
extern oal_void hi1105_rx_add_dscr_th(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_rx_dscr_queue_id_enum_uint8 en_queue_num,
                                      oal_uint16 us_rx_dscr_num);
extern oal_void hi1105_rx_update_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_rx_dscr_queue_id_enum_uint8 en_queue_num,
                                      oal_uint16 us_rx_dscr_num);
extern oal_void hi1105_recycle_rx_isr_list(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_dlist_head_stru *pst_rx_isr_list);
...
extern oal_void hi1105_reset_phy_machw(hal_to_dmac_device_stru *pst_hal_device,
                                       hal_reset_hw_type_enum_uint8 en_type,
                                       oal_uint8 sub_mod, oal_uint8 uc_reset_phy_reg,
                                       oal_uint8 uc_reset_mac_reg);
...
#ifdef _PRE_WLAN_FEATURE_AMPDU_TX_HW
extern oal_void hi1105_set_ampdu_tx_hw_on(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_enable,
                                          oal_uint8 uc_snd_type);
#endif
extern oal_void hi1105_initialize_machw_common(hal_to_dmac_device_stru *pst_hal_device);

extern oal_void hi1105_set_freq_band(hal_to_dmac_device_stru *pst_hal_device,
                                     wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1105_set_bandwidth_mode(hal_to_dmac_device_stru *pst_hal_device,
                                          wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
#endif
extern oal_void hi1105_set_primary_channel(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint8 uc_channel_num,
                                           wlan_channel_band_enum_uint8 en_band,
                                           oal_uint8 uc_channel_idx,
                                           wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void hi1105_set_mac_phy_freq(hal_to_dmac_device_stru *pst_hal_device,
                                        wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void hi1105_set_power_test(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_en);
#ifdef _PRE_WLAN_PHY_PERFORMANCE
extern oal_void hi1105_set_phy_tx_scale(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_bool_enum_uint8 en_2g_11ac);
#endif
...
extern oal_void hi1105_remove_machw_ba_lut_entry(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint8 uc_lut_index);
extern oal_void hi1105_get_machw_ba_params(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_index,
                                           oal_uint32 *pst_addr_h, oal_uint32 *pst_addr_l, oal_uint32 *pst_bitmap_h,
                                           oal_uint32 *pst_bitmap_l, oal_uint32 *pst_ba_para);
extern oal_void hi1105_restore_machw_ba_params(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 uc_index, oal_uint32 ul_addr_h,
                                               oal_uint32 ul_addr_l, oal_uint32 ul_ba_para);
extern oal_void hi1105_machw_seq_num_index_update_per_tid(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint8 uc_lut_index,
                                                          oal_uint8 uc_qos_flag);
extern oal_void hi1105_set_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint8 uc_lut_index, oal_uint8 uc_tid,
                                           oal_uint8 uc_qos_flag, oal_uint32 ul_val_write,
                                           oal_uint8 uc_vap_index);
extern oal_void hi1105_get_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint8 uc_lut_index, oal_uint8 uc_tid,
                                           oal_uint8 uc_qos_flag, oal_uint8 uc_vap_index,
                                           oal_uint32 *pst_val_read);
extern oal_void hi1105_get_tx_seq_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index,
                                      oal_uint8 uc_tid, oal_uint8 uc_qos_flag,
                                      oal_uint8 uc_vap_index, oal_uint16 *pst_val_read);
extern oal_void hi1105_set_phy_freq_factor(
                hal_to_dmac_device_stru          *pst_hal_device,
                oal_uint8                         uc_channel_num,
                wlan_channel_band_enum_uint8      en_band,
                wlan_channel_bandwidth_enum_uint8   en_bandwidth);
#ifdef _PRE_WLAN_FEATURE_AMPDU_TX_HW
extern oal_void hi1105_save_tx_ba_para(hal_to_dmac_device_stru *pst_hal_device,
                                       hal_ba_para_stru *pst_ba_para);
extern oal_void hi1105_get_tx_ba_para(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_ba_para_stru *pst_ba_para);
#endif
...
extern oal_void hi1105_reset_reg_restore(hal_to_dmac_device_stru *pst_hal_device,
                                         hal_reset_hw_type_enum_uint8 en_type);
extern oal_void hi1105_reset_reg_save(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_reset_hw_type_enum_uint8 en_type);
extern oal_void hi1105_reset_reg_dma_save(hal_to_dmac_device_stru *pst_hal, oal_uint8 *uc_dmach0,
                                          oal_uint8 *uc_dmach1, oal_uint8 *uc_dmach2);
extern oal_void hi1105_reset_reg_dma_restore(hal_to_dmac_device_stru *pst_hal, oal_uint8 *uc_dmach0,
                                             oal_uint8 *uc_dmach1, oal_uint8 *uc_dmach2);
...
extern oal_void hi1105_dfs_set_fft_pg(hal_to_dmac_device_stru *p_hal_device, oal_bool_enum_uint8 is_status);
extern oal_void hi1105_radar_config_reg(hal_to_dmac_device_stru *pst_hal_device,
                                        hal_dfs_radar_type_enum_uint8 en_dfs_domain);
extern oal_void hi1105_radar_config_reg_bw(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_dfs_radar_type_enum_uint8 en_radar_type,
                                           wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void hi1105_radar_enable_chirp_det(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 en_chirp_det);
...
extern oal_void hi1105_pow_set_rf_regctl_enable(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_bool_enum_uint8 en_rf_linectl);
...
extern oal_void hi1105_pow_set_band_spec_frame_tx_power(hal_to_dmac_device_stru *pst_hal_device,
                                                        wlan_channel_band_enum_uint8 en_band, oal_uint8 uc_chan_idx,
                                                        hal_rate_pow_code_gain_tbl_stru *pst_rate_pow_table);
extern oal_void hi1105_pow_get_spec_frame_data_rate_idx(oal_uint32 ul_data_rate,
                                                        oal_uint8 *puc_rate_idx);
extern oal_void hi1105_pow_get_dscr_control_frame_rate_idx(void *p_data_rate,
                                                           oal_uint8 *puc_rate_idx);
...
#ifdef _PRE_WLAN_FEATURE_USER_RESP_POWER
extern oal_void hi1105_pow_set_user_resp_frame_tx_power(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint8 uc_lut_index,
                                                        oal_uint8 uc_rssi_distance);
extern oal_void hi1105_pow_oper_machw_resp_power_lut_entry(
    hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_lut_index,
    hal_oper_pow_lut_oper_type_enum_uint8 en_rsp_pow_oper);
extern oal_void hi1105_pow_set_user_resp_frm_phy_tx_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                         wlan_channel_band_enum_uint8 en_band,
                                                         oal_uint8 uc_subband_idx);
#endif
...
extern oal_void hi1105_pow_cfg_no_margin_pow_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_pow_mode);
extern oal_void hi1105_pow_cfg_show_log(hal_to_dmac_device_stru *pst_hal_device,
                                        hal_vap_pow_info_stru *pst_vap_pow_info,
                                        wlan_channel_band_enum_uint8 en_freq_band,
                                        oal_uint8 *puc_rate_idx);
extern oal_void hi1105_pow_show_single_tpc_mem(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 uc_tpc_idx);
...
extern oal_void hi1105_update_upc_amend_by_tas(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 uc_chn_idx,
                                               oal_bool_enum_uint8 en_need_improved);
#endif
...
#endif
extern oal_void hi1105_cali_matrix_data_send_func(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 *puc_matrix_data,
                                                  oal_uint16 us_frame_len,
                                                  oal_uint16 us_remain);
extern oal_void hi1105_cali_send_func(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 *puc_cali_data,
                                      oal_uint16 us_frame_len, oal_uint16 us_remain);
...
extern oal_void hi1105_get_mac_error_int_status(hal_to_dmac_device_stru *pst_hal_device,
                                                hal_error_state_stru *pst_state);
extern oal_void hi1105_clear_mac_error_int_status(hal_to_dmac_device_stru *pst_hal_device,
                                                  hal_error_state_stru *pst_status);
extern oal_void hi1105_unmask_mac_init_status(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 ul_status);
...
extern oal_void hi1105_add_vap(hal_to_dmac_device_stru *pst_hal_device, wlan_vap_mode_enum_uint8 vap_mode,
                               oal_uint8 uc_mac_vap_id, hal_to_dmac_vap_stru **ppst_hal_vap);
extern oal_void hi1105_del_vap(hal_to_dmac_device_stru *pst_hal_device,

                               wlan_vap_mode_enum_uint8 vap_mode,
                               oal_uint8 vap_id);
#ifdef _PRE_WLAN_FEATURE_M2S
extern oal_void hi1105_update_datarate_by_chain(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint8 uc_resp_tx_chain);
#endif
...
#endif
extern oal_void hi1105_config_eifs_time(hal_to_dmac_device_stru *pst_hal_device,
                                        wlan_protocol_enum_uint8 en_protocol);
extern oal_void hi1105_register_alg_isr_hook(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_isr_type_enum_uint8 en_isr_type,
                                             hal_alg_noify_enum_uint8 en_alg_notify,
                                             p_hal_alg_isr_func p_func);
extern oal_void hi1105_unregister_alg_isr_hook(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_isr_type_enum_uint8 en_isr_type,
                                               hal_alg_noify_enum_uint8 en_alg_notify);
extern oal_void hi1105_register_gap_isr_hook(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_isr_type_enum_uint8 en_isr_type,
                                             p_hal_alg_isr_func p_func);
extern oal_void hi1105_unregister_gap_isr_hook(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_isr_type_enum_uint8 en_isr_type);
extern oal_void hi1105_rx_set_trlr_report_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 *auc_config_val, oal_uint8 uc_trlr_switch);
extern oal_void hi1105_one_packet_start(struct tag_hal_to_dmac_device_stru *pst_hal_device,
                                        hal_one_packet_cfg_stru *pst_cfg);
extern oal_void hi1105_one_packet_stop(struct tag_hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_one_packet_get_status(struct tag_hal_to_dmac_device_stru *pst_hal_device,
                                             hal_one_packet_status_stru *pst_status);
...
extern oal_void hi1105_clear_hw_queue(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 hwq);
extern oal_void hi1105_mask_interrupt(struct tag_hal_to_dmac_device_stru *pst_hal_device,
                                      oal_uint32 ul_offset);
extern oal_void hi1105_unmask_interrupt(struct tag_hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint32 ul_offset);
extern oal_void hi1105_reg_info(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_addr, oal_uint32 *pul_val);
extern oal_void hi1105_reg_info16(hal_to_dmac_device_stru *pst_hal_device,
                                  oal_uint32 ul_addr,
                                  oal_uint16 *pus_val);
extern oal_void hi1105_read_rf_reg(hal_to_dmac_device_stru *pst_hal_device,
                                   oal_uint16 us_reg_addr,
                                   oal_uint16 *pus_reg_val);
extern oal_void hi1105_write_rf_reg(hal_to_dmac_device_stru *pst_hal_device,
                                    oal_uint16 us_rf_addr_offset,
                                    oal_uint16 us_rf_16bit_data);

#ifdef _PRE_WLAN_ONLINE_DPD
extern oal_void hi1105_dpd_config(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 *puc_val);
extern oal_void hi1105_dpd_cfr_set_work_mode(hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_set_type, oal_uint8 uc_value);
extern oal_bool_enum_uint8 hi1105_device_dpd_is_on(hal_to_dmac_device_stru *pst_hal_device,
    wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1105_dpd_cfr_switch_config(hal_to_dmac_device_stru *pst_hal_device,
    wlan_channel_band_enum_uint8 en_band);
#endif

extern oal_void hi1105_get_all_tx_q_status(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint32 *pul_val,
                                           oal_uint8 uc_q_offset_id);
extern oal_void hi1105_get_ampdu_bytes(hal_to_dmac_device_stru *pst_hal_device,
                                       oal_uint32 *pul_tx_bytes,
                                       oal_uint32 *pul_rx_bytes);
...
extern oal_void hi1105_mac_error_msg_report(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_mac_error_type_enum_uint8 en_error_type);
extern oal_void hi1105_get_dieid(hal_to_dmac_device_stru *pst_hal_device,
                                 oal_uint32 *pul_dieid,
                                 oal_uint32 *pul_length);
...
extern oal_void hi1105_ce_add_key(hal_to_dmac_device_stru *pst_hal_device,
                                  hal_security_key_stru *pst_security_key,
                                  oal_uint8 *puc_addr);
extern oal_void hi1105_ce_del_key(hal_to_dmac_device_stru *pst_hal_device,
                                  hal_security_key_stru *pst_security_key);
extern oal_void hi1105_ce_get_key(hal_to_dmac_device_stru *pst_hal_device,
                                  hal_security_key_stru *pst_security_key);
extern oal_void hi1105_disable_ce(hal_to_dmac_device_stru *pst_device);
extern oal_void hi1105_ce_add_peer_macaddr(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_idx,
                                           oal_uint16 us_user_idx, oal_uint8 *puc_addr);
...
#ifdef _PRE_WLAN_INIT_PTK_TX_PN
extern oal_void hi1105_tx_get_dscr_phy_mode_one(hal_tx_dscr_stru *pst_tx_dscr,
                                                oal_uint32 *pul_phy_mode_one);
extern oal_void hi1105_tx_get_ra_lut_index(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_tx_dscr_stru *pst_dscr,
                                           oal_uint8 *puc_ra_lut_index);
extern oal_void hi1105_init_ptk_tx_pn(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_security_key_stru *pst_security_key,
                                      oal_uint32 ul_pn_msb);
#endif
...
extern oal_void hi1105_set_ch_measurement_period(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint8 uc_period);
extern oal_void hi1105_get_ch_statics_result(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_ch_statics_irq_event_stru *pst_ch_statics);
extern oal_void hi1105_get_ch_measurement_result(hal_to_dmac_device_stru *pst_hal_device,
                                                 hal_ch_statics_irq_event_stru *pst_ch_statics);
#ifdef _PRE_WLAN_FEATURE_BQRP
...
extern oal_void hi1105_get_radar_det_result(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_radar_det_event_stru *pst_radar_info);
extern oal_void hi1105_radar_get_pulse_info(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_radar_pulse_info_stru *pst_pulse_info);
extern oal_void hi1105_radar_clean_pulse_buf(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_update_rts_rate_params(hal_to_dmac_device_stru *pst_hal_device,
                                              wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1105_set_rts_rate_params(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_cfg_rts_tx_param_stru *pst_hal_rts_tx_param);
extern oal_void hi1105_set_rts_rate_selection_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 uc_rts_rate_select_mode);
extern oal_void hi1105_set_agc_track_ant_sel(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_agc_track_ant_sel);
extern oal_void hi1105_get_agc_track_ant_sel(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_agc_track_ant_sel);
extern oal_void hi1105_set_prot_resp_frame_chain(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint8 uc_chain_val);
...
extern oal_void hi1105_set_spec_frm_phy_tx_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint8 uc_band, oal_uint8 uc_subband_idx);
...
extern oal_void hi1105_set_resp_pow_level(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_int8 c_near_distance_rssi, oal_int8 c_far_distance_rssi);
extern oal_void hi1105_rf_regctl_enable_set_regs(hal_to_dmac_device_stru *pst_hal_device,
                                                 wlan_channel_band_enum_uint8 en_freq_band,
                                                 oal_uint8 uc_cur_ch_num,
                                                 wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
#endif
#endif
extern oal_void hi1105_set_legacy_matrix_buf_pointer(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 ul_matrix);
extern oal_void hi1105_get_legacy_matrix_buf_pointer(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 *pul_matrix);
extern oal_void hi1105_set_vht_report_rate(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_rate);
extern oal_void hi1105_set_vht_report_phy_mode(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 ul_phy_mode);
...
extern oal_void hi1105_set_ndpa_duration(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint32 ul_ndpa_duration);
extern oal_void hi1105_set_ndp_group_id(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint8 uc_group_id,
                                        oal_uint16 us_partial_id);
extern oal_void hi1105_set_phy_legacy_bf_en(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1105_set_phy_txbf_legacy_en(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 ul_reg_value);
...
extern oal_void hi1105_set_ht_buffer_pointer(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_reg_value);
extern oal_void hi1105_delete_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_lut_index);
extern oal_void hi1105_set_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint8 uc_lut_index,
                                         oal_uint32 ul_reg_value);
extern oal_void hi1105_get_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint8 uc_lut_index,
                                         oal_uint32 *pst_reg_value);
extern oal_void hi1105_set_h_matrix_timeout(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_reg_value);
extern oal_void hi1105_set_dl_mumimo_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_enable);
extern oal_void hi1105_get_dl_mumimo_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 *en_enable);
extern oal_void hi1105_set_mu_aid_matrix_info(hal_to_dmac_device_stru *pst_hal_device,
                                              hal_to_dmac_vap_stru *pst_hal_vap,
                                              oal_uint16 us_aid);
extern oal_void hi1105_set_sta_membership_status_63_32(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 value);
extern oal_void hi1105_set_sta_membership_status_31_0(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint32 ul_value);
...
extern oal_void hi1105_set_bfer_subcarrier_ng(hal_to_dmac_device_stru *pst_hal_device,
                                              wlan_bw_cap_enum_uint8 en_user_bw);
extern oal_void hi1105_set_txbf_vht_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
                                              hal_to_dmac_vap_stru *pst_hal_vap,
                                              oal_uint32 ul_addr, oal_uint16 us_buffer_len);
#ifdef _PRE_WLAN_FEATURE_11AX
extern oal_void hi1105_set_txbf_he_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
    hal_to_dmac_vap_stru *pst_hal_vap, oal_uint32 ul_addr, oal_uint16 us_buffer_len);
#endif
extern oal_void hi1105_set_bfee_h2v_beamforming_ng(hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_user_bw);
extern oal_void hi1105_set_bfee_grouping_codebook(hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_lut_index, oal_uint8 uc_min_group, oal_uint8 uc_txbf_mode, oal_uint8 uc_user_bw);
extern oal_void hi1105_set_bfee_sounding_en(hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_txbf_mode, oal_uint8 uc_bfee_enable);
#endif

/* phy debug信息中trailer信息上报设置寄存器 */
extern oal_void hi1105_rx_set_trlr_report_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint8 *auc_config_val, oal_uint8 uc_trlr_switch);
extern oal_void hi1105_rf_tone_transmit_entrance(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint16 us_data_len, oal_uint8 uc_chain_idx);
...
extern oal_void hi1105_get_weak_intf_rssi_th(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pst_reg_value);
extern oal_void hi1105_set_agc_unlock_min_th(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_int32 l_tx_reg_val,
                                             oal_int32 l_rx_reg_val);
extern oal_void hi1105_get_agc_unlock_min_th(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pst_reg_value);
extern oal_void hi1105_set_nav_max_duration(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint16 us_bss_dur,
                                            oal_uint32 us_obss_dur);
#endif
...
extern oal_void hi1105_set_extlna_chg_cfg(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_extlna_chg_bypass);
#ifdef _PRE_WLAN_FEATURE_EDCA_OPT
extern oal_void hi1105_set_counter1_clear(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_get_txrx_frame_time(hal_to_dmac_device_stru *pst_hal_device,
                                           hal_ch_mac_statics_stru *pst_ch_statics);
extern oal_void hi1105_set_mac_clken(hal_to_dmac_device_stru *pst_hal_device,
                                     oal_bool_enum_uint8 en_wctrl_enable);
#endif

extern oal_void hi1105_set_80m_resp_mode(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_debug_en);
extern oal_void hi1105_get_mac_statistics_data(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_mac_key_statis_info_stru *pst_mac_key_statis);
...
extern oal_void hi1105_set_dyn_bypass_extlna_pm_flag(hal_to_dmac_device_stru *pst_hal_device,
                                                     wlan_channel_band_enum_uint8 en_band,
                                                     oal_bool_enum_uint8 en_value);
extern oal_bool_enum_uint8 hi1105_get_dyn_bypass_extlna_pm_flag(hal_to_dmac_device_stru *pst_hal_device);
#ifdef _PRE_WLAN_FEATURE_CCA_OPT
extern oal_void hi1105_set_ed_high_th(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_alg_cca_th_stru *pst_cca_th_opt);
extern oal_void hi1105_set_cca_prot_th(hal_to_dmac_device_stru *pst_hal_device,
                                       hal_alg_cca_th_stru *pst_cca_th_opt);
extern oal_void hi1105_set_cca_th_default(hal_to_dmac_device_stru *pst_hal_device,
                                          wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1105_enable_sync_error_counter(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_int32 l_enable_cnt_reg_val);
...
extern oal_void hi1105_get_cca_reg_th(hal_to_dmac_device_stru *pst_hal_device,
                                      wlan_channel_band_enum_uint8 uc_band, oal_int8 *ac_reg_val);
#endif
#ifdef _PRE_WLAN_FEATURE_MWO_DET
extern oal_void hi1105_set_mac_anti_intf_period(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint32 ul_reg_val);
extern oal_void hi1105_get_mac_anti_intf_period(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint32 *pul_reg_val);
extern oal_void hi1105_set_mac_anti_intf_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 ul_reg_val);
extern oal_void hi1105_get_mac_mwo_cycle_time(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 *pul_tx_comp_mwo_cyc_time);
extern oal_void hi1105_set_phy_mwo_det_rssithr(hal_to_dmac_device_stru *pst_hal_device,
                                               ...
                                               oal_bool_enum_uint8 en_enable_mwo,
                                               oal_uint8 uc_cfg_power_sel);
extern oal_void hi1105_get_phy_mwo_det_rssithr(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_reg_val);
extern oal_void hi1105_restore_phy_mwo_det_rssithr(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint32 ul_reg_val);
extern oal_void hi1105_set_phy_mwo_det_timethr(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 ul_reg_val);
extern oal_void hi1105_get_phy_mwo_det_timethr(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_reg_val);
#endif
extern oal_void hi1105_set_soc_lpm(hal_to_dmac_device_stru *pst_hal_device,
                                   hal_lpm_soc_set_enum_uint8 en_type,
                                   oal_uint8 uc_on_off, oal_uint8 uc_pcie_idle);
...
extern oal_void hi1105_set_psm_listen_interval_count(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 us_interval_count);
...
extern oal_void hi1105_set_psm_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                             oal_uint32 ul_beacon_period);
extern oal_void hi1105_soc_set_pcie_l1s(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint8 uc_on_off,
                                        oal_uint8 uc_pcie_idle);
#if defined(_PRE_WLAN_FEATURE_SMPS) || defined(_PRE_WLAN_CHIP_TEST)
...
extern oal_void hi1105_set_txop_ps_partial_aid(hal_to_dmac_vap_stru *pst_hal_vap,
                                               oal_uint32 ul_partial_aid);
extern oal_void hi1105_get_txop_ps_partial_aid(hal_to_dmac_vap_stru *pst_hal_vap,
                                               oal_uint32 *pul_partial_aid);
#endif
#ifdef _PRE_WLAN_FEATURE_MAC_PARSE_TIM
...
extern oal_void hi1105_set_wow_en(hal_to_dmac_device_stru *pst_hal_device,
                                  oal_uint32 ul_set_bitmap,
                                  hal_wow_param_stru *pst_para);
extern oal_void hi1105_set_lpm_state(hal_to_dmac_device_stru *pst_hal_device,
                                     hal_lpm_state_enum_uint8 uc_state_from,
                                     hal_lpm_state_enum_uint8 uc_state_to,
                                     oal_void *pst_para, oal_void *pst_wow_para);
...
extern oal_void hi1105_set_coex_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                     oal_uint32 ul_mac_ctrl,
                                     oal_uint32 ul_rf_ctrl);
extern oal_void hi1105_get_hw_version(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_hw_vsn,
                                      oal_uint32 *pul_hw_vsn_data, oal_uint32 *pul_hw_vsn_num);
...
extern oal_void hi1105_freq_adjust(hal_to_dmac_device_stru *pst_hal_device,
                                   oal_uint16 us_pll_int,
                                   oal_uint16 us_pll_frac);
#endif
extern oal_void hi1105_tx_status11_debug_info(hal_to_dmac_device_stru *pst_hal_device,
    hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 uc_usr_index);
extern oal_void hi1105_get_he_rom_info(hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8 uc_usr_index, oal_uint8 *pcu_rom_en, oal_uint8 *puc_rom_bw, oal_uint8 *puc_rom_nss);
extern oal_void hi1105_tx_get_protocol_nss_bw(hal_to_dmac_device_stru *pst_hal_device,
    hal_tx_dscr_stru *pst_dscr, oal_uint8 *puc_protocol, oal_uint8 *puc_nss, oal_uint8 *puc_bw);
extern oal_void hi1105_set_tx_dscr_field(hal_to_dmac_device_stru *pst_hal_device,
                                         void *p_data,
                                         hal_rf_test_sect_enum_uint8 en_sect);
extern oal_void hi1105_get_tx_dscr_field(hal_to_dmac_device_stru *pst_hal_device,
                                         hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1105_set_phy_max_bw_field(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_data,
                                            hal_phy_max_bw_sect_enmu_uint8 en_sect);
extern oal_void hi1105_rf_test_disable_al_tx(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_rf_test_enable_al_tx(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_tx_dscr_stru *pst_tx_dscr);
extern oal_void hi1105_set_daq_mac_reg(hal_to_dmac_device_stru *pst_hal_device,
                                       oal_uint32 *pul_addr, oal_uint16 us_unit_len,
                                       oal_uint16 us_unit_num, oal_uint16 us_depth);
...
extern oal_void hi1105_set_dac_lpf_gain(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint8 en_band, oal_uint8 en_bandwidth, oal_uint8 uc_chan_number,
                                        oal_uint8 en_protocol_mode, oal_uint8 en_rate);
extern oal_void hi1105_get_pwr_comp_val(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint32 ul_tx_ratio,
                                        oal_int16 *ps_pwr_comp_val);
...
extern oal_void hi1105_set_acq_param(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 uc_is_init);
extern oal_void hi1105_set_rx_filter(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_rx_filter_val);
extern oal_void hi1105_set_rx_filter_reg(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint32 ul_rx_filter_command);
extern oal_void hi1105_get_rx_filter(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pst_reg_value);
extern oal_void hi1105_set_beacon_timeout_val(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint16 us_value);
...
extern oal_void hi1105_vap_tsf_get_64bit(hal_to_dmac_vap_stru *pst_hal_vap,
                                         oal_uint32 *pul_tsf_hi,
                                         oal_uint32 *pul_tsf_lo);
extern oal_void hi1105_vap_tsf_set_64bit(hal_to_dmac_vap_stru *pst_hal_vap,
                                         oal_uint32 ul_tsf_hi,
                                         oal_uint32 ul_tsf_lo);
extern oal_void hi1105_vap_send_beacon_pkt(hal_to_dmac_vap_stru *pst_hal_vap,
                                           hal_beacon_tx_params_stru *pst_params);
...
extern oal_void hi1105_vap_set_opmode(hal_to_dmac_vap_stru *pst_hal_vap,
                                      wlan_vap_mode_enum_uint8 en_vap_mode);

extern oal_void hi1105_vap_clr_opmode(hal_to_dmac_vap_stru *pst_hal_vap,
                                      wlan_vap_mode_enum_uint8 en_vap_mode);
extern oal_void hi1105_vap_set_machw_aifsn_all_ac(hal_to_dmac_vap_stru *pst_hal_vap,
                                                  oal_uint8 uc_bk,
                                                  oal_uint8 uc_be,
                                                  oal_uint8 uc_vi,
                                                  oal_uint8 uc_vo);
...
extern oal_void hi1105_vap_set_machw_aifsn_ac_wfa(hal_to_dmac_vap_stru *pst_hal_vap,
                                                  ...
                                                  oal_uint8 uc_aifs,
                                                  wlan_wme_ac_type_enum_uint8 en_wfa_lock);
extern oal_void hi1105_vap_set_edca_machw_cw(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 uc_cwmax,
                                             oal_uint8 uc_cwmin, oal_uint8 uc_ac_type);
extern oal_void hi1105_vap_set_edca_machw_cw_wfa(hal_to_dmac_vap_stru *pst_hal_vap,
                                                 oal_uint8 uc_cwmaxmin, oal_uint8 uc_ac_type,
                                                 wlan_wme_ac_type_enum_uint8 en_wfa_lock);
extern oal_void hi1105_vap_get_edca_machw_cw(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 *puc_cwmax,
                                             oal_uint8 *puc_cwmin, oal_uint8 uc_ac_type);
extern oal_void hi1105_vap_set_machw_txop_limit_bkbe(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 us_be, oal_uint16 us_bk);
extern oal_void hi1105_vap_get_machw_txop_limit_bkbe(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 *pus_be, oal_uint16 *pus_bk);
extern oal_void hi1105_vap_set_machw_txop_limit_vivo(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 us_vo, oal_uint16 us_vi);
extern oal_void hi1105_vap_get_machw_txop_limit_vivo(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_uint16 *pus_vo, oal_uint16 *pus_vi);
extern oal_void hi1105_vap_set_machw_edca_bkbe_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                        oal_uint16 us_be, oal_uint16 us_bk);
extern oal_void hi1105_vap_get_machw_edca_bkbe_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                        oal_uint16 *pus_be, oal_uint16 *pus_bk);
extern oal_void hi1105_vap_set_machw_edca_vivo_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                        oal_uint16 us_vo, oal_uint16 us_vi);
extern oal_void hi1105_vap_get_machw_edca_vivo_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                        oal_uint16 *pus_vo, oal_uint16 *pus_vi);
...
extern oal_void hi1105_vap_set_machw_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                                   oal_uint16 us_beacon_period);
extern oal_void hi1105_vap_update_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                                oal_uint16 us_beacon_period);
extern oal_void hi1105_vap_get_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                             oal_uint32 *pul_beacon_period);
...
extern oal_void  hi1105_set_trig_para_check(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 en_check);
#endif
#ifdef _PRE_WLAN_FEATURE_TWT
extern oal_void hi1105_vap_set_twt(hal_to_dmac_vap_stru *pst_hal_vap,
                                   oal_uint64 ull_start_tsf,
                                   oal_uint32 ul_duration,
                                   oal_uint32 ul_interval,
                                   oal_uint8 uc_count,
...
extern oal_void hi1105_vap_set_noa_update_regs(hal_to_dmac_vap_stru *pst_hal_vap,
...
extern oal_void hi1105_vap_set_noa(hal_to_dmac_vap_stru *pst_hal_vap,
                                   oal_uint32 ul_start_tsf,
                                   oal_uint32 ul_duration,
                                   oal_uint32 ul_interval,
                                   oal_uint8 uc_count);
...
#ifdef _PRE_WLAN_FEATURE_P2P
extern oal_void hi1105_vap_set_ops(hal_to_dmac_vap_stru *pst_hal_vap,
                                   oal_uint8 en_ops_ctrl,
                                   oal_uint8 uc_ct_window);
extern oal_void hi1105_vap_enable_p2p_absent_suspend(hal_to_dmac_vap_stru *pst_hal_vap,
                                                     oal_bool_enum_uint8 en_suspend_enable);
#endif
...
extern oal_void hi1105_mwo_det_enable_mac_counter(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_int32 l_enable_reg_val);
#ifdef _PRE_WLAN_110X_PILOT
extern oal_void hi1105_tx_enable_resp_ps_bit_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_lut_index);
extern oal_void hi1105_tx_enable_resp_ps_bit_ctrl_all(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_tx_disable_resp_ps_bit_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 uc_lut_index);
extern oal_void hi1105_tx_disable_resp_ps_bit_ctrl_all(hal_to_dmac_device_stru *pst_hal_device);
#endif
extern oal_void hi1105_tx_enable_peer_sta_ps_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_lut_index);
extern oal_void hi1105_tx_disable_peer_sta_ps_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 uc_lut_index);
extern oal_void hi1105_cfg_slottime_type(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint32 ul_slottime_type);
extern oal_void hi1105_get_hw_status(hal_to_dmac_device_stru *pst_hal_device,
                                     oal_uint32 *ul_cali_check_hw_status);
extern oal_void hi1105_pm_wlan_get_service_id(hal_to_dmac_vap_stru *pst_hal_vap,
                                              oal_uint8 *uc_service_id);
extern oal_void hi1105_pm_enable_front_end(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint8 uc_enable_paldo);
...
extern oal_void hi1105_get_btcoex_abort_qos_null_seq_num(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint32 *ul_qosnull_seq_num);
extern oal_void hi1105_get_btcoex_occupied_period(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint16 *us_occupied_period);
extern oal_void hi1105_get_btcoex_pa_status(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 *ul_pa_status);
...
extern oal_void hi1105_get_btcoex_statistic(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_bool_enum_uint8 en_enable_abort_stat);
extern oal_uint32 hi1105_mpw_soc_write_reg(oal_uint32 ulQuryRegAddrTemp,
                                           oal_uint16 usQuryRegValueTemp);
extern oal_void hi1105_btcoex_update_ap_beacon_count(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 *pul_beacon_count);
extern oal_void hi1105_btcoex_post_event(hal_to_dmac_chip_stru *pst_hal_chip,
                                         hal_dmac_misc_sub_type_enum_uint8 en_sub_type);
extern oal_void hi1105_btcoex_have_small_ampdu(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_have_ampdu);
extern oal_void hi1105_btcoex_process_bt_status(hal_to_dmac_chip_stru *pst_hal_chip, oal_uint8 uc_print);
extern oal_void hi1105_btcoex_set_wl0_antc_switch(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_bool_enum_uint8 en_tx_slv);
#ifdef _PRE_WLAN_FEATURE_BTCOEX_SLV_TX_BUGFIX
extern oal_void hi1105_btcoex_set_wl0_tx_slv_en(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_bool_enum_uint8 en_tx_slv);
extern oal_void hi1105_btcoex_set_pta0_wl0_selected_sel(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_bool_enum_uint8 en_sw_ctl);
extern oal_void hi1105_btcoex_set_wl0_rx_status_byp(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_bool_enum_uint8 en_rx_byp);
#endif
extern oal_void hi1105_btcoex_get_bt_acl_status(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_bool_enum_uint8 *en_acl_status);
extern oal_void hi1105_btcoex_get_bt_sco_status(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_bool_enum_uint8 *en_sco_status);
extern oal_void hi1105_btcoex_get_slna_status(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 *en_sco_status);
extern oal_void hi1105_btcoex_get_ps_service_status(hal_to_dmac_device_stru *pst_hal_device,
                                                    hal_btcoex_ps_status_enum_uint8 *en_ps_status);
extern oal_void hi1105_btcoex_set_slna_en(hal_to_dmac_device_stru *pst_hal_device,
                                          oal_bool_enum_uint8 en_slna);
extern oal_void hi1105_btcoex_set_ba_resp_pri(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 en_occu);
#ifdef _PRE_WLAN_110X_PILOT
...
#endif
extern oal_void hi1105_set_btcoex_abort_preempt_frame_param(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint16 us_preempt_param);
extern oal_void hi1105_set_btcoex_abort_null_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 ul_abort_null_buff_addr);
extern oal_void hi1105_set_btcoex_tx_abort_preempt_type(hal_to_dmac_device_stru *pst_hal_device,
                                                        hal_coex_hw_preempt_mode_enum_uint8 en_preempt_type);
extern oal_void hi1105_set_btcoex_abort_qos_null_seq_num(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint32 ul_qosnull_seq_num);
extern oal_void hi1105_set_btcoex_hw_rx_priority_dis(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_bool_enum_uint8 en_hw_rx_prio_dis);
extern oal_void hi1105_set_btcoex_hw_priority_en(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_bool_enum_uint8 en_hw_prio_en);
extern oal_void hi1105_set_btcoex_priority_period(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint16 us_priority_period);
extern oal_void hi1105_set_btcoex_occupied_period(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint16 us_occupied_period);
extern oal_void hi1105_btcoex_get_rf_control(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint16 ul_occupied_period,
                                             oal_uint32 *pul_wlbt_mode_sel,
                                             oal_uint16 us_wait_cnt);
extern oal_void hi1105_set_btcoex_sw_all_abort_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_bool_enum_uint8 en_sw_abort_ctrl);
extern oal_void hi1105_set_btcoex_sw_priority_flag(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_bool_enum_uint8 en_sw_prio_flag);
extern oal_void hi1105_set_btcoex_soc_gpreg0(oal_uint8 uc_val, oal_uint16 us_mask, oal_uint8 uc_offset);
extern oal_void hi1105_set_btcoex_soc_gpreg0_replace(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 uc_val, oal_uint16 us_mask,
                                                     oal_uint8 uc_offset);
extern oal_void hi1105_set_btcoex_soc_gpreg1(oal_uint8 uc_val, oal_uint16 us_mask, oal_uint8 uc_offset);
extern oal_void hi1105_set_btcoex_soc_gpreg1_replace(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 uc_val, oal_uint16 us_mask,
                                                     oal_uint8 uc_offset);
extern oal_void hi1105_set_btcoex_soc_gpreg2(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_val,
    oal_uint16 us_mask, oal_uint8 uc_offset);
extern oal_void hi1105_btcoex_restore_reg(oal_void);
extern oal_void hi1105_btcoex_recover_reg(oal_void);
#endif

extern oal_void hi1105_tx_get_dscr_iv_word(hal_tx_dscr_stru *pst_dscr, oal_uint32 *pul_iv_ms_word,
                                           oal_uint32 *pul_iv_ls_word, oal_uint8 uc_chiper_type,
                                           oal_uint8 uc_chiper_keyid);
#ifdef _PRE_WLAN_DFT_STAT
extern oal_void hi1105_dft_get_machw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pst_machw_stat, oal_uint8 us_bank_select,
                                               oal_uint32 *pul_len);
extern oal_void hi1105_dft_set_phy_stat_node(hal_to_dmac_device_stru *pst_hal_device,
                                             oam_stats_phy_node_idx_stru *pst_phy_node_idx);
extern oal_void hi1105_dft_get_phyhw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pst_phyhw_stat, oal_uint8 us_bank_select,
                                               oal_uint32 *pul_len);
extern oal_void hi1105_dft_get_rfhw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 *pul_rfhw_stat, oal_uint32 *pul_len,
                                              oal_uint8 uc_rf_select);
extern oal_void hi1105_dft_get_sochw_reg_info(oal_uint32 ul_reg_start_addr, oal_uint32 ul_reg_end_addr,
                                              oal_uint16 **ppus_sochw_stat, oal_uint32 *pul_len);
extern oal_void hi1105_dft_get_sochw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint16 *pst_sochw_stat, oal_uint32 *pul_len,
                                               oal_uint8 uc_bank_select);
...
extern oal_void  hi1105_dft_force_report_all_reg_state(hal_to_dmac_device_stru *pst_hal_device);
#endif
...
extern oal_void hi1105_get_cw_signal_reg(hal_to_dmac_device_stru *pst_hal_device,
                                         oal_uint8 uc_chain_idx, wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1105_revert_cw_signal_reg(hal_to_dmac_device_stru *pst_hal_device,
                                            wlan_channel_band_enum_uint8 en_band);
extern oal_void hi1105_check_test_value_reg(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint16 us_value,
                                            oal_uint32 *pul_result);
...
extern oal_void hi1105_get_rate_idx_pow(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_pow_idx,
                                        wlan_channel_band_enum_uint8 en_freq_band, oal_uint16 *pus_powr,
                                        oal_uint8 uc_channel_idx, oal_uint8 uc_chn_idx);
extern oal_void hi1105_get_target_tx_power_by_tx_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                      hal_tx_dscr_ctrl_one_param *pst_tx_dscr_one,
                                                      hal_pdet_info_stru *pst_pdet_info,
                                                      oal_int16 *ps_tx_pow);
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
...
extern oal_void hi1105_config_update_scaling_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint16 *paus_dbb_scale);
extern oal_void hi1105_config_update_dsss_scaling_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint16 *paus_dbb_scale, oal_uint8 uc_distance);
...
extern oal_void hi1105_config_set_cus_nvram_params(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint8 *puc_param);
...
extern oal_void hi1105_al_tx_hw_cfg(hal_to_dmac_device_stru *pst_hal_device,
                                    oal_uint32 ul_mode,
                                    oal_uint32 ul_rate);
#ifdef _PRE_WLAN_FEATURE_FTM
...
extern oal_void hi1105_get_ftm_ctrl_status(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint32 *pul_ftm_status);
extern oal_void hi1105_get_ftm_config_status(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_ftm_status);
extern oal_void hi1105_set_ftm_ctrl_status(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_ftm_status);
extern oal_void hi1105_set_ftm_config_status(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_ftm_status);
extern oal_void hi1105_set_ftm_enable(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_bool_enum_uint8 en_ftm_status);
extern oal_void hi1105_set_ftm_sample(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_bool_enum_uint8 en_ftm_status);
extern oal_void hi1105_get_ftm_cali_rx_time(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 *pul_ftm_cali_rx_time);
extern oal_void hi1105_get_ftm_cali_rx_intp_time(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint32 *pul_ftm_cali_rx_time);
extern oal_void hi1105_get_ftm_cali_tx_time(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 *pul_ftm_cali_tx_time);
extern oal_void hi1105_set_ftm_cali(hal_to_dmac_device_stru *pst_hal_device,
                                    hal_tx_dscr_stru *pst_tx_dscr,
                                    oal_bool_enum_uint8 en_ftm_cali);
extern oal_void hi1105_set_ftm_flag(hal_to_dmac_device_stru *pst_hal_device,
                                    hal_tx_dscr_stru *pst_tx_dscr,
                                    oal_bool_enum_uint8 en_ftm_flag);
extern oal_void hi1105_set_ftm_tx_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                      hal_tx_dscr_stru *pst_tx_dscr,
                                      oal_uint8 uc_ftm_tx_cnt);
extern oal_void hi1105_set_ftm_bandwidth(hal_to_dmac_device_stru *pst_hal_device,
                                         hal_tx_dscr_stru *pst_tx_dscr,
                                         wlan_bw_cap_enum_uint8 en_band_cap);
extern oal_void hi1105_set_ftm_protocol(hal_to_dmac_device_stru *pst_hal_device,
                                        hal_tx_dscr_stru *pst_tx_dscr,
                                        wlan_phy_protocol_enum_uint8 uc_prot_format);
extern oal_void hi1105_set_ftm_m2s(hal_to_dmac_device_stru *pst_hal_device,
                                   hal_tx_dscr_stru *pst_tx_dscr,
                                   oal_uint8 uc_tx_chain_selection);
extern oal_void hi1105_set_ftm_m2s_phy(hal_to_dmac_device_stru *pst_hal_device,
                                       oal_bool_enum_uint8 en_is_mimo,
                                       oal_uint8 uc_tx_chain_selection);
...
extern oal_void hi1105_set_ftm_buf_base_addr(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 ul_ftm_info_addr);
extern oal_void hi1105_set_ftm_buf_size(hal_to_dmac_device_stru *pst_hal_device,
                                        oal_uint16 us_cfg_ftm_buf_size);
extern oal_uint32 hi1105_set_ftm_white_list(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint8 uc_index,
                                            oal_uint8 *puc_addr);
#endif
#endif
...
extern oal_int16 hi1105_get_tx_pdet_by_pow(hal_to_dmac_device_stru *OAL_CONST pst_hal_device,
                                           hal_pdet_info_stru *OAL_CONST pst_pdet_info,
                                           hal_dyn_cali_usr_record_stru *OAL_CONST pst_user_pow,
                                           oal_int16 *pst_exp_pdet);
...
extern oal_void hi1105_config_set_dyn_cali_dscr_interval(hal_to_dmac_device_stru *pst_hal_device,
                                                         wlan_channel_band_enum_uint8 uc_band,
                                                         oal_uint16 us_param_val);
#ifdef _PRE_WLAN_DPINIT_CALI
extern oal_void hi1105_config_get_dyn_cali_dpinit_val(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint16 us_param_val);
#endif
extern oal_void hi1105_rf_cali_realtime_entrance(hal_to_dmac_device_stru *OAL_CONST pst_hal_device,
                                                 hal_pdet_info_stru *OAL_CONST pst_pdet_info,
                                                 hal_dyn_cali_usr_record_stru *OAL_CONST pst_user_pow,
                                                 hal_tx_dscr_stru *OAL_CONST pst_base_dscr);
...
#endif
#ifdef _PRE_WLAN_DFT_REG
extern oal_uint32 hi1105_debug_refresh_reg_ext(hal_to_dmac_device_stru *pst_hal_device,
                                               oam_reg_evt_enum_uint32 en_evt_type,
                                               oal_uint32 *pul_ret);
extern oal_void hi1105_debug_frw_evt(hal_to_dmac_device_stru *pst_hal_device);
#endif

extern oal_void hi1105_get_wow_enable_status(hal_to_dmac_device_stru *pst_hal_device,
                                             oal_uint32 *pul_status);

#ifdef _PRE_WLAN_CHIP_TEST
extern oal_void hi1105_set_tx_dscr_long_nav_enable(hal_tx_dscr_stru *pst_tx_dscr,
                                                   oal_uint8 uc_en_status);
#endif

#ifdef _PRE_WLAN_CACHE_COHERENT_SUPPORT
extern oal_void hi1105_get_tx_msdu_address_params(hal_tx_dscr_stru *pst_dscr,
                                                  hal_tx_msdu_address_params **ppst_tx_dscr_msdu_subtable,
                                                  oal_uint8 *puc_msdu_num);
#endif
...
extern oal_void hi1105_flush_rx_queue_complete_irq(hal_to_dmac_device_stru *pst_hal_dev,
    hal_rx_dscr_queue_id_enum_uint8 en_queue_num);
...
#ifdef _PRE_WLAN_FEATURE_11AX
extern oal_void hi1105_phase_calc(hal_to_dmac_device_stru   *pst_hal_device);
#endif
...
extern oal_void hi1105_device_set_power_gating(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_mac_auto_pg_enum_uint8 en_state);

#ifdef _PRE_WLAN_1103_CHR
extern oal_void hi1105_get_phy_mac_chr_info(hal_to_dmac_device_stru *pst_hal_device,
                                            hal_phy_mac_chr_info_stru *pst_phy_mac_chr_info);
#endif

extern oal_uint32 hi1105_get_subband_index(wlan_channel_band_enum_uint8 en_band,
                                           oal_uint8 uc_channel_idx,
                                           oal_uint8 *puc_subband_idx);
#ifdef _PRE_WLAN_110X_PILOT
extern oal_void hi1105_pow_set_pow_to_pow_code(hal_to_dmac_device_stru *pst_hal_device,
                                               ...
                                               oal_uint8 uc_chan_num, wlan_channel_bandwidth_enum_uint8 en_bandwidth,
                                               hal_pow_set_type_enum_uint8 uc_type);
extern oal_void hi1105_pow_set_he_tb_tx_chain_sel(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 uc_rf_chain);
extern oal_uint32 hi1105_comb_pow_code(oal_bool_enum_uint8 en_dpd_enable, oal_uint8 uc_upc_idx,
                                       oal_uint8 uc_pa_idx, oal_uint8 uc_dac_idx,
                                       oal_uint8 uc_lpf_idx, oal_uint16 us_delta_dbb_scaling,
                                       oal_uint8 uc_dpd_tpc_lv, oal_uint8 uc_cfr_index);
...
extern oal_void hi1105_get_abort_timers_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint8 *uc_abort_cnt);

#ifdef _PRE_WLAN_FEATURE_BT_20DBM
extern oal_uint16 hi1105_bt20dbm_enable_status(oal_void);
extern oal_void hi1105_bt20dbm_occupy_set_process(oal_bool_enum_uint8 en_occupy,
                                                  hal_btcoex_rf_20dbm_occu_enum_uint8 en_type);
#endif
...
extern oal_void hi1105_get_phy_power0_ref_info(hal_to_dmac_device_stru *pst_hal_device,
                                               oal_uint32 *pul_status);
extern oal_void hi1105_get_phy_extlna_gain_info(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint32 *pul_gain0_status, oal_uint32 *pul_gain1_status);
extern oal_void hi1105_get_phy_adc_pin_code_info(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint32 *pul_status);
extern oal_void hi1105_device_get_5g_min_level_tx_pow(hal_to_dmac_device_stru *pst_hal_device,
                                                      wlan_channel_band_enum_uint8 en_freq_band,
                                                      oal_int16 *ps_tx_pow);
extern oal_void hi1105_device_set_5g_min_level_lowpower(hal_to_dmac_device_stru *pst_hal_device,
                                                        wlan_channel_band_enum_uint8 en_freq_band,
                                                        oal_uint8 uc_switch_flag, oal_uint8 uc_use_type);
...
extern oal_void hi1105_get_11b_rate_code(hal_wlan_11b_rate_enum_uint8 en_rate_index,
                                         oal_uint8 *puc_rate_code);
extern oal_void hi1105_get_11ag_rate_code(hal_wlan_legacy_ofdm_rate_enum en_rate_index,
                                          oal_uint8 *puc_rate_code);
...
extern oal_void hi1105_set_compatible_1103_en(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_bool_enum_uint8 en_status);
extern oal_void hi1105_dump_mac_reg_debug(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void hi1105_get_efuse_reg_value(hal_to_dmac_device_stru *pst_hal_device,
                                           oal_uint16 *pus_value_buf,
                                           oal_uint8 uc_buf_size);
#ifdef _PRE_WLAN_FEATURE_FULL_QUAN_PROD_CAL
extern oal_void hi1105_set_pdet_info_report_param(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint8 en_report_flag,
                                                  oal_uint8 uc_full_data_coll_idx);
extern oal_void hi1105_pow_refresh_full_cali_pro_line_data(hal_to_dmac_device_stru *pst_hal_device,
                                                           hal_pdet_info_stru *OAL_CONST pst_pdet_info);
#endif
extern oal_void hi1105_set_ru_test(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint16 us_aid,
                                   oal_uint16 us_rudir, oal_uint32 *pul_ret);
