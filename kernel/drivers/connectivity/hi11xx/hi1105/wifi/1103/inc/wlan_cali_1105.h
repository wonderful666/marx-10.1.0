...
typedef struct {
    ...
    oal_int16 as_txiq_comp_ls_fir_i[HI1105_CALI_TXIQ_GAIN_LVL_NUM][HI1105_TXIQ_LSFIR_NUM];
    oal_int16 as_txiq_comp_ls_fir_q[HI1105_CALI_TXIQ_GAIN_LVL_NUM][HI1105_TXIQ_LSFIR_NUM];
...
typedef struct {
    ...
    oal_int16 as_rxiq_comp_ls_fir_i[HI1105_CALI_RXIQ_GAIN_LVL_NUM][HI1105_RXIQ_LSFIR_NUM];
    oal_int16 as_rxiq_comp_ls_fir_q[HI1105_CALI_RXIQ_GAIN_LVL_NUM][HI1105_RXIQ_LSFIR_NUM];
