...
OAL_STATIC oal_uint32  wal_config_set_probe_resp_mode(mac_vap_stru *pst_mac_vap, oal_uint16 us_len,
    oal_uint8 *puc_param);
...
OAL_STATIC oal_uint32 wal_config_clear_11n_blacklist(mac_vap_stru *p_mac_vap, oal_uint16 len, oal_uint8 *p_param);
#ifdef _PRE_WLAN_FEATURE_11AX
...
#endif
OAL_STATIC oal_uint32 wal_config_set_11ax_wifi6_black_list(mac_vap_stru *pst_mac_vap,
    oal_uint16 us_len, oal_uint8 *puc_param);
OAL_STATIC oal_uint32 wal_config_set_11ax_close_htc(mac_vap_stru *pst_mac_vap,
    oal_uint16 us_len, oal_uint8 *puc_param);
#endif
...
OAL_STATIC oal_uint32 wal_config_set_rx_listen_ps_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len,
    oal_uint8 *puc_param);
#endif
...
OAL_STATIC oal_uint32 wal_config_set_m2s_switch_modem_etc(mac_vap_stru *pst_mac_vap,
    oal_uint16 us_len, oal_uint8 *puc_param);
#endif
#endif
...
#ifdef _PRE_WLAN_FEATURE_M2S
#ifdef _PRE_WLAN_FEATURE_M2S_MODEM
    { WLAN_CFGID_SET_M2S_MODEM, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_set_m2s_switch_modem_etc },
#endif
#endif
...
OAL_STATIC oal_uint32 wal_config_clear_11n_blacklist(mac_vap_stru *p_mac_vap, uint16_t len, uint8_t *p_param)
{
...
OAL_STATIC oal_uint32 wal_config_set_11ax_wifi6_black_list(mac_vap_stru *pst_mac_vap,
    oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_wifi6_self_cure_black_list_set(pst_mac_vap, us_len, puc_param);
}

OAL_STATIC oal_uint32 wal_config_set_11ax_close_htc(mac_vap_stru *pst_mac_vap,
    oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_wifi6_self_cure_close_htc_handle(pst_mac_vap);
}
...
OAL_STATIC oal_uint32 wal_config_process_query_param_check(
                                               ...
                                               oal_uint8 *puc_rsp_msg_len)
{
    if (OAL_ANY_NULL_PTR4(pst_mac_vap, puc_req_msg, puc_rsp_msg, puc_rsp_msg_len)) {
        OAM_ERROR_LOG4(0, OAM_SF_ANY,
            "{wal_config_process_query_param_check::mac_vap/req_msg/rsp_msg/rsp_msg_len null ptr error: %x, %x, %x, %x!}\r\n",
                                               ...
                                               oal_uint8 *puc_rsp_msg_len)
{
    ...
    ul_ret = wal_config_process_query_param_check(pst_mac_vap, puc_req_msg,
                                           puc_rsp_msg, puc_rsp_msg_len);
    if (ul_ret != OAL_SUCC) {
...
OAL_STATIC oal_uint32 wal_config_process_write_param_check(
                                               mac_vap_stru *pst_mac_vap,
                                               oal_uint8 *puc_req_msg)
{
...
oal_net_device_stru* wal_config_get_netdev_etc(const oal_int8 *pc_name, oal_int32 arrayLen)
{
    if (arrayLen < 0) {
        return OAL_PTR_NULL;
    }
    ...
    if ((oal_strcmp("Hisilicon0", pc_name)) == 0) {
        ...
        return hmac_vap_get_net_device_etc(0);
    } else
#endif
    {
...
OAL_STATIC oal_uint32  wal_config_set_probe_resp_mode(mac_vap_stru *pst_mac_vap,
    oal_uint16 us_len, oal_uint8 *puc_param)
{
    if ((pst_mac_vap == OAL_PTR_NULL) || (puc_param == OAL_PTR_NULL)) {
...
oal_int32 wal_recv_config_cmd_etc(oal_uint8 *puc_buf, oal_uint16 us_len)
{
    ...
    /* 根据dev_name找到dev */
    pst_net_dev = wal_config_get_netdev_etc(ac_vap_name, OAL_STRLEN(ac_vap_name));
    if (pst_net_dev == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_recv_config_cmd_etc::wal_config_get_netdev_etc return null ptr!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_int32 wal_recv_reg_cmd_etc(oal_uint8 *puc_buf, oal_uint16 us_len)
{
    ...
    pst_net_dev = wal_config_get_netdev_etc(ac_vap_name, OAL_STRLEN(ac_vap_name));
    if (pst_net_dev == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_recv_reg_cmd_etc::wal_config_get_netdev_etc return null ptr!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_int32 wal_recv_sample_cmd(oal_uint8 *puc_buf, oal_uint16 us_len)
{
    ...
    pst_net_dev = wal_config_get_netdev_etc(ac_vap_name, OAL_STRLEN(ac_vap_name));
    if (pst_net_dev == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_recv_sample_cmd::wal_config_get_netdev_etc return null ptr!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32 wal_sample_report2sdt(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (EOK != memcpy_s(oal_netbuf_data(pst_net_buf), us_payload_len, pst_event->auc_event_data, us_payload_len)) {
        ...
        oal_mem_sdt_netbuf_free_etc(pst_net_buf, OAL_TRUE);
        return OAL_FAIL;
    }
...
oal_int32 wal_recv_autocali_cmd(oal_uint8 *puc_buf, oal_uint16 us_len)
{
    ...
    pst_net_dev = wal_config_get_netdev_etc(ac_vap_name, OAL_STRLEN(ac_vap_name));
    if (pst_net_dev == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_recv_autocali_cmd::wal_config_get_netdev_etc return null ptr!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
OAL_STATIC oal_uint32 wal_config_set_m2s_switch_modem_etc(mac_vap_stru *pst_mac_vap,
    oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_set_m2s_switch_modem_etc(pst_mac_vap, us_len, puc_param);
}
#endif
#endif
