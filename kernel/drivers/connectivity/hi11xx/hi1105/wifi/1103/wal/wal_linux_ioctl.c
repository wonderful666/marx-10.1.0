...
oal_int8 g_wait_wlan_power_on_cali = OAL_TRUE;
oal_uint8 g_go_cac = OAL_TRUE;
...
OAL_STATIC oal_void wal_event_report_to_sdt(wal_msg_type_enum_uint8 en_msg_type,
    oal_uint8 *puc_param, wal_msg_stru *pst_cfg_msg);
#endif
#endif
...
OAL_STATIC oal_uint32 wal_hipriv_dhcp_req_disable_switch(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_param);
#endif
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
...
OAL_STATIC oal_uint32 wal_hipriv_set_random_mac_addr_scan(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_param);
...
#endif
OAL_STATIC oal_uint32 wal_hipriv_set_2040_coext_support(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_param);
...
OAL_STATIC oal_int32 wal_net_device_ioctl(oal_net_device_stru *pst_net_dev,
    oal_ifreq_stru *pst_ifr, oal_int32 ul_cmd);
OAL_STATIC oal_int32 wal_ioctl_set_mlme_ie_etc(oal_net_device_stru *pst_net_dev,
...
OAL_STATIC oal_uint32 wal_hipriv_report_product_log_cfg(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_param);
#endif
...
OAL_STATIC oal_uint32 wal_hipriv_set_edca_opt_switch_sta(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_param);
#endif
...
#endif
OAL_STATIC oal_uint32 wal_hipriv_set_fasts_sleep_para(oal_net_device_stru *pst_cfg_net_dev,
    oal_int8 *pc_param);
#endif

#ifdef _PRE_WLAN_RX_LISTEN_POWER_SAVING
OAL_STATIC oal_uint32 wal_ioctl_set_rx_listen_ps_switch(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_command);
#endif
...
#ifdef _PRE_WLAN_FEATURE_P2P
OAL_STATIC oal_int32 wal_ioctl_set_p2p_miracast_status(oal_net_device_stru *pst_net_dev,
    oal_uint8 uc_param);
...
OAL_STATIC oal_int32 wal_ioctl_get_vowifi_param(oal_net_device_stru *pst_net_dev,
    oal_int8 *puc_command, oal_int32 *pl_value);
#endif

#ifdef _PRE_WLAN_FEATURE_M2S_MSS
OAL_STATIC oal_uint32 wal_ioctl_set_m2s_blacklist(oal_net_device_stru *pst_net_dev,
    oal_uint8 *puc_buf, oal_uint32 ul_buf_len, oal_uint8 uc_m2s_blacklist_cnt);
...
OAL_STATIC oal_int32 wal_kick_sta(oal_net_device_stru *pst_net_dev,
    oal_uint8 *auc_mac_addr, oal_uint8 uc_mac_addr_len, oal_uint16 us_reason_code);
...
OAL_STATIC int wal_ioctl_set_ap_sta_disassoc(oal_net_device_stru *pst_net_dev,
    oal_iw_request_info_stru *pst_info, oal_iwreq_data_union *pst_wrqu, char *pc_extra);
OAL_STATIC oal_uint32 wal_get_parameter_from_cmd(oal_int8 *pc_cmd,
    oal_int8 *pc_arg, OAL_CONST oal_int8 *puc_token, oal_uint32 *pul_cmd_offset, oal_uint32 ul_param_max_len);
...
#endif
#ifdef _PRE_WLAN_FEATURE_STA_PM
OAL_STATIC oal_uint32 wal_ioctl_set_fastsleep_switch(oal_net_device_stru *pst_net_dev,
    oal_int8 *puc_para_str);
#endif
...
OAL_STATIC oal_uint32 wal_hipriv_beacon_req_table_switch(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_param);
#endif
...
#endif
#ifdef _PRE_WLAN_COUNTRYCODE_SELFSTUDY
OAL_STATIC oal_void wal_selfstudy_default_regdomain_dfs_config(OAL_CONST oal_ieee80211_regdomain_stru *pst_regdom,
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
OAL_STATIC oal_int32 wal_ioctl_get_wifi_priv_feature_cap_param(oal_net_device_stru *pst_net_dev,
    oal_int8 *puc_command, oal_int32 *pl_value);
#endif
OAL_STATIC oal_uint32 wal_ioctl_force_stop_filter(oal_net_device_stru *pst_net_dev, oal_uint8 uc_param);
#ifdef _PRE_WLAN_RR_PERFORMANCE
OAL_STATIC oal_int32 wal_ext_priv_cmd_dev_freq_check_para(oal_net_device_stru *pst_net_dev);
OAL_STATIC oal_int32 wal_priv_cmd_dev_freq_para_etc(mac_cfg_set_tlv_stru *pst_config_para, oal_uint8 uc_cmd_type,
                                                    oal_uint8 ul_value, mac_vap_stru *mac_vap);
OAL_STATIC oal_int32 wal_ext_priv_cmd_set_dev_freq(oal_net_device_stru *pst_net_dev, oal_uint8 uc_flag);
OAL_STATIC oal_int32 wal_ext_priv_cmd_pcie_aspm(oal_int32 aspm);
#endif /* _PRE_WLAN_RR_PERFORMANCE */
...
OAL_STATIC OAL_CONST wal_hipriv_cmd_entry_stru  g_ast_hipriv_cmd[] = {
     ...
     */
    { "ip_filter",            wal_hipriv_set_ip_filter_etc },
#endif
    ...
    /* 打印寄存器信息: hipriv "Hisilicon0 regwrite 32/16(51没有16位写寄存器功能) regtype(soc/mac/phy) addr val"
    ...
    /* 扫描停止测试命令 hipriv "Hisilicon0 bgscan_enable param1" param1取值'0/1',关闭和打开背景扫描, '2'关闭所有扫描 */
...
#endif
#ifdef _PRE_WLAN_FEATURE_SMPS
    /* 配置vap的smps模式 sh hipriv.sh 'wlan0 smps_vap_mode 1/2/3' static/dynamic/disable */
    { "smps_vap_mode",        wal_hipriv_set_smps_vap_mode },
#endif
#ifdef _PRE_WLAN_FEATURE_UAPSD
    ...
    /* 设置硬件常发模式:hipriv "vap0 al_tx_hw_cfg devid XXX XXX" 对devid mode和速率进行配置 */
    { "al_tx_hw_cfg ",        wal_hipriv_always_tx_hw_cfg },
    /* 设置硬件常发模式:hipriv "vap0 al_tx_hw_cfg devid XXX XXX" 对devid mode和速率进行配置 */
    ...
    /* 设置硬件常发:hipriv "vap0 al_tx_hw  0/1/2/3  0/1/2/3  content len times"
       ...
       4. len数据长度。
       5. 帧发送的次数 */
    /* 设置硬件常发: hipriv "vap0 al_tx_hw <switch(x)|device id(x)| flag(xx)|xxxx> <content> <len> <times> <ifs>" */
    { "al_tx_hw",             wal_hipriv_always_tx_hw },
#endif
...
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
    /* 刷新定制化文件中功率增益相关参数 hipriv.sh "Hisilicon0 load_ini_gain" */
    { "load_ini_gain", wal_hipriv_load_ini_power_gain },
#endif
...
#ifdef _PRE_WLAN_FEATURE_WDS
    /* 设置vap的 wds使能: hipriv "wlan0 wds_vap_mode 0/1/2/3" 第二个参数
     0:关闭WDS, 1:RootAP模式, 2:RepeaterAP模式下的STA Vap, 3:RepeaterAP模式下的AP Vap */
    { "wds_vap_mode", wal_hipriv_wds_vap_mode },
    { "wds_vap_show", wal_hipriv_wds_vap_show },  /* 打印WDS Vap的配置信息和状态信息 */
    /* 添加WDS STA信息到 WDS表中: hipriv "wlan0 wds_sta_add StaMac PeerNodeMac"
       第二个参数 StaMac为新添加的 WDS STA的 Mac地址,
       第三个参数 PeerNodeMac为WDS STA绑定的WDS对端节点的Mac(对端为STA模式的Vap,如果该对端节点不存在，则添加失败) */
    { "wds_sta_add",  wal_hipriv_wds_sta_add },
    /* 删除WDS表中对应WDS STA信息: hipriv "wlan0 wds_sta_del StaMac" 第二个参数 StaMac为新添加的 WDS STA的 Mac地址 */
    { "wds_sta_del",  wal_hipriv_wds_sta_del },
    /* 设置WDS表中WDS STA有效时间: hipriv "wlan0 wds_sta_age AgeTime" 第二个参数 WDS Sta最长不活跃时间(单位为秒) */
    { "wds_sta_age",  wal_hipriv_wds_sta_age },
#endif

#ifdef _PRE_WLAN_FEATURE_DHCP_REQ_DISABLE
    /* dhcp_req_disable模块的开关的命令: hipriv "vap0 dhcp_req_disable 0 | 1" */
    { "dhcp_req_disable", wal_hipriv_dhcp_req_disable_switch },
#endif
#ifdef _PRE_WLAN_FEATURE_SMPS
...
#ifdef _PRE_WLAN_REPORT_PRODUCT_LOG
    /* 产品log上报配置，hipriv "wlan0 product_log_flag 0/1/2"; 0/1表示关开，2表示查询当前开关 */
    { "product_log_flag", wal_hipriv_report_product_log_cfg },
#endif
...
OAL_STATIC OAL_CONST oal_iw_priv_args_stru g_ast_iw_priv_args[] = {
...
#ifdef _PRE_WLAN_FEATURE_WDS
    /* 设置VAP的WDS模式使能 */
    { WLAN_CFGID_WDS_VAP_MODE, OAL_IW_PRIV_TYPE_INT  | OAL_IW_PRIV_SIZE_FIXED | 1,  0,    "wds_vap_mode" },
    { WLAN_CFGID_WDS_STA_ADD,  OAL_IW_PRIV_TYPE_CHAR | OAL_IW_PRIV_TYPE40,          0,    "wds_sta_add" },
    { WLAN_CFGID_WDS_STA_DEL,  OAL_IW_PRIV_TYPE_CHAR | OAL_IW_PRIV_TYPE40,          0,    "wds_sta_del" },
    /* 读取VAP的WDS模式使能 */
    { WLAN_CFGID_WDS_VAP_MODE, 0, OAL_IW_PRIV_TYPE_INT | OAL_IW_PRIV_SIZE_FIXED |   1,    "get_wds_vap_mode" },
#endif
#if (_PRE_WLAN_FEATURE_BLACKLIST_LEVEL != _PRE_WLAN_FEATURE_BLACKLIST_NONE)
    ...
    /* 获取当前waveapp仪器识别的标记 */
    { WLAN_CFGID_GET_WAVEAPP_FLAG, 0, OAL_IW_PRIV_TYPE_INT | OAL_IW_PRIV_SIZE_FIXED | 1,  "get_waveapp_flag" },
#endif
};
...
OAL_CONST wal_ioctl_tlv_stru g_ast_11ax_debug_table[] = {
    ...
    { "wifi_self_cure_type", MAC_VAP_11AX_DEBUG_WIFI6_SELF_CURE_FLAG},
    { OAL_PTR_NULL }
};
#endif
...
oal_uint32 wal_get_cmd_one_arg_etc(oal_int8 *pc_cmd, oal_int8 *pc_arg,
    oal_uint32 ul_arg_len, oal_uint32 *pul_cmd_offset)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR3(pc_cmd, pc_arg, pul_cmd_offset))) {
        OAM_ERROR_LOG3(0, OAM_SF_ANY, "{wal_get_cmd_one_arg_etc::pc_cmd/pc_arg/pul_cmd_offset null ptr err %x/%x/%x!}",
    ...
    while ((*pc_cmd_copy != ' ') && (*pc_cmd_copy != '\0')) {
        ...
        if (OAL_UNLIKELY(ul_pos >= ul_arg_len)) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_get_cmd_one_arg_etc::pos>=HIPRIV_CMD_NAME_MAX_LEN, pos:%d}", ul_pos);
...
oal_uint32 wal_hipriv_set_fix_rate_pre_config(oal_net_device_stru *pst_net_dev,
...
OAL_STATIC oal_uint32 wal_hipriv_set_non_ht_rate(mac_cfg_non_ht_rate_stru *pst_set_non_ht_rate_param,
...
oal_uint32 wal_hipriv_process_rate_params(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_cmd, mac_cfg_set_dscr_param_stru *pc_stu)
{
    oal_uint32 ul_ret, ul_off_set;
    oal_int32 l_val;
    wal_dscr_param_enum_uint8 en_param_index;
    ...
    if (pst_rsp_msg != OAL_PTR_NULL) {
        ...
        if (ul_err_code != OAL_SUCC) {
            OAM_WARNING_LOG2(0, OAM_SF_SCAN,
                "{wal_check_and_release_msg_resp_etc::detect err code:[%u],wid:[%u]}",
                ul_err_code, en_wid);
            return ul_err_code;
        }
    }
...
oal_int32 wal_set_msg_response_by_addr_etc(oal_ulong addr,
    oal_void *pst_resp_mem, oal_uint32 ul_resp_ret, oal_uint32 uc_rsp_len)
{
        ...
        if (pst_request->ul_request_address == (oal_ulong)addr) {
            ...
            if (OAL_UNLIKELY(pst_request->pst_resp_mem != NULL)) {
                OAM_ERROR_LOG0(0, OAM_SF_ANY,
                    "{wal_set_msg_response_by_addr_etc::wal_set_msg_response_by_addr rsp had set!");
            }
...
oal_uint32 wal_alloc_cfg_event_etc(oal_net_device_stru *pst_net_dev,
    frw_event_mem_stru **ppst_event_mem, oal_void *pst_resp_addr,
    wal_msg_stru **ppst_cfg_msg, oal_uint16 us_len)
{
    ...
    if (OAL_UNLIKELY(pst_vap == OAL_PTR_NULL)) {
        ...
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
            "{wal_alloc_cfg_event_etc::OAL_NET_DEV_PRIV(pst_net_dev) null! pst_net_dev[%p]}", (uintptr_t)pst_net_dev);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (OAL_UNLIKELY(pst_event_mem == OAL_PTR_NULL)) {
        OAM_ERROR_LOG2(pst_vap->uc_vap_id, OAM_SF_ANY,
            "{wal_alloc_cfg_event_etc::pst_event_mem null ptr error,request size:us_len:%d,resp_len:%d}",
            us_len, us_resp_len);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_int32 wal_send_cfg_event_etc(oal_net_device_stru *pst_net_dev,
    wal_msg_type_enum_uint8 en_msg_type, oal_uint16 us_len,
    oal_uint8 *puc_param, oal_bool_enum_uint8 en_need_rsp, wal_msg_stru **ppst_rsp_msg)
{
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_send_cfg_event_etc::wal_alloc_cfg_event_etc err %d!}", ul_ret);
        return -OAL_ENOMEM;
    }
    ...
    pst_mac_vap = OAL_NET_DEV_PRIV(pst_net_dev);
    if (OAL_UNLIKELY(pst_mac_vap == OAL_PTR_NULL)) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_send_cfg_event_etc::OAL_NET_DEV_PRIV(pst_net_dev) null.}");
        FRW_EVENT_FREE(pst_event_mem);
        return -OAL_EINVAL;
    }
    ...
    if (OAL_WARN_ON(l_ret == 0)) {
        /* 超时 */
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_send_cfg_event_etc:: wait queue timeout,%ds!}", HMAC_WAIT_EVENT_RSP_TIME);
...
oal_int32 wal_cfg_vap_h2d_event_etc(oal_net_device_stru *pst_net_dev)
{
    ...
    if (pst_mac_device == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_cfg_vap_h2d_event_etc::mac_device is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /* 发送消息 */
    l_ret = wal_send_cfg_event_etc(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
                                   WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_vap_h2d_stru),
                                   (oal_uint8 *)&st_write_msg,
                                   OAL_TRUE, &pst_rsp_msg);

    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_cfg_vap_h2d_event_etc::wal_alloc_cfg_event_etc err %d!}", l_ret);
        return l_ret;
    }
    ...
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_cfg_vap_h2d_event_etc::hmac cfg vap h2d fail,err code[%u]", ul_err_code);
        return -OAL_EINVAL;
    }
...
OAL_STATIC oal_int32 wal_host_dev_config(oal_net_device_stru *pst_net_dev, wlan_cfgid_enum_uint16 en_wid)
{
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_host_dev_config::wal_alloc_cfg_event_etc err %d!}", l_ret);
        return l_ret;
    }
...
oal_void hwifi_config_host_global_11ax_ini_param(oal_void)
{
    ...
    g_st_mac_device_custom_cfg.st_11ax_custom_cfg.bit_htc_include =
        (((oal_uint32)l_val & 0x0F) & BIT0) ? OAL_TRUE : OAL_FALSE;
...
OAL_STATIC oal_void hwifi_set_voe_custom_param(oal_void)
{
    oal_uint32 ul_val;
...
OAL_STATIC oal_void hwifi_config_host_global_hiex_ini_param(oal_void)
{
    oal_int32 l_val;
    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_HIEX_CAP);
...
#ifdef _PRE_WLAN_FEATURE_ROAM
OAL_STATIC oal_void hwifi_config_host_roam_global_ini_param(oal_void)
{
    oal_int32 l_val;

    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_ROAM_SWITCH);
    wlan_customize_etc.uc_roam_switch = (0 == l_val || 1 == l_val) ?
        (oal_uint8)l_val : wlan_customize_etc.uc_roam_switch;

    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_SCAN_ORTHOGONAL);
        wlan_customize_etc.uc_roam_scan_orthogonal = (1 <= l_val) ?
    (oal_uint8)l_val : wlan_customize_etc.uc_roam_scan_orthogonal;
...
OAL_STATIC oal_void hwifi_config_host_amsdu_th_ini_param(oal_void)
{
    oal_int32 l_val = 0;
    ...
    g_st_tx_large_amsdu.us_amsdu_throughput_high = (l_val > 0) ? (oal_uint16)l_val : 500;
    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_AMSDU_AMPDU_TH_MIDDLE);
    g_st_tx_large_amsdu.us_amsdu_throughput_middle = (l_val > 0) ? (oal_uint16)l_val : 100;
    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_AMSDU_AMPDU_TH_LOW);
    g_st_tx_large_amsdu.us_amsdu_throughput_low = (l_val > 0) ? (oal_uint16)l_val : 50;
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
OAL_STATIC oal_void hwifi_config_tcp_ack_buf_ini_param(oal_void)
{
    oal_int32 l_val = 0;
...
OAL_STATIC oal_void hwifi_config_performance_ini_param(oal_void)
{
    oal_int32 l_val;
    ...
    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RX_AMPDU_BITMAP);
...
OAL_STATIC oal_void hwifi_config_cpu_freq_ini_param(oal_void)
{
    oal_int32 l_val;

#if defined(_PRE_FEATURE_PLAT_LOCK_CPUFREQ) && !defined(CONFIG_HI110X_KERNEL_MODULES_BUILD_SUPPORT)
    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_PRIV_DMA_LATENCY);
    g_freq_lock_control_etc.uc_lock_dma_latency = (l_val > 0) ? OAL_TRUE : OAL_FALSE;
    g_freq_lock_control_etc.dma_latency_value = (oal_uint16)l_val;
    OAL_IO_PRINT("DMA latency[%d]\r\n", g_freq_lock_control_etc.uc_lock_dma_latency);
    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_PRIV_LOCK_CPU_TH_HIGH);
    g_freq_lock_control_etc.us_lock_cpu_th_high = (oal_uint16)l_val;
    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_PRIV_LOCK_CPU_TH_LOW);
    g_freq_lock_control_etc.us_lock_cpu_th_low = (oal_uint16)l_val;
    OAL_IO_PRINT("CPU freq high[%d] low[%d]\r\n", g_freq_lock_control_etc.us_lock_cpu_th_high,
        g_freq_lock_control_etc.us_lock_cpu_th_low);
#endif
    ...
    OAL_IO_PRINT("irq affinity enable[%d]High_th[%u]Low_th[%u]\r\n", g_freq_lock_control_etc.en_irq_affinity,
        g_freq_lock_control_etc.us_throughput_irq_high, g_freq_lock_control_etc.us_throughput_irq_low);
}


OAL_STATIC oal_void hwifi_config_dmac_freq_ini_param(oal_void)
{
    oal_uint32 cfg_id;
    oal_uint32 ul_val;
...
oal_int32 hwifi_config_host_global_ini_param(oal_void)
{
    ...
    l_val = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_DDR_FREQ);
    g_ul_ddr_freq = (oal_uint32)l_val;

#ifdef _PRE_WLAN_FEATURE_HIEX
    hwifi_config_host_global_hiex_ini_param();
#endif
...
OAL_STATIC oal_void hwifi_config_selfstudy_init_country(oal_net_device_stru *pst_cfg_net_dev)
{
    oal_int32 l_ret;
    ...
    if (uc_val & CUS_PARAM_COUNTRYCODE_SELFSTUDY_OPEN0) {
        cust_country_code_ignore_flag.en_country_code_study_ingore_hipriv_flag = OAL_FALSE;
        l_ret = (oal_int32)wal_hipriv_setcountry(pst_cfg_net_dev, default_country_code);
        if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
            OAM_ERROR_LOG1(0, OAM_SF_ANY,
                           "{hwifi_config_selfstudy_init_country::send_cfg_event return err code [%d]!}", l_ret);
        }
    } else {
        cust_country_code_ignore_flag.en_country_code_study_ingore_hipriv_flag = OAL_TRUE;
    }
...
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST)
OAL_STATIC oal_void hwifi_cfg_front_end_2g_rf0_fem(mac_cfg_customize_rf *pst_customize_rf)
{
    /* 2g 外部fem */
    /* RF0 */
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].c_lna_bypass_gain_db =
        (oal_int8)CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_LNA_BYPASS_GAIN_DB_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].c_lna_gain_db =
        (oal_int8)CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_LNA_GAIN_DB_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].c_pa_gain_b0_db =
        (oal_int8)CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_PA_GAIN_DB_B0_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].c_pa_gain_b1_db =
        (oal_int8)CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_PA_GAIN_DB_B1_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].uc_pa_gain_lvl_num =
        (oal_int8)CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_PA_GAIN_LVL_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].uc_ext_switch_isexist =
        (oal_uint8) !!CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_SWITCH_ISEXIST_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].uc_ext_pa_isexist =
        (oal_uint8) !!CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_PA_ISEXIST_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].uc_ext_lna_isexist =
        (oal_uint8)CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_LNA_ISEXIST_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].us_lna_on2off_time_ns =
        (oal_uint16)CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_LNA_ON2OFF_TIME_NS_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ZERO].us_lna_off2on_time_ns =
        (oal_uint16)CUS_GET_LOW_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_LNA_OFF2ON_TIME_NS_2G));

}

OAL_STATIC oal_void hwifi_cfg_front_end_2g_rf1_fem(mac_cfg_customize_rf *pst_customize_rf)
{
    /* RF1 */
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].c_lna_bypass_gain_db =
        (oal_int8)CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_LNA_BYPASS_GAIN_DB_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].c_lna_gain_db =
        (oal_int8)CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_LNA_GAIN_DB_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].c_pa_gain_b0_db =
        (oal_int8)CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_PA_GAIN_DB_B0_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].c_pa_gain_b1_db =
        (oal_int8)CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_PA_GAIN_DB_B1_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].uc_pa_gain_lvl_num =
        (oal_int8)CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_PA_GAIN_LVL_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].uc_ext_switch_isexist =
        (oal_uint8) !!CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_SWITCH_ISEXIST_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].uc_ext_pa_isexist =
        (oal_uint8) !!CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_PA_ISEXIST_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].uc_ext_lna_isexist =
        (oal_uint8)CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_LNA_ISEXIST_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].us_lna_on2off_time_ns =
        (oal_uint16)CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_LNA_ON2OFF_TIME_NS_2G));
    pst_customize_rf->ast_ext_rf[WLAN_BAND_2G][WLAN_RF_CHANNEL_ONE].us_lna_off2on_time_ns =
        (oal_uint16)CUS_GET_HIGH_16BITS(hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_LNA_OFF2ON_TIME_NS_2G));

}
#else
OAL_STATIC oal_void hwifi_cfg_front_end_5g_fem(mac_cfg_customize_rf *pst_customize_rf)
{
    /* 5g 外部fem */
    pst_customize_rf->st_ext_rf.c_lna_bypass_gain_db =
        (oal_int8)hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_LNA_BYPASS_GAIN_DB_5G);
    pst_customize_rf->st_ext_rf.c_lna_gain_db =
        (oal_int8)hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_LNA_GAIN_DB_5G);
    pst_customize_rf->st_ext_rf.c_pa_gain_b0_db =
        (oal_int8)hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_RF_PA_GAIN_DB_B0_5G);
    pst_customize_rf->st_ext_rf.uc_ext_switch_isexist =
        (oal_uint8) !!hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_SWITCH_ISEXIST_5G);
    pst_customize_rf->st_ext_rf.uc_ext_pa_isexist =
        (oal_uint8) !!hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_PA_ISEXIST_5G);
    pst_customize_rf->st_ext_rf.uc_ext_lna_isexist =
        (oal_uint8) !!hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_EXT_LNA_ISEXIST_5G);
    pst_customize_rf->st_ext_rf.us_lna_on2off_time_ns =
        (oal_uint16)hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_LNA_ON2OFF_TIME_NS_5G);
    pst_customize_rf->st_ext_rf.us_lna_off2on_time_ns =
        (oal_uint16)hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_LNA_OFF2ON_TIME_NS_5G);

}
#endif


OAL_STATIC OAL_INLINE oal_uint32 hwifi_cfg_front_end_value_range_check(mac_cfg_customize_rf *pst_customize_rf,
    oal_int32 l_wlan_band, oal_int32 l_rf_db_min)
{
...
OAL_STATIC oal_uint32 hwifi_cfg_front_end(oal_uint8 *puc_param)
{
    ...
    for (uc_idx = 0; uc_idx < CUS_RF_PA_BIAS_REG_NUM; uc_idx++) {
        ...
        (oal_uint32)hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_TX2G_PA_GATE_VCTL_REG236 + uc_idx);
    }
#endif  // #if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST)
...
#else
        /* 5g 外部fem */
        hwifi_cfg_front_end_5g_fem(pst_customize_rf);
...
OAL_STATIC oal_uint32 hwifi_cfg_init_cus_dyn_cali(mac_cus_dy_cali_param_stru *puc_dyn_cali_param)
{
    oal_int32  l_val;
    oal_uint8  uc_idx = 0;
    oal_uint8  uc_rf_idx, uc_dy_cal_param_idx;
    ...
    for (uc_rf_idx = 0; uc_rf_idx < WLAN_RF_CHANNEL_NUMS; uc_rf_idx++) {
        ...
        l_ret = memcpy_s(puc_dyn_cali_param->al_dy_cali_base_ratio_params,
                         ...
                         pro_line_params[uc_rf_idx], OAL_SIZEOF(puc_dyn_cali_param->al_dy_cali_base_ratio_params));
        ...
        l_ret += memcpy_s(puc_dyn_cali_param->as_extre_point_val, OAL_SIZEOF(puc_dyn_cali_param->as_extre_point_val),
                          gs_extre_point_vals[uc_rf_idx], OAL_SIZEOF(puc_dyn_cali_param->as_extre_point_val));
...
OAL_STATIC oal_void hwifi_config_init_ini_rf(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    ul_ret = (oal_uint32)wal_send_cfg_event_etc(pst_cfg_net_dev,
                                                ...
                                                OAL_PTR_NULL);
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{hwifi_config_init_ini_rf::EVENT[wal_send_cfg_event_etc] fail[%d]!}", ul_ret);
    }
}
...
OAL_STATIC oal_uint32 hwifi_cfg_init_dts_cus_cali(oal_uint8 *puc_param, oal_uint8 uc_5g_Band_enable)
{
    ...
    pst_cus_cali->uc_tone_amp_grade =
        (oal_uint8)hwifi_get_init_value_etc(CUS_TAG_DTS, WLAN_CFG_DTS_CALI_TONE_AMP_GRADE);
    ...
    for (uc_idx = 0; uc_idx < MAC_DPD_CALI_CUS_PARAMS_NUM; uc_idx++) {
        ...
        /* 通道1 */
        l_val = hwifi_get_init_value_etc(CUS_TAG_DTS, WLAN_CFG_DTS_DPD_CALI_START +
...
OAL_STATIC oal_uint32 hwifi_config_init_dts_cali(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{hwifi_config_init_dts_cali::wal_send_cfg_event_etc failed, ret[%d]!}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_void hwifi_config_init_cus_dyn_cali(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    for (uc_rf_id = 0; uc_rf_id < WLAN_RF_CHANNEL_NUMS; uc_rf_id++) {
        ...
        ul_ret = wal_send_cfg_event_etc(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
            WAL_MSG_WRITE_MSG_HDR_LENGTH + ul_offset, (oal_uint8 *)&st_write_msg, OAL_TRUE, &pst_rsp_msg);
        if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
            return;
        }
...
oal_uint32 hwifi_config_init_nvram_main_etc(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{hwifi_config_init_nvram_main_etc::err [%d]!}", l_ret);
        return OAL_FAIL;
    }
...
oal_int32 hwifi_config_init_ini_etc(oal_net_device_stru *pst_net_dev)
{
    ...
    if (pst_net_dev == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{hwifi_config_init_ini_etc::net_dev null!}");
        return -OAL_EINVAL;
    }

    pst_mac_vap = OAL_NET_DEV_PRIV(pst_net_dev);
    if (pst_mac_vap == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{hwifi_config_init_ini_etc::mac_vap null}");
        return -OAL_EINVAL;
    }

    pst_wdev = OAL_NETDEVICE_WDEV(pst_net_dev);
    if (pst_wdev == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{hwifi_config_init_ini_etc::wdev null!}");
        return -OAL_EFAUL;
    }

    pst_wiphy_priv = (mac_wiphy_priv_stru *)oal_wiphy_priv(pst_wdev->wiphy);
    if (pst_wiphy_priv == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{hwifi_config_init_ini_etc::wiphy_priv null!}");
        return -OAL_EFAUL;
    }
    pst_mac_device = pst_wiphy_priv->pst_mac_device;
    if (pst_mac_device == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{hwifi_config_init_ini_etc::mac_device null!}");
        return -OAL_EFAUL;
    }

    pst_cfg_hmac_vap = (hmac_vap_stru *)mac_res_get_hmac_vap(pst_mac_device->uc_cfg_vap_id);
    if (pst_cfg_hmac_vap == OAL_PTR_NULL) {
        OAM_WARNING_LOG1(0, 0, "{hwifi_config_init_ini_etc::cfg_hmac_vap[%d] null}", pst_mac_device->uc_cfg_vap_id);
        return -OAL_EFAUL;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_load_ini_power_gain(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (hwifi_force_refresh_rf_params(pst_net_dev) != OAL_SUCC) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY,
            "{wal_hipriv_refresh_ini_power_gain::refresh rf(max_txpwr & dbb scale) params failed!}");
        return OAL_FAIL;
    }
    ...
    if (hwifi_config_init_etc(CUS_TAG_DTS)) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY,
            "{wal_hipriv_refresh_ini_power_gain::refresh CUS_TAG_DTS params failed!}");
        return OAL_FAIL;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_refresh_ini_power_gain::send_cfg_event err[%d]!}", l_ret);
...
OAL_STATIC oal_int32 wal_netdev_spe_init(oal_net_device_stru *pst_net_dev)
{
    ...
    if (l_port_num < 0) {
        OAL_IO_PRINT("wal_netdev_spe_init::spe port alloc fail;\r\n");
        return -OAL_FAIL;
    }
    pst_mac_vap->ul_spe_portnum = (oal_uint32)l_port_num;

    OAL_IO_PRINT("wal_netdev_spe_init::vap::%d;port_num::%d\n", pst_mac_vap->uc_vap_id, pst_mac_vap->ul_spe_portnum);
...
OAL_STATIC oal_int32 _wal_netdev_open(oal_net_device_stru *pst_net_dev,
    oal_uint8 uc_entry_flag, oal_int32 pm_ret)
{
    wal_msg_write_stru st_write_msg;
    oal_int32 l_ret;
    wal_msg_stru *pst_rsp_msg = OAL_PTR_NULL;
    ...
    if (OAL_UNLIKELY(pst_net_dev == OAL_PTR_NULL)) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_netdev_open_etc::pst_net_dev null!}");
        return -OAL_EFAUL;
    }

    OAL_IO_PRINT("wal_netdev_open_etc,dev_name is:%s\n", pst_net_dev->name);
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_netdev_open_etc::iftype:%d.!}", pst_net_dev->ieee80211_ptr->iftype);
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_netdev_open_etc::wal_alloc_cfg_event_etc err %d!}", l_ret);
        return l_ret;
    }
    ...
    ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_netdev_open_etc::hmac start vap fail,err code[%u]!}", ul_err_code);
        return -OAL_EINVAL;
    }
...
oal_int32 wal_netdev_open_etc(oal_net_device_stru *pst_net_dev, oal_uint8 uc_entry_flag)
{
    ...
    if (g_wait_wlan_power_on_cali == OAL_TRUE) {
        if (oal_wait_for_completion_timeout(&g_wlan_cali_completed,
                                            (oal_uint32)OAL_MSECS_TO_JIFFIES(WAL_WAIT_CALI_COMPLETE_TIME)) == 0) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_netdev_open_etc::wait [%d]ms g_wlan_cali_completed timeout(6s)!}");
...
oal_uint32 wal_custom_cali_etc(oal_void)
{
    ...
    pst_net_dev = wal_config_get_netdev_etc("Hisilicon0", OAL_STRLEN("Hisilicon0"));  // 通过cfg vap0来下c0 c1校准
    ...
    if (hwifi_config_init_nvram_main_etc(pst_net_dev)) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_custom_cali_etc::init_nvram fail!}");
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_custom_cali_etc:init_dts_main fail!}");
    }
...
OAL_STATIC oal_int32 _wal_netdev_stop(oal_net_device_stru *pst_net_dev)
{
    ...
    if (OAL_UNLIKELY(pst_net_dev == OAL_PTR_NULL)) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_netdev_stop_etc::pst_net_dev null!}");
        return -OAL_EFAUL;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        if (OAL_NET_DEV_PRIV(pst_net_dev) == OAL_PTR_NULL) {
            ...
            OAL_NETDEVICE_FLAGS(pst_net_dev) &= (~OAL_IFF_RUNNING);
            OAM_WARNING_LOG1(0, OAM_SF_ANY,
                "{wal_netdev_stop_etc::netdev's vap null, set flag not running, if_idx:%d}", pst_net_dev->ifindex);
        }
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_netdev_stop_etc::wal_alloc_cfg_event_etc err %d!}", l_ret);
        return l_ret;
    }
    ...
    ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_netdev_stop_etc::hmac stop vap fail!err code [%d]}", ul_err_code);
        return -OAL_EFAIL;
    }
...
#ifdef _PRE_WLAN_FEATURE_P2P
    /* p2p0 down时 删除VAP */
    // 如果上层删除p2p group(GC or GO)时，调用wal_del_p2p_group_etc删除p2p group的vap调用work queue删除GC or GO netdev
...
OAL_STATIC oal_int32 wal_ioctl_judge_input_param_length_etc(wal_wifi_priv_cmd_stru st_priv_cmd,
    oal_uint32 ul_cmd_length, oal_uint16 us_adjust_val)
{
    ...
    oal_int8 *pc_command, wal_wifi_priv_cmd_stru st_priv_cmd)
{
    ...
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_ioctl_priv_cmd_tx_power_etc::len at least CMD_TX_POWER_LEN + 2}");
        return -OAL_EFAIL;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_ioctl_priv_cmd_tx_power_etc::err [%d]!}", l_ret);
    ...
    oal_int8 *pc_command, wal_wifi_priv_cmd_stru st_priv_cmd)
{
    ...
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG0(0, 0, "{wal_ioctl_priv_cmd_ltecoex_mode_etc::len at least CMD_LTECOEX_MODE_LEN + 2}");
        return -OAL_EFAIL;
    }

    ltecoex_mode = oal_atoi(pc_command + CMD_LTECOEX_MODE_LEN + 1);

    OAM_WARNING_LOG1(0, 0, "{wal_ioctl_priv_cmd_ltecoex_mode_etc::CMD_LTECOEX_MODE,ltecoex mode:%d}", ltecoex_mode);

    l_ret = (oal_int32)wal_ioctl_ltecoex_mode_set(pst_net_dev, (oal_int8 *)&ltecoex_mode);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_ioctl_priv_cmd_ltecoex_mode_etc::err [%d]!}", l_ret);
        return -OAL_EFAIL;
    }
    return l_ret;
}
    ...
    oal_int8 *pc_command, wal_wifi_priv_cmd_stru st_priv_cmd)
{
    ...
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, 0, "{wal_ioctl_priv_cmd_country_etc::len gt[%d]}", CMD_COUNTRY_LEN + 3); /* 3 cmdpara */
        return -OAL_EFAIL;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_ioctl_priv_cmd_country_etc::err [%d]!}", l_ret);
...
OAL_STATIC oal_int32 wal_netdev_set_power_on(oal_net_device_stru *pst_net_dev, oal_int32 power_flag)
{
    ...
    if (power_flag == 0) { // 下电
        ...
        if (l_ret == OAL_FAIL) {
            ...
            l_ret = wal_host_dev_init_etc(pst_net_dev);
            if (l_ret != OAL_SUCC) {
                OAL_IO_PRINT("wal_host_dev_init_etc FAIL %d ", l_ret);
                return -OAL_EFAIL;
            }
        }
    } else {
...
#ifdef _PRE_WLAN_FEATURE_STA_PM
OAL_STATIC oal_int32 wal_ioctl_set_sta_pm_on(oal_net_device_stru *pst_net_dev,
    oal_uint8 *pc_command, wal_wifi_priv_cmd_stru st_priv_cmd)
{
    wal_msg_write_stru st_write_msg;
    ...
    oal_int8 *pc_command, wal_wifi_priv_cmd_stru st_priv_cmd)
{
    ...
    if ((ul_skip + pst_wps_p2p_ie->ul_ie_len + OAL_OFFSET_OF(oal_app_ie_stru, auc_ie)) >
        ...
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_ioctl_priv_cmd_set_ap_wps_p2p_ie_etc::SET_AP_WPS_P2P_IE param len:%d err}",
            (ul_skip + pst_wps_p2p_ie->ul_ie_len));
        return -OAL_EFAIL;
    }
    /*lint +e413*/
    l_ret = wal_ioctl_set_wps_p2p_ie_etc(pst_net_dev, pst_wps_p2p_ie->auc_ie,
...
oal_int32 wal_vendor_get_wifi6_supported(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr)
{
    oal_int32 l_priv_value = 0;
    oal_uint8 uc_val;
    ...
    /* 判断STA 11ax定制化是否打开 */
    if ((oal_uint32)l_priv_value & BIT0) {
        uc_val = PROTOCOL_WIFI6_SUPPORT;
    } else {
        uc_val = PROTOCOL_DEFAULT;
    }

    if (oal_copy_to_user(pst_ifr->ifr_data + WAL_IFR_DATA_OFFSET, &uc_val, OAL_SIZEOF(oal_uint8))) {
...
OAL_STATIC oal_int32 wal_vendor_get_radar_result(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr, \
    oal_int8 *pc_cmd)
{
    ...
    if (oal_copy_to_user(pst_ifr->ifr_data + 8, (oal_void *)pst_radar_result, /* 8 为偏移头字节 */
 ...
 */
oal_int32 wal_vendor_set_nrcoex_priority_etc(oal_net_device_stru *pst_net_dev,
    oal_ifreq_stru *pst_ifr, oal_int8 *pc_command)
{
    ...
    if (OAL_STRLEN(pc_command) < (OAL_STRLEN((oal_int8 *)CMD_SET_NRCOEX_PRIOR) + 2)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
            "{wal_vendor_set_nrcoex_priority_etc::CMD_SET_NRCOEX_PRIOR len err[%d].}", OAL_STRLEN(pc_command));
    ...
    OAM_WARNING_LOG1(0, OAM_SF_ANY,
        "{wal_vendor_set_nrcoex_priority_etc::CMD_SET_NRCOEX_PRIOR cmd,nrcoex priority:%d}", nrcoex_priority);

    l_ret = (oal_int32)wal_ioctl_nrcoex_priority_set(pst_net_dev, (oal_int8 *)&nrcoex_priority);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_vendor_set_nrcoex_priority_etc::err [%d]!}", l_ret);
        return -OAL_EFAIL;
    }
...
OAL_STATIC oal_uint32 wal_ioctl_get_nrcoex_stat(oal_net_device_stru *pst_net_dev, oal_int8 *puc_stat)
{
    ...
    /*lint -e730 -e740 -e774*/
    l_ret = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_device->st_nrcoex_stat_query.st_wait_queue,
...
#if (defined(_PRE_WLAN_FEATURE_PSM_FLT_STAT) || defined(_PRE_WLAN_FEATURE_PSM_DFX_EXT) || \
    defined(_PRE_WLAN_RX_LISTEN_POWER_SAVING))
oal_int32 wal_vendor_priv_cmd_power_saving(oal_net_device_stru *pst_net_dev,
                                                     oal_ifreq_stru *pst_ifr, oal_uint8 *pc_cmd)
{
    ...
    else if (oal_strncasecmp(pc_cmd, CMD_GET_BEACON_CNT, CMD_GET_BEACON_CNT_LEN) == 0) {
    ...
    else if (oal_strncasecmp(pc_cmd, CMD_GET_RX_LISTEN_STATE, OAL_STRLEN(CMD_GET_RX_LISTEN_STATE)) == 0) {
        return wal_ioctl_get_psm_stat(pst_net_dev, MAC_PSM_QUERY_RX_LISTEN_STATE, pst_ifr);
    } else if (oal_strncasecmp(pc_cmd, CMD_SET_RX_LISTEN_PS_SWITCH, OAL_STRLEN(CMD_SET_RX_LISTEN_PS_SWITCH)) == 0) {
...
#ifdef _PRE_WLAN_FEATURE_11AX
oal_uint32 wal_vendor_11ax_close_htc_handle(oal_net_device_stru *pst_net_dev)
{
    oal_uint8 uc_switch = 0;
    oal_int32 l_ret;
    wal_msg_write_stru st_write_msg;

    WAL_WRITE_MSG_HDR_INIT(&st_write_msg, WLAN_CFGID_SET_11AX_CLOSE_HTC, OAL_SIZEOF(uc_switch));
    st_write_msg.auc_value[0] = (oal_uint8)(uc_switch ? OAL_TRUE : OAL_FALSE);

    l_ret = wal_send_cfg_event_etc(pst_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(uc_switch), (oal_uint8 *)&st_write_msg,
...
oal_uint32 wal_vendor_11ax_wifi6_balcklist_handle(oal_net_device_stru *pst_net_dev,
    oal_uint8 *pc_cmd, oal_uint32 ul_cmd_len)
{
    oal_uint32 skip = CMD_SET_AX_BLACKLIST_LEN + 1;
    oal_int32 l_ret;
    oal_uint8 *pc_cmd_data;
    oal_uint8 uc_blacklist_cnt;
    wal_msg_write_stru st_write_msg;
    hmac_wifi6_self_cure_info_stru *pst_wifi6_self_cure_info;

    pc_cmd_data      = pc_cmd + skip;
    uc_blacklist_cnt = (oal_uint8)*pc_cmd_data;
    pc_cmd_data += 1;

    if (uc_blacklist_cnt > HMAC_WIFI6_SELF_CURE_BLACK_LIST_MAX_NUM) {
        OAM_WARNING_LOG2(0, OAM_SF_M2S, "{wal_vendor_11ax_wifi6_balcklist_handle::uc_blacklist_cnt=[%d],\
            max_num=[%d].}\r\n", uc_blacklist_cnt, HMAC_WIFI6_SELF_CURE_BLACK_LIST_MAX_NUM);
        return OAL_FAIL;
    }

    WAL_WRITE_MSG_HDR_INIT(&st_write_msg, WLAN_CFGID_SET_11AX_WIFI6_BLACKLIST,
        OAL_SIZEOF(hmac_wifi6_self_cure_info_stru));
    pst_wifi6_self_cure_info = (hmac_wifi6_self_cure_info_stru *)st_write_msg.auc_value;
    pst_wifi6_self_cure_info->uc_blaclist_num = uc_blacklist_cnt;
    memmove_s (pst_wifi6_self_cure_info->ast_wifi6_blacklist,
        uc_blacklist_cnt * OAL_SIZEOF(hmac_wifi6_self_cure_blacklist_stru), pc_cmd_data,
        uc_blacklist_cnt * OAL_SIZEOF(hmac_wifi6_self_cure_blacklist_stru));
...
uint32_t wal_vendor_clear_11n_blacklist_handle(oal_net_device_stru *p_net_dev)
{
    ...
    ret = wal_send_cfg_event_etc(p_net_dev, WAL_MSG_TYPE_WRITE,
...
OAL_STATIC oal_uint32 wal_vendor_priv_cmd_wifi6_etc(oal_net_device_stru *pst_net_dev,
    oal_ifreq_stru *pst_ifr, wal_wifi_priv_cmd_stru *pst_priv_cmd, oal_uint8 *pc_cmd)
{
    if (oal_strncasecmp(pc_cmd, CMD_GET_WIFI6_SUPPORT, CMD_GET_WIFI6_SUPPORT_LEN) == 0) {
        return wal_vendor_get_wifi6_supported(pst_net_dev, pst_ifr);
    }
#ifdef _PRE_WLAN_FEATURE_11AX
    if (oal_strncasecmp(pc_cmd, CMD_SET_AX_CLOSE_HTC, CMD_SET_AX_CLOSE_HTC_LEN) == 0) {
        return wal_vendor_11ax_close_htc_handle(pst_net_dev);
    } else if (oal_strncasecmp(pc_cmd, CMD_SET_AX_BLACKLIST, CMD_SET_AX_BLACKLIST_LEN) == 0) {
        return wal_vendor_11ax_wifi6_balcklist_handle(pst_net_dev, pc_cmd, pst_priv_cmd->ul_total_len);
    }
#endif
    return OAL_SUCC;
}
...
#ifdef _PRE_WLAN_FEATURE_HIEX
oal_uint8 g_tb_frame_gain[5];
OAL_STATIC oal_int32 wal_get_tb_frame_gain(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr)
{
    mac_vap_stru *pst_mac_vap;
    mac_channel_stru *pst_channel;
    oal_uint8 narrowband_gain_info[2];
    oal_uint8 tx_band;
    oal_int32 l_ret = 0;
    ...
    narrowband_gain_info[0] = pst_channel->uc_chan_number;
    if (pst_channel->en_band == WLAN_BAND_2G) {
        narrowband_gain_info[1] = g_tb_frame_gain[0];
    } else {
        if (pst_channel->uc_chan_number >= 36 && pst_channel->uc_chan_number <= 48) {
            tx_band = 1;
        } else if (pst_channel->uc_chan_number >= 52 && pst_channel->uc_chan_number <= 64) {
            tx_band = 2;
        } else if (pst_channel->uc_chan_number >= 100 && pst_channel->uc_chan_number <= 140) {
            tx_band = 3;
        } else {
            tx_band = 4;
        }
        narrowband_gain_info[1] = g_tb_frame_gain[tx_band];
    }

    l_ret = oal_copy_to_user(pst_ifr->ifr_data + 8, narrowband_gain_info, /* 8为hdr */
            OAL_SIZEOF(narrowband_gain_info));
    if (l_ret) {
        OAM_ERROR_LOG1(0, OAM_SF_CFG, "{wal_get_narrowband_gain::Failed to copy data to user error %d!}", l_ret);
    }
    return l_ret;
}
#endif
...
oal_int32 wal_vendor_priv_cmd_ext2_etc(oal_net_device_stru *pst_net_dev,
    oal_ifreq_stru *pst_ifr, wal_wifi_priv_cmd_stru *pst_priv_cmd, oal_uint8 *pc_cmd)
{
    oal_int32 l_ret = 0;
...
#if (defined(_PRE_WLAN_FEATURE_PSM_FLT_STAT) || defined(_PRE_WLAN_FEATURE_PSM_DFX_EXT) || \
    defined(_PRE_WLAN_RX_LISTEN_POWER_SAVING))
    l_ret = wal_vendor_priv_cmd_power_saving(pst_net_dev, pst_ifr, pc_cmd);
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "wal_vendor_priv_cmd_etc:one of power saving cmds faild!");
        return -OAL_EFAIL;
    }
#endif
...
#endif
    if (oal_strncasecmp(pc_cmd, CMD_SET_CLREAR_11N_BLACKLIST, CMD_SET_CLREAR_11N_BLACKLIST_LEN) == 0) {
        return wal_vendor_clear_11n_blacklist_handle(pst_net_dev);
    }
    return wal_vendor_priv_cmd_wifi6_etc(pst_net_dev, pst_ifr, pst_priv_cmd, pc_cmd);
}
    ...
    oal_ifreq_stru *pst_ifr, wal_wifi_priv_cmd_stru *pst_priv_cmd, oal_uint8 *pc_cmd)
{
    ...
    if (0 == oal_strncasecmp(pc_cmd, CMD_SET_VHT160_FEM_LOWER, CMD_SET_VHT160_FEM_LOWER_LEN)) {
        ...
        if (OAL_STRLEN(pc_cmd) < (CMD_SET_DC_STATE_LEN + 2)) {
            OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_ext_etc::dc status,cmd len[%d]}", OAL_STRLEN(pc_cmd));
            return -OAL_EFAIL;
        }
        ...
        return wal_vendor_priv_cmd_ext2_etc(pst_net_dev, pst_ifr, pst_priv_cmd, pc_cmd);
    }
...
oal_int32 wal_vendor_priv_cmd_etc(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr, oal_int32 ul_cmd)
{
    ...
    if (temp_flag) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::private cmd len err:%d}", st_priv_cmd.ul_total_len);
        return -OAL_EINVAL;
    }
    ...
    if (oal_strncasecmp(pc_command, CMD_SET_AP_WPS_P2P_IE, CMD_SET_AP_WPS_P2P_IE_LEN) == 0) {
        ...
        if ((skip + pst_mlme_ie->us_ie_len + OAL_OFFSET_OF(oal_mlme_ie_stru, auc_ie)) >
            (oal_uint32)st_priv_cmd.ul_total_len) {
            OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::SET_ASSOC_RSP_IE param len lt:%d}",
        ...
        if (l_ret != OAL_SUCC) {
            OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::CMD_P2P_SET_NOA param len too short. need %d.}",
        ...
        if (command_len < (CMD_SET_POWER_ON_LEN + 2)) {
            OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::CMD_SET_POWER_ON cmd len[%d] err}", command_len);
        ...
        if (command_len < (CMD_SET_POWER_MGMT_ON_LEN + 2)) {
            OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::CMD_SET_POWER_MGMT_ON len err:%d}", command_len);
        ...
        OAM_WARNING_LOG1(0, 0, "{wal_vendor_priv_cmd_etc::CMD_SET_POWER_MGMT_ON cmd,flag:%u}", power_mgmt_flag);
        ...
        if ((oal_uint32)st_priv_cmd.ul_total_len < CMD_CAPA_DBDC_SUPP_LEN) {
            OAM_ERROR_LOG1(0, 0, "{wal_vendor_priv_cmd_etc::CMD_GET_CAPA_DBDC len[%d] err}", st_priv_cmd.ul_total_len);
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
        ...
        if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_vendor_priv_cmd_etc:CMD_GET_CAPA_DBDC Fail to copy ioctl_data to user!");
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
        OAM_WARNING_LOG2(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::CMD_GET_CAPA_DBDC reply len:%d, ret:%d}",
        ...
        if (l_value != OAL_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_TPC, "{wal_vendor_priv_cmd_etc::CMD_SET_TAS_TXPOWER err [%d]!}", l_ret);
            oal_free(pc_command);
            return OAL_SUCC;
        }
        ...
        if (l_ret == OAL_SUCC) {
            ...
            OAM_WARNING_LOG2(0, OAM_SF_TPC, "{wal_vendor_priv_cmd_etc::SET_TAS_TXPOWER coreidx[%d] needImprove[%d]}",
                             l_param_1, l_param_2);
            /* TAS控制抬功率 */
        ...
        *pc_command = wlan_customize_etc.uc_disable_capab_2ght40;
        ...
        if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::VOWIFI_SET_PARAM err [%d]!}", l_ret);
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
        ...
        if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::CMD_VOWIFI_GET_MODE(%d) err [%d]!}", l_ret);
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
        ...
        *pl_value = l_value;
        ...
        if (oal_copy_to_user(pst_ifr->ifr_data + 8, pc_command, (oal_uint32)(st_priv_cmd.ul_total_len))) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_vendor_priv_cmd_etc:CMD_VOWIFi_GET_MODE copy ioctl_data to user fail!");
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
    }
        ...
        if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
            OAM_WARNING_LOG1(0, 0, "{wal_vendor_priv_cmd_etc::GET_WIFI_PRVI_FEATURE_CAPABILITY err:%d}", l_ret);
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
        ...
        *pl_value = l_value;
        ...
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "wal_vendor_priv_cmd_etc::GET_WIFI_PRVI_FEATURE_CAPABILITY[%x]!", *pl_value);

        if (oal_copy_to_user(pst_ifr->ifr_data + 8, pc_command, (oal_uint32)(st_priv_cmd.ul_total_len))) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_vendor_priv_cmd_etc:GET_WIFI_PRVI_FEATURE_CAPABILITY copy to user fail");
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
        ...
        if ((oal_uint32)st_priv_cmd.ul_total_len < CMD_VOWIFI_IS_SUPPORT_REPLY_LEN) {
            OAM_ERROR_LOG1(0, 0, "{wal_vendor_priv_cmd_etc::VOWIFI SUPPORT len[%d]}", st_priv_cmd.ul_total_len);
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
        /* 将buf清零 */
        ...
        if (oal_copy_to_user(pst_ifr->ifr_data + 8, pc_command, ret_len)) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_vendor_priv_cmd_etc:CMD_VOWIFI_IS_SUPPORT Failed to copy to user !");
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
    }
        ...
        if (l_ret != OAL_SUCC) {
            OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::CMD_FILTER_SWITCH cmd len[%d] < 8}", command_len);
        ...
        if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::CMD_FILTER_SWITCH err [%d]!}", l_ret);
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
#else
        ...
        if (l_ret != OAL_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd_etc::CMD_SETSUSPENDMODE len err[%d]}",
        ...
        if (l_ret != OAL_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "wal_vendor_priv_cmd_etc:CMD_GET_APF_PKTS_CNT Fail get psm stat:%d", l_ret);
            oal_free(pc_command);
            return -OAL_EFAIL;
        }
    }
        ...
        /* 圈复杂度限制，新增拓展私有命令接口 */
        l_ret = wal_vendor_priv_cmd_ext_etc(pst_net_dev, pst_ifr, &st_priv_cmd, pc_command);
    }
                                                    ...
                                                    oal_uint8 ul_value, mac_vap_stru *mac_vap)
{
    ...
    result = hmac_config_set_tlv_cmd(mac_vap, 0, (oal_uint8 *)pst_config_para);
    if (result != OAL_SUCC) {
...
OAL_STATIC oal_int32 wal_ext_priv_cmd_set_dev_freq(oal_net_device_stru *pst_net_dev, oal_uint8 uc_flag)
{
    ...
    if (uc_flag == FREQ_AUTO_FLAG) {
        result = wal_priv_cmd_dev_freq_para_etc(pst_config_para, CMD_SET_AUTO_FREQ_ENDABLE, FREQ_LOCK_ENABLE, mac_vap);
        if (result != OAL_SUCC) {
            oal_free(pst_config_para);
            pst_config_para = NULL;
            OAM_ERROR_LOG0(0, OAM_SF_CFG, "wal_ext_priv_cmd_set_dev_freq::wal_ext_priv_cmd_fill_para_etc fail!\n");
            return result;
        }
    } else if (uc_flag == FREQ_MAX_FLAG) {
        result = wal_priv_cmd_dev_freq_para_etc(pst_config_para, CMD_SET_AUTO_FREQ_ENDABLE, FREQ_LOCK_DISABLE, mac_vap);
        if (result != OAL_SUCC) {
            oal_free(pst_config_para);
            pst_config_para = NULL;
            OAM_ERROR_LOG0(0, OAM_SF_CFG, "wal_ext_priv_cmd_set_dev_freq::wal_ext_priv_cmd_fill_para_etc fail!\n");
        ...
        result = wal_priv_cmd_dev_freq_para_etc(pst_config_para, CMD_SET_DEVICE_FREQ_VALUE, FREQ_MAX_VALUE, mac_vap);
        if (result != OAL_SUCC) {
            oal_free(pst_config_para);
            pst_config_para = NULL;
            OAM_ERROR_LOG0(0, OAM_SF_CFG, "wal_ext_priv_cmd_set_dev_freq::wal_ext_priv_cmd_fill_para_etc fail!\n");
...
oal_int32 wal_ext_priv_cmd_etc(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr)
{
    ...
    CHR_EXCEPTION_P(CHR_WIFI_IWARE_RR_EVENTID, (oal_uint8 *)&st_priv_cmd.ul_cmd, sizeof(oal_uint32));
#endif
    return l_ret;
}
...
oal_int32 wal_net_device_ioctl(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr, oal_int32 ul_cmd)
{
    ...
    /* PC APP 通过ioctl下发的命令，上层适配+3 */
        ...
        l_ret = wal_ext_priv_cmd_etc(pst_net_dev, pst_ifr);
        return l_ret;
    }
#endif /* _PRE_WLAN_RR_PERFORMANCE */
#endif
...
OAL_STATIC oal_uint32 wal_hipriv_set_mode(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_mode::wal_get_cmd_one_arg_etc vap name err %d!}", ul_ret);
        return ul_ret;
    }
    ...
    */
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_mode::wal_alloc_cfg_event_etc err %d!}", l_ret);
        return (oal_uint32)l_ret;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_set_mode fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
...
oal_uint32 wal_hipriv_set_essid_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (pst_mac_vap->en_vap_mode == WLAN_VAP_MODE_BSS_AP) {
        ...
        if (0 != (OAL_IFF_RUNNING & OAL_NETDEVICE_FLAGS(pst_net_dev))) {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                "{wal_hipriv_set_essid_etc::dev  busy, please down it first:%d}", OAL_NETDEVICE_FLAGS(pst_net_dev));
            return -OAL_EBUSY;
        }
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_essid_etc::wal_get_cmd_one_arg_etc vap name err %d}", ul_ret);
        return ul_ret;
    }
    ...
    OAM_INFO_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_hipriv_set_essid_etc:: ssid length %d!}", uc_ssid_len);

    if (uc_ssid_len > WLAN_SSID_MAX_LEN - 1) { /* -1为\0预留空间 */
        uc_ssid_len = WLAN_SSID_MAX_LEN - 1;
    }

    OAM_INFO_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_hipriv_set_essid_etc:: ssid length is %d!}", uc_ssid_len);
    /* 抛事件到wal层处理 */
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id,
            OAM_SF_ANY, "{wal_hipriv_set_essid_etc::alloc_cfg_event err:%d}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_set_freq(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_freq::wal_get_cmd_one_arg_etc vap name err %d!}", ul_ret);
        return ul_ret;
    }
    ...
    *((oal_int32 *)(st_write_msg.auc_value)) = l_freq;
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   &pst_rsp_msg);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_freq::err %d!}", l_ret);
        return (oal_uint32)l_ret;
    }
    /* 读取返回的错误码 */
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_set_freq fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
...
oal_uint32 wal_regdomain_get_channel_etc(oal_uint8 uc_band,
    oal_uint32 ul_start_freq, oal_uint32 ul_end_freq)
{
    oal_uint32 ul_ch_bmap = 0;
    ;
...
oal_uint32 wal_linux_update_wiphy_channel_list_num_etc(oal_net_device_stru *pst_net_dev,
    oal_wiphy_stru *pst_wiphy)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_linux_update_wiphy_channel_list_num_etc::get chan list fail:%d}", ul_ret);
        return ul_ret;
    }
    ...
    OAM_WARNING_LOG2(0, OAM_SF_ANY, "{wal_linux_update_wiphy_channel_list_num_etc::2g_chan_num:%d, 5g_chan_num:%d}",
    ...
    mac_regdomain_info_stru *pst_mac_regdom)
{
    ...
    for (ul_i = 0; ul_i < pst_regdom->n_reg_rules; ul_i++) {
...
#ifdef _PRE_WLAN_COUNTRYCODE_SELFSTUDY
        wal_selfstudy_default_regdomain_dfs_config(pst_regdom, pst_mac_regdom, ul_i);
#endif
        /* 填充覆盖类和最大发送功率 */
        ...
        pst_mac_regdom->ast_regclass[ul_i].us_max_tx_pwr =
            (oal_uint16)(pst_regdom->reg_rules[ul_i].power_rule.max_eirp / 10);
    }
}
...
oal_int32 wal_regdomain_update_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country)
{
    ...
    if (OAL_TRUE == hwifi_is_regdomain_changed_etc((oal_uint8 *)old_pc_country, (oal_uint8 *)pc_country)) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_regdomain_update_etc::regdomain changed, refresh rf param!}");
    ...
    if (!wal_is_alpha_upper(pc_country[0]) || !wal_is_alpha_upper(pc_country[1])) {
        if ((pc_country[0] == '9') && (pc_country[1] == '9')) {
            ...
            OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_regdomain_update_etc::country str invalid!}");
            return -OAL_EINVAL;
        }
    }
    ...
    if (pst_mac_regdom == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_regdomain_update_etc::alloc regdom mem fail(%d),null ptr!}", us_size);
        return -OAL_ENOMEM;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_regdomain_update_etc::err %d!}", l_ret);
    ...
    pst_mac_vap = (mac_vap_stru *)OAL_NET_DEV_PRIV(pst_net_dev);
    if (OAL_UNLIKELY(pst_mac_vap == OAL_PTR_NULL)) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_regdomain_update_etc::OAL_NET_DEV_PRIV(pst_net_dev) null.}");
        return -OAL_FAIL;
    }
...
OAL_STATIC oal_void wal_regdomain_update_rf_param_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country,
                                                      oal_int8 *old_pc_country)
{
    if (EOK != memcpy_s(old_pc_country, COUNTRY_CODE_LEN, hwifi_get_country_code_etc(), COUNTRY_CODE_LEN)) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_regdomain_update_rf_param_etc::memcpy fail!");
        return;
    }
    ...
    /* 如果新的国家码和旧国家处于一个regdomain，不刷新RF参数，只更新国家码 */
    if (OAL_TRUE == hwifi_is_regdomain_changed_etc((oal_uint8 *)old_pc_country, (oal_uint8 *)pc_country)) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_regdomain_update_rf_param_etc::regdomain changed, refresh rf param!}");

        /* 刷新参数失败，为了保证国家码和功率参数对应 */
        /* 将国家码设回原来的国家码，本次更新失败 */
        if (hwifi_force_refresh_rf_params(pst_net_dev) != OAL_SUCC) {
            OAM_WARNING_LOG0(0, OAM_SF_ANY,
                "{wal_regdomain_update_rf_param_etc::refresh rf params failed. Set country back.!}");
            hwifi_set_country_code_etc(old_pc_country, COUNTRY_CODE_LEN);
        }
    }
}
...
OAL_STATIC oal_int32 wal_regdomain_confirm_etc(oal_int8 *pc_country, mac_regdomain_info_stru *pst_mac_regdom)
{
    if (!wal_is_alpha_upper(pc_country[0]) || !wal_is_alpha_upper(pc_country[1])) {
        if ((pc_country[0] == '9') && (pc_country[1] == '9')) {
            OAM_INFO_LOG0(0, OAM_SF_ANY, "{wal_regdomain_confirm_etc::set regdomain to 99!}");
        } else {
            OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_regdomain_confirm_etc::country str invalid!}");
            return -OAL_EINVAL;
        }
    }
    return OAL_SUCC;
...
OAL_STATIC oal_void wal_regdomain_update_hostapd_param_etc(OAL_CONST oal_ieee80211_regdomain_stru *pst_regdom,
                                                           oal_net_device_stru *pst_net_dev)
{
    mac_vap_stru *pst_mac_vap = OAL_PTR_NULL;
    oal_uint8 uc_dev_id;
    ...
    pst_mac_vap = (mac_vap_stru *)OAL_NET_DEV_PRIV(pst_net_dev);
    if (OAL_UNLIKELY(pst_mac_vap == OAL_PTR_NULL)) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_regdomain_update_hostapd_param_etc::OAL_NET_DEV_PRIV null.}");
        return;
    }
    ...
    if ((pst_device != OAL_PTR_NULL) && (pst_device->pst_wiphy != OAL_PTR_NULL)) {
        ...
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_regdomain_update_hostapd_param_etc::update regdom to kernel.}");
...
oal_int32 wal_selfstdy_regdomain_update_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country)
{
    OAL_CONST oal_ieee80211_regdomain_stru *pst_regdom;
    oal_uint16 us_size;
    mac_regdomain_info_stru *pst_mac_regdom = OAL_PTR_NULL;
    ...
    wal_regdomain_update_rf_param_etc(pst_net_dev, pc_country, old_pc_country);
#endif

    l_ret = wal_regdomain_confirm_etc(pc_country, pst_mac_regdom);
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev, WAL_MSG_TYPE_WRITE,
                                   WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_country_stru),
                                   (oal_uint8 *)&st_write_msg, OAL_FALSE, &pst_rsp_msg);
    ...
    /* 驱动不支持ACS时，更新hostapd管制域信息; 如果驱动支持ACS，则不需要更新，否则hostapd无法配置DFS信道 */
#ifndef _PRE_SUPPORT_ACS
    wal_regdomain_update_hostapd_param_etc(pst_regdom, pst_net_dev);
#endif
    return OAL_SUCC;
}
#endif
...
oal_int32 wal_regdomain_update_for_dfs_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country)
{
    ...
    pst_mac_regdom = OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL, us_size, OAL_TRUE);
    if (pst_mac_regdom == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_regdomain_update_for_dfs_etc::alloc regdom mem fail,size[%d]}", us_size);
        return -OAL_ENOMEM;
    }
    ...
    *pst_param = pst_mac_regdom->en_dfs_domain;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        ...
        OAL_MEM_FREE(pst_mac_regdom, OAL_TRUE);
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_regdomain_update_for_dfs_etc::err %d!}", l_ret);
        return l_ret;
    }
    /* pst_mac_regdom内存，此处释放 */
    OAL_MEM_FREE(pst_mac_regdom, OAL_TRUE);
...
oal_uint32 wal_regdomain_update_sta_etc(oal_uint8 uc_vap_id)
{
    ...
    if (us_updata_rd_by_ie_switch == OAL_TRUE) {
        ...
        if (OAL_UNLIKELY(pc_desired_country == OAL_PTR_NULL)) {
            OAM_ERROR_LOG0(uc_vap_id, OAM_SF_ANY, "{wal_regdomain_update_sta_etc::pc_desired_country null!}");
            return OAL_ERR_CODE_PTR_NULL;
        }

        /* 期望的国家码全为0，表示对端AP的国家码不存在，采用sta当前默认的国家码 */
        if ((pc_desired_country[0] == 0) && (pc_desired_country[1] == 0)) {
            OAM_INFO_LOG0(uc_vap_id, OAM_SF_ANY, "{wal_regdomain_update_sta_etc::ap has no country ie,use default}");
            return OAL_SUCC;
        }

        pst_net_dev = hmac_vap_get_net_device_etc(uc_vap_id);
        if (OAL_UNLIKELY(pst_net_dev == OAL_PTR_NULL)) {
            OAM_ERROR_LOG0(uc_vap_id, OAM_SF_ANY, "{wal_regdomain_update_sta_etc::pst_net_dev null!}");
            return OAL_ERR_CODE_PTR_NULL;
        }

        l_ret = wal_regdomain_update_for_dfs_etc(pst_net_dev, pc_desired_country);
        if (l_ret != OAL_SUCC) {
            OAM_WARNING_LOG1(uc_vap_id, OAM_SF_ANY, "{wal_regdomain_update_sta_etc::regdomain_update err:%d!}", l_ret);
            return OAL_FAIL;
        }
        ...
        OAM_INFO_LOG0(uc_vap_id, OAM_SF_ANY, "{wal_regdomain_update_sta_etc::us_updata_rd_by_ie_switch is fail!}");
    }
    return OAL_SUCC;
}
...
oal_int32 wal_regdomain_update_country_code_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country)
{
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_regdomain_update_country_code_etc::update_for_dfs err [%d]!}", l_ret);
        return -OAL_EFAIL;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_regdomain_update_country_code_etc::update err [%d]!}", l_ret);
        return -OAL_EFAIL;
    }
    return OAL_SUCC;
}
...
oal_int32 wal_regdomain_update_selfstudy_country_code_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country)
{
    oal_int32   l_ret;

    if (pst_net_dev == OAL_PTR_NULL || pc_country == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY,
            "{wal_regdomain_update_selfstudy_country_code_etc::null ptr.net_dev %p!}", (uintptr_t)pst_net_dev);
        return -OAL_EFAIL;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
            "{wal_regdomain_update_selfstudy_country_code_etc::update_for_dfs return err code [%d]!}\r\n", l_ret);
        return -OAL_EFAIL;
    }

    l_ret = wal_selfstdy_regdomain_update_etc(pst_net_dev, pc_country);

    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
            "{wal_regdomain_update_selfstudy_country_code_etc::update return err code [%d]!}\r\n", l_ret);
        return -OAL_EFAIL;
    }
    return OAL_SUCC;
}

OAL_STATIC oal_void wal_regdomain_update_by_ap_etc(oal_uint8 uc_vap_id)
{
    oal_int8 *pc_desired_country = OAL_PTR_NULL;
    oal_net_device_stru *pst_net_dev = OAL_PTR_NULL;
    oal_int32 l_ret;
    ...
    if (g_country_code_result[0] == '9' && g_country_code_result[1] == '9') {
        ...
        l_ret = wal_regdomain_update_selfstudy_country_code_etc(pst_net_dev, pc_desired_country);
    }
}

oal_void wal_selfstudy_regdomain_update_by_ap_etc(frw_event_stru *pst_event)
{
    if (cust_country_code_ignore_flag.en_country_code_study_ingore_hipriv_flag == OAL_FALSE) {
        wal_regdomain_update_by_ap_etc(pst_event->st_event_hdr.uc_vap_id);
    }
}
...
OAL_STATIC oal_void wal_selfstudy_default_regdomain_dfs_config(OAL_CONST oal_ieee80211_regdomain_stru *pst_regdom,
                                                               ...
                                                               oal_uint32 ul_i)
{
    if (pst_mac_regdom->ac_country[0] == '9' && pst_mac_regdom->ac_country[1] == '9') {
        if (ul_i != 0) {
            pst_mac_regdom->ast_regclass[ul_i].uc_behaviour_bmap |= MAC_RC_DFS;
        }
    }
...
oal_int32 wal_set_random_mac_to_mib_etc(oal_net_device_stru *pst_net_dev)
{
    ...
    */
    ul_ret = wal_alloc_cfg_event_etc(pst_net_dev, &pst_event_mem, NULL, &pst_cfg_msg,
        (WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_staion_id_param_stru))); /* 申请事件 */
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_set_random_mac_to_mib_etc() fail; return %d!}", ul_ret);
        return -OAL_ENOMEM;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_getcountry(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        ...
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_getcountry::wal_alloc_cfg_event_etc err %d!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
#define BW_ENUM_TO_NUMBER(_bw)  ((_bw) == 0 ? 20 : (_bw) == 1 ? 40 : 80)
    ...
    OAL_DLIST_SEARCH_FOR_EACH_SAFE(pst_entry, pst_dlist_tmp, &(pst_mac_vap->st_mac_user_list_head))
    {
        ...
        l_ret = wal_send_cfg_event_etc(pst_hmac_vap->pst_net_device, WAL_MSG_TYPE_WRITE,
...
OAL_STATIC oal_void wal_vap_stat_info(struct seq_file *f, oam_vap_stat_info_stru *pst_oam_vap_stat)
{
...
OAL_STATIC oal_uint32 wal_hipriv_add_vap(oal_net_device_stru *pst_cfg_net_dev, oal_int8 *pc_param)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_add_vap::wal_get_cmd_one_arg_etc err_code %d!}", ul_ret);
        return ul_ret;
    }
    ...
    /* 根据dev_name找到dev */
    pst_net_dev = wal_config_get_netdev_etc(ac_name, OAL_STRLEN(ac_name));
    if (pst_net_dev != OAL_PTR_NULL) {
        /* 调用oal_dev_get_by_name后，必须调用oal_dev_put使net_dev的引用计数减一 */
        oal_dev_put(pst_net_dev);
    ...
    pst_net_dev = oal_net_alloc_netdev_mqs(OAL_SIZEOF(oal_netdev_priv_stru), ac_name,
        oal_ether_setup, WAL_NETDEV_SUBQUEUE_MAX_NUM, 1); /* 此函数第一个入参代表私有长度，此处不涉及为0 */
    ...
    ((mac_cfg_add_vap_param_stru *)st_write_msg.auc_value)->bit_11ac2g_enable =
        (oal_uint8)!!hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_11AC2G_ENABLE);
    ((mac_cfg_add_vap_param_stru *)st_write_msg.auc_value)->bit_disable_capab_2ght40 =
        wlan_customize_etc.uc_disable_capab_2ght40;
#endif
    /* 发送消息 */
    l_ret = wal_send_cfg_event_etc(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
    ...
    /* 注册net_device */
    ul_ret = (oal_uint32)hmac_net_register_netdev(pst_net_dev);
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        ...
        if (l_ret != OAL_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_add_vap::wal_send_cfg_event_etc fail,err code %d!}", l_ret);
        }
...
oal_uint32 wal_hipriv_del_vap_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_UNLIKELY(0 != (OAL_IFF_RUNNING & OAL_NETDEVICE_FLAGS(pst_net_dev)))) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_hipriv_del_vap_etc::dev busy, down it first:%d}",
    ...
    if (pst_mac_vap->en_vap_mode == WLAN_VAP_MODE_CONFIG) {
        OAM_WARNING_LOG0(0, OAM_SF_CFG, "{wal_hipriv_del_vap_etc::invalid para,cfg vap!}");
        return OAL_ERR_CODE_INVALID_CONFIG;
    }
...
#endif
    {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_hipriv_del_vap_etc::device busy, down it first %d!}",
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_del_vap_etc::err %d}", l_ret);
        /* 去注册 */
...
oal_uint32 wal_hipriv_vap_info_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_vap_info_etc::err %d!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_ipriv_ip_filter_items(wal_hw_wifi_filter_item *pst_items,
    oal_uint32 ul_item_size, oal_int32 l_count)
{
...
oal_uint32 wal_hipriv_set_ip_filter_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_ip_filter_etc::wal_get_cmd_one_arg_etc err_code:%d}", ul_ret);
        return ul_ret;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_ip_filter_etc::get cmd_param err %d!}", ul_ret);
        return ul_ret;
    }
    ...
    if (0 == oal_strncmp(ac_cmd, CMD_SET_RX_FILTER_ENABLE, OAL_STRLEN(CMD_SET_RX_FILTER_ENABLE))) {
        ...
        for (l_items_idx = 0; l_items_idx < l_items_cnt; l_items_idx++) {
            ...
            ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_cmd_param, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
            if (ul_ret != OAL_SUCC) {
                OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_ip_filter_etc::get item_params err:%d!}", ul_ret);
                return ul_ret;
            }
    ...
    oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_2040_coext_support::wal_get_cmd_one_arg_etc err:%d}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_rx_fcs_info(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_rx_fcs_info::wal_get_cmd_one_arg_etc  err_code %d!}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_vap_log_level(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    */
    ...
    if (0 == oal_strcmp("Hisilicon0", pst_net_dev->name)) {
        hmac_config_set_all_log_level_etc(pst_mac_vap, OAL_SIZEOF(oam_log_level_enum_uint8),
            (oal_uint8 *)&en_level_val);
        return OAL_SUCC;
    }
#endif
...
OAL_STATIC oal_uint32 wal_ioctl_ltecoex_mode_set(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    *((oal_uint8 *)(st_write_msg.auc_value)) = *pc_param;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_ioctl_ltecoex_mode_set::err[%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_aifsn_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_aifsn_cfg::get wfa switch fail, err[%d]!}", ul_ret);
        return ul_ret;
    }
    pc_param += ul_off_set;
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_aifsn_cfg::get wfa ac fail, err[%d]!}", ul_ret);
        return ul_ret;
    }
    pc_param += ul_off_set;
    ...
    if (st_edca_cfg.en_switch == OAL_TRUE) {
        ...
        ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
        if (ul_ret != OAL_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_aifsn_cfg::get wfa val fail, err[%d]!}", ul_ret);
            return ul_ret;
        }
        pc_param += ul_off_set;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_aifsn_cfg::err[%d]!}", ul_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_cw_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_cw_cfg::get wfa switch fail, err[%d]!}", ul_ret);
        return ul_ret;
    }
    pc_param += ul_off_set;
    st_edca_cfg.en_switch = (oal_bool_enum_uint8)oal_atoi(ac_name);
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_cw_cfg::get wfa ac fail, err[%d]!}", ul_ret);
        return ul_ret;
    }
    pc_param += ul_off_set;
    st_edca_cfg.en_ac = (wlan_wme_ac_type_enum_uint8)oal_atoi(ac_name);
    ...
    if (st_edca_cfg.en_switch == OAL_TRUE) {
        ...
        ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
        if (ul_ret != OAL_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_cw_cfg::get wfa val fail, err[%d]!}", ul_ret);
            return ul_ret;
        }
        pc_param += ul_off_set;
    ...
    /* 设置配置命令参数 */
    if (EOK != memcpy_s(st_write_msg.auc_value, OAL_SIZEOF(st_edca_cfg),
                        (const oal_void *)&st_edca_cfg, OAL_SIZEOF(st_edca_cfg))) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_aifsn_cfg::memcpy fail!");
        return OAL_FAIL;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_set_smps_vap_mode(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_SMPS, "{wal_hipriv_set_smps_vap_mode::wal_get_cmd_one_arg_etc err[%d]}", ul_ret);
        return ul_ret;
    }
    ...
    if (0 == (oal_strcmp("1", ac_name))) {
        ...
        OAM_ERROR_LOG1(0, OAM_SF_SMPS, "{wal_hipriv_set_smps_vap_mode::err cmd[%x],input1/2/3!}", (uintptr_t)ac_name);
        return OAL_ERR_CODE_INVALID_CONFIG;
    }
    ...
    *((oal_int32 *)(st_write_msg.auc_value)) = l_tmp; /* 设置配置命令参数 */
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_SMPS, "{wal_hipriv_set_smps_vap_mode::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_set_smps_mode(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_SMPS, "{wal_hipriv_set_smps_mode::wal_get_cmd_one_arg_etc err[%d]}", ul_ret);
        return ul_ret;
    }
    ...
    *((oal_int32 *)(st_write_msg.auc_value)) = l_tmp; /* 设置配置命令参数 */
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_SMPS, "{wal_hipriv_set_smps_mode::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_set_uapsd_cap(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_uapsd_cap::wal_get_cmd_one_arg_etc err[%d]}", ul_ret);
        return ul_ret;
    }
...
oal_uint32 wal_hipriv_set_rate_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_arg, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_rate_etc::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_rate_etc::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
    /* 读取返回的错误码 */
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_set_rate_etc fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
    //#endif  /* _PRE_WLAN_CHIP_TEST */
    return OAL_SUCC;
...
oal_uint32 wal_hipriv_set_mcs_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_arg, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_mcs_etc::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if (l_mcs < WAL_HIPRIV_HT_MCS_MIN || l_mcs > WAL_HIPRIV_HT_MCS_MAX) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_mcs_etc::input val out of range [%d]!}", l_mcs);
        return OAL_ERR_CODE_INVALID_CONFIG;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_mcs_etc::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
    /* 读取返回的错误码 */
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_set_mcs_etc fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
    //#endif  /* _PRE_WLAN_CHIP_TEST */
    return OAL_SUCC;
...
oal_uint32 wal_hipriv_set_mcsac_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_arg, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_mcsac_etc::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_mcsac_etc::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
    /* 读取返回的错误码 */
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_set_mcsac_etc fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_always_tx_hw_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_always_tx_hw_cfg::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    pc_param = pc_param + ul_off_set;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_always_tx_hw_cfg::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_always_tx_hw(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_always_tx_hw::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if (pst_al_hw_tx->bit_switch == OAL_SWITCH_ON) {
        ...
        if (pst_al_hw_tx->ul_len > 65535) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_always_tx_hw::len [%u] overflow!}", pst_al_hw_tx->ul_len);
            return OAL_ERR_CODE_INVALID_CONFIG;
        }
        ...
        if (pst_al_hw_tx->ul_ifs > 65535) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_always_tx_hw::al_tx ifs[%u] overflow}", pst_al_hw_tx->ul_ifs);
            return OAL_ERR_CODE_INVALID_CONFIG;
        }
    }

    l_ret = wal_send_cfg_event_etc(pst_net_dev,
        WAL_MSG_TYPE_WRITE, WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_al_tx_hw_stru),
        (oal_uint8 *)&st_write_msg, OAL_FALSE, OAL_PTR_NULL);

    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_always_tx_hw::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_always_rx(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_arg, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_always_rx::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    *(oal_uint8 *)(st_write_msg.auc_value) = uc_rx_flag;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_always_rx::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
    /* 读取返回的错误码 */
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_always_rx fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_set_sniffer(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    memset_s((oal_uint8 *)&st_cfg_sniffer_param, OAL_SIZEOF(st_cfg_sniffer_param),
        0, OAL_SIZEOF(st_cfg_sniffer_param));

    /* 获取sniffer开关标志 */
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_arg, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_sniffer::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    OAM_WARNING_LOG4(0, OAM_SF_ANY, "{wal_hipriv_set_sniffer::ac_name[0]=[%d] [%d],ac_name[%x:%x:%x].}",
        ac_name[0], ac_name[3], ac_name[4], ac_name[5]); /* 3 4 5 cmd para */
    ...
    OAM_WARNING_LOG4(0, OAM_SF_ANY, "{wal_hipriv_set_sniffer::uc_sniffer_mode [%d],mac[3-4]=[%x:%x:%x].}",
                     uc_sniffer_mode,
                     st_cfg_sniffer_param.auc_mac_addr[3],  /* 3 macaddr */
                     st_cfg_sniffer_param.auc_mac_addr[4],  /* 4 macaddr */
                     st_cfg_sniffer_param.auc_mac_addr[5]); /* 5 macaddr */
    ...
    for (ul_mac_address_index = 0; ul_mac_address_index < WLAN_MAC_ADDR_LEN; ul_mac_address_index++) {
        pst_cfg_sniffer_param->auc_mac_addr[ul_mac_address_index] =
            st_cfg_sniffer_param.auc_mac_addr[ul_mac_address_index];
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_sniffer::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
    /* 读取返回的错误码 */
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_set_sniffer fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
    return OAL_SUCC;
}
...
OAL_STATIC oal_uint32 wal_hipriv_enable_monitor_mode(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_arg, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_enable_monitor_mode::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    *(oal_uint8 *)(st_write_msg.auc_value) = uc_monitor_mode;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_enable_monitor_mode::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
    ...
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_enable_monitor_mode fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_pcie_pm_level(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_arg, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_pcie_pm_level::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_pcie_pm_level::err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
    return OAL_SUCC;
}
...
OAL_STATIC oal_uint32 wal_hipriv_find_cmd(oal_int8 *pc_cmd_name,
    oal_uint8 uc_cmd_name_len, wal_hipriv_cmd_entry_stru **pst_cmd_id)
{
...
OAL_STATIC oal_uint32 wal_hipriv_get_cmd_net_dev(oal_int8 *pc_cmd,
    oal_net_device_stru **ppst_net_dev, oal_uint32 *pul_off_set)
{
    oal_net_device_stru *pst_net_dev = OAL_PTR_NULL;
    ...
    /* 根据dev_name找到dev */
    pst_net_dev = wal_config_get_netdev_etc(ac_dev_name, OAL_STRLEN(ac_dev_name));
    if (pst_net_dev == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_hipriv_get_cmd_net_dev::wal_config_get_netdev_etc return null ptr!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_get_cmd_id(oal_int8 *pc_cmd,
    wal_hipriv_cmd_entry_stru **pst_cmd_id, oal_uint32 *pul_off_set)
{
...
oal_uint32 wal_hipriv_parse_cmd_etc(oal_int8 *pc_cmd)
{
    ...
    */
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_parse_cmd_etc::wal_hipriv_get_cmd_net_dev error[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_parse_cmd_etc::wal_hipriv_get_cmd_id  error[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_parse_cmd_etc::g_ast_hipriv_cmd  error[%d]!}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_int32 wal_hipriv_proc_write(oal_file_stru *pst_file,
    const oal_int8 *pc_buffer, oal_uint32 ul_len, oal_void *p_data)
{
...
OAL_STATIC oal_uint32 wal_hipriv_set_regdomain_pwr(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   OAL_PTR_NULL);
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_set_regdomain_pwr::wal_send_cfg_event_etc fail:%d}", l_ret);
    }
...
OAL_STATIC oal_uint32 wal_hipriv_dump_all_rx_dscr(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_dump_all_rx_dscr::return err code [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_dfs_radartool(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_UNLIKELY(WAL_MSG_WRITE_MAX_LEN <= OAL_STRLEN(pc_param))) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
            "{wal_hipriv_dfs_radartool:: pc_param overlength is %d}\n", OAL_STRLEN(pc_param));
        oal_print_hex_dump((oal_uint8 *)pc_param, WAL_MSG_WRITE_MAX_LEN, 32, /* 32 msg len */
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_dfs_radartool::return err code [%d]!}", l_ret);
...
oal_uint32 wal_hipriv_alg_cfg_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_alg_cfg_etc::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if (st_alg_cfg.pc_name == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_hipriv_alg_cfg_etc::invalid alg_cfg cmd!}");
        return OAL_FAIL;
    }
    ...
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_alg_cfg_etc fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }
...
oal_int32 wal_ioctl_set_mlme_ie_etc(oal_net_device_stru *pst_net_dev, oal_mlme_ie_stru *pst_mlme_ie)
{
    ...
    if ((l_ret != OAL_SUCC) || (pst_rsp_msg == OAL_PTR_NULL)) {
        OAM_ERROR_LOG1(0, OAM_SF_P2P, "{wal_ioctl_set_mlme:: wal_alloc_cfg_event_etc return err code %d!}", l_ret);
        return l_ret;
    }
...
static oal_uint32 wal_ioctl_parse_wps_p2p_ie(oal_app_ie_stru *pst_app_ie,
    oal_uint8 *puc_src, oal_uint32 ul_src_len)
{
...
oal_int32 wal_ioctl_set_wps_p2p_ie_etc(oal_net_device_stru *pst_net_dev,
    oal_uint8 *puc_buf, oal_uint32 ul_len, en_app_ie_type_uint8 en_type)
{
    wal_msg_write_stru st_write_msg;
    ...
    switch (en_type) {
        ...
        case OAL_APP_ASSOC_RSP_IE:
            ...
            break;
        default:
            OAM_ERROR_LOG1(0, OAM_SF_CFG, "{wal_ioctl_set_wps_p2p_ie_etc:: wrong type: [%x]!}", en_type);
            return -OAL_EFAIL;
    }

    if (OAL_FALSE == IS_LEGACY_VAP(pst_mac_vap)) {
        if (OAL_SUCC != wal_ioctl_parse_wps_p2p_ie(&st_app_ie, puc_buf, ul_len)) {
            OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_ioctl_set_wps_p2p_ie_etc::Type=[%d], parse p2p ie fail!}", en_type);
            return -OAL_EFAIL;
        }
    } else {
    ...
    OAM_WARNING_LOG3(0, OAM_SF_CFG, "{wal_ioctl_set_wps_p2p_ie_etc::p2p_ie_type[%d],len[%d],st_app_ie.ul_ie_len[%d]}",
    ...
    if ((l_ret != OAL_SUCC) || (pst_rsp_msg == OAL_PTR_NULL)) {
        OAM_ERROR_LOG1(0, OAM_SF_P2P, "{wal_ioctl_set_wps_p2p_ie_etc:: wal_alloc_cfg_event_etc err %d!}", l_ret);
        return l_ret;
    }
    ...
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_P2P,
            "{wal_ioctl_set_wps_p2p_ie_etc::wal_check_and_release_msg_resp_etc fail err: [%d]!}", ul_err_code);
        return -OAL_EFAIL;
    }
    ...
    mac_cfg_p2p_noa_param_stru *pst_p2p_noa_param)
{
    ...
    if ((l_ret != OAL_SUCC) || (pst_rsp_msg == OAL_PTR_NULL)) {
        OAM_ERROR_LOG1(0, OAM_SF_P2P, "{wal_ioctl_set_p2p_noa:: wal_alloc_cfg_event_etc return err code %d!}", l_ret);
        return l_ret;
    }
    ...
    ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_P2P, "{wal_ioctl_set_p2p_noa::wal_check_and_release_msg_resp_etc fail[%d]!}",
                         ul_err_code);
        return -OAL_EFAIL;
    }
    ...
    mac_cfg_p2p_ops_param_stru *pst_p2p_ops_param)
{
    ...
    if ((l_ret != OAL_SUCC) || (pst_rsp_msg == OAL_PTR_NULL)) {
        OAM_ERROR_LOG1(0, OAM_SF_P2P, "{wal_ioctl_set_p2p_ops:: wal_alloc_cfg_event_etc return err code %d!}", l_ret);
        return l_ret;
    }
    ...
    ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_P2P, "{wal_ioctl_set_p2p_ops::wal_check_and_release_msg_resp_etc fail[%d]!}",
                         ul_err_code);
        return -OAL_EFAIL;
    }
    ...
    hmac_cfg_qos_map_param_stru *pst_qos_map_param)
{
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   &pst_rsp_msg);
    if ((l_ret != OAL_SUCC) || (pst_rsp_msg == OAL_PTR_NULL)) {
        OAM_ERROR_LOG1(0, OAM_SF_HS20, "{wal_ioctl_set_qos_map:: wal_alloc_cfg_event_etc return err code %d!}", l_ret);
        return l_ret;
    }
    ...
    ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_HS20, "{wal_ioctl_set_qos_map::wal_check_and_release_msg_resp_etc fail[%x!}",
                         ul_err_code);
        return -OAL_EFAIL;
    }
    return OAL_SUCC;
...
OAL_STATIC oal_uint32 wal_get_parameter_from_cmd(oal_int8 *pc_cmd, oal_int8 *pc_arg,
    OAL_CONST oal_int8 *puc_token, oal_uint32 *pul_cmd_offset, oal_uint32 ul_param_max_len)
{
    oal_int8 *pc_cmd_copy = OAL_PTR_NULL;
...
OAL_STATIC oal_int32 wal_set_ap_max_user(oal_net_device_stru *pst_net_dev, oal_uint32 ul_ap_max_user)
{
    ...
    *((oal_uint32 *)st_write_msg.auc_value) = ul_ap_max_user;
    ...
    if ((l_ret != OAL_SUCC) || (pst_rsp_msg == OAL_PTR_NULL)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_set_ap_max_user:: wal_send_cfg_event_etc return err code %d!}", l_ret);
    ...
    ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_set_ap_max_user::wal_check_and_release_msg_resp_etc fail[%d]!}",
                         ul_err_code);
        return -OAL_EFAIL;
    }
...
OAL_STATIC oal_void wal_config_mac_filter(oal_net_device_stru *pst_net_dev, oal_int8 *pc_command)
{
    ...
    if (ul_mac_mode > 2) {
        OAM_WARNING_LOG4(0, OAM_SF_ANY, "{wal_config_mac_filter::invalid MAC_MODE[%c%c%c%c]!}",
            ...
            (oal_uint8)ac_parsed_command[2], (oal_uint8)ac_parsed_command[3]); /* 2 3 cmd para */
        return;
    }
    ...
    for (ul_i = 0; ul_i < ul_mac_cnt; ul_i++) {
        ...
        /* 6.1  发送消息 */
        l_ret = wal_send_cfg_event_etc(pst_net_dev, WAL_MSG_TYPE_WRITE,
            WAL_MSG_WRITE_MSG_HDR_LENGTH + us_len, (oal_uint8 *)&st_write_msg, OAL_TRUE, &pst_rsp_msg);
        if ((l_ret != OAL_SUCC) || (pst_rsp_msg == OAL_PTR_NULL)) {
            OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_config_mac_filter:: wal_send_cfg_event_etc err %d!}", l_ret);
            return;
        }
        ...
        ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
        if (ul_err_code != OAL_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_config_mac_filter::wal_check_and_release_msg_resp_etc fail[%x]!}",
                             ul_err_code);
            return;
        }
#endif
    ...
    oal_uint8 *auc_mac_addr, oal_uint8 uc_mac_addr_len, oal_uint16 us_reason_code)
{
    ...
    if ((l_ret != OAL_SUCC) || (pst_rsp_msg == OAL_PTR_NULL)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_kick_sta:: wal_send_cfg_event_etc return err code %d!}", l_ret);
        return l_ret;
    }
...
{
    oal_int8 *pc_command = OAL_PTR_NULL;
    oal_int8 *pc_parse_cmd = OAL_PTR_NULL;
    oal_int32 l_ret = OAL_SUCC;
    oal_uint32 ul_ret, ul_off_set;
    oal_int8 ac_cmd[WAL_IOCTL_PRIV_SUBCMD_MAX_LEN];
    ...
    g_st_ap_config_info.ul_ap_max_user = (oal_uint32)oal_atoi(ac_cmd);
    if (OAL_NET_DEV_PRIV(pst_net_dev) != OAL_PTR_NULL) {
        l_ret = wal_set_ap_max_user(pst_net_dev, (oal_uint32)oal_atoi(ac_cmd));
    }
    ...
    oal_iw_request_info_stru *pst_info, oal_iwreq_data_union *pst_wrqu, char *pc_extra)
{
    ...
    /* 发送消息 */
    l_ret = wal_send_cfg_event_etc(pst_net_dev, WAL_MSG_TYPE_QUERY,
        WAL_MSG_WID_LENGTH, (oal_uint8 *)&st_query_msg, OAL_TRUE, &pst_rsp_msg);
    ...
    if (pst_query_rsp_msg->us_len >= OAL_SIZEOF(oal_netbuf_stru *)) {
        ...
        if (pst_rsp_netbuf != NULL) {
            /* 保存ap保存的sta地址信息 */
            pc_sta_list = (oal_int8 *)OAL_NETBUF_DATA(pst_rsp_netbuf);
            pst_wrqu->data.length = (oal_uint16)(OAL_NETBUF_LEN(pst_rsp_netbuf) + 1);
    ...
    oal_iw_request_info_stru *pst_info, oal_iwreq_data_union *pst_wrqu, char *pc_extra)
{
    ...
    oal_int8   ac_parsed_command[WAL_IOCTL_PRIV_SUBCMD_MAX_LEN];
    oal_int8  *pc_parse_command = OAL_PTR_NULL;
    oal_uint32 ul_mac_mode, ul_mac_cnt, ul_off_set;
...
oal_uint32 wal_hipriv_get_mac_addr_etc(oal_int8 *pc_param,
    oal_uint8 auc_mac_addr[], oal_uint32 *pul_total_offset)
{
    oal_uint32 ul_off_set = 0;
    oal_uint32 ul_ret ;
    oal_int8 ac_name[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_get_mac_addr_etc::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_EDCA, "{wal_hipriv_set_edca_opt_switch_sta::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    *puc_value = uc_flag;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_EDCA, "{wal_hipriv_set_edca_opt_switch_sta:: err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
                                               ...
                                               oal_int8 *pc_param, wlan_cfgid_enum_uint16 cfgid)
{
    ...
    *(oal_uint32 *)(st_write_msg.auc_value) = set_value;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_send_cfg_uint32_data_etc:send_cfg_event return[%d]}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_bgscan_enable(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    *pen_bgscan_enable_flag = (oal_uint8)oal_atoi(ac_stop);
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   OAL_PTR_NULL);
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_bgscan_enable::wal_send_cfg_event_etc fail.err[%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
    ...
    oal_int8 *pc_param)
{
    ...
    *pen_dhcp_req_disable_flag = (oal_bool_enum_uint8)oal_atoi(ac_stop);
    ...
    OAM_WARNING_LOG1(0, OAM_SF_ANY,
        "wal_hipriv_dhcp_req_disable_switch:: pen_dhcp_req_disable_flag:%d", *pen_dhcp_req_disable_flag);
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev, WAL_MSG_TYPE_WRITE,
                                   ...
                                   OAL_FALSE, OAL_PTR_NULL);
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_dhcp_req_disable_switch::send_cfg_event fail.err[%d]}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_ioctl_set_sta_ps_mode_etc(oal_net_device_stru *pst_cfg_net_dev,
    oal_int8 uc_ps_mode)
{
    wal_msg_write_stru st_write_msg;
    oal_int32 l_ret;
...
OAL_STATIC oal_uint32 wal_ioctl_set_fast_sleep_para_etc(oal_net_device_stru *pst_cfg_net_dev,
    oal_int8 *pc_param)
{
    wal_msg_write_stru st_write_msg;
    oal_int32 l_ret;
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_PWR, "{wal_ioctl_set_fast_sleep_para_etc::return err code [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
oal_int32 wal_start_vap_etc(oal_net_device_stru *pst_net_dev)
{
    ...
    if (OAL_UNLIKELY(pst_net_dev == OAL_PTR_NULL)) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_start_vap_etc::pst_net_dev null!}");
        return -OAL_EFAUL;
    }
    ...
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_start_vap_etc::en_p2p_mode:%d}", en_p2p_mode);
#endif
    ((mac_cfg_start_vap_param_stru *)st_write_msg.auc_value)->en_mgmt_rate_init_flag = OAL_TRUE;
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   &pst_rsp_msg);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_start_vap_etc::wal_alloc_cfg_event_etc return err code %d!}", l_ret);
        return l_ret;
    }
    /* 处理返回消息 */
    ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_start_vap_etc::hmac start vap fail, err code[%d]!}", ul_err_code);
        return -OAL_EINVAL;
    }
    if ((OAL_NETDEVICE_FLAGS(pst_net_dev) & OAL_IFF_RUNNING) == 0) {
        OAL_NETDEVICE_FLAGS(pst_net_dev) |= OAL_IFF_RUNNING;
...
oal_int32 wal_stop_vap_etc(oal_net_device_stru *pst_net_dev)
{
    ...
    if (OAL_UNLIKELY(pst_net_dev == OAL_PTR_NULL)) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_stop_vap_etc::pst_net_dev null!}");
        return -OAL_EFAUL;
    }
    ...
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_stop_vap_etc::en_p2p_mode:%d}", en_p2p_mode);
#endif
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   &pst_rsp_msg);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_stop_vap_etc::wal_alloc_cfg_event_etc return err code %d!}", l_ret);
        return l_ret;
    }
...
oal_int32 wal_init_WiTAS_state(oal_void)
{
    ...
    if ((aen_tas_switch_en[WLAN_RF_CHANNEL_ZERO] == OAL_FALSE) &&
        (aen_tas_switch_en[WLAN_RF_CHANNEL_ONE] == OAL_FALSE)) {
...
OAL_STATIC oal_void wal_init_probe_resp_status(mac_cfg_add_vap_param_stru *write_msg)
{
    oal_int32 ini_probe_resp_mode;
    ...
    if (hmac_get_feature_switch(HMAC_MIRACAST_SINK_SWITCH)) {
        ini_probe_resp_mode = hwifi_get_init_value_etc(CUS_TAG_INI, WLAN_CFG_INIT_PROBE_RESP_MODE);
        probe_resp_enable  = !!(OAL_MASK(4, 4) & (oal_uint32)ini_probe_resp_mode);
        probe_resp_status  = (OAL_MASK(4, 0) & (oal_uint32)ini_probe_resp_mode);
...
oal_int32 wal_init_wlan_vap_etc(oal_net_device_stru *pst_net_dev)
{
    ...
    if (pst_mac_vap != NULL) {
        ...
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_init_wlan_vap_etc::pst_mac_vap is already free!}");
    ...
    snprintf_s(ac_wlan_netdev_name, NET_DEV_NAME_LEN, NET_DEV_NAME_LEN - 1, "wlan%d", pst_mac_device->uc_device_id);
    snprintf_s(ac_p2p_netdev_name, NET_DEV_NAME_LEN, NET_DEV_NAME_LEN - 1, "p2p%d", pst_mac_device->uc_device_id);
    snprintf_s(ac_hwlan_netdev_name, NET_DEV_NAME_LEN, NET_DEV_NAME_LEN - 1, "hwlan%d", pst_mac_device->uc_device_id);
    ...
    if (OAL_ANY_NULL_PTR2(pst_cfg_mac_vap, pst_cfg_hmac_vap)) {
        OAM_WARNING_LOG4(0, OAM_SF_ANY,
            "{wal_init_wlan_vap_etc::pst_cfg_mac_vap[%p] or pst_cfg_hmac_vap[%p] is null! vap_id:%d,deviceid[%d]}",
    ...
    if ((NL80211_IFTYPE_STATION == pst_wdev->iftype) || (NL80211_IFTYPE_P2P_DEVICE == pst_wdev->iftype)) {
        if (OAL_ANY_ZERO_VALUE2(oal_strcmp(ac_wlan_netdev_name, pst_net_dev->name),
            oal_strcmp(ac_hwlan_netdev_name, pst_net_dev->name))) {
...
#ifdef _PRE_WLAN_FEATURE_P2P
    OAM_WARNING_LOG2(0, OAM_SF_ANY, "{wal_init_wlan_vap_etc::vap_mode:%d, p2p_mode:%d}", en_vap_mode, en_p2p_mode);
#endif
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(pst_cfg_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_init_wlan_vap_etc::return err:%d!}", l_ret);
        return -OAL_EFAIL;
    }
    ...
    ul_err_code = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
        OAM_WARNING_LOG1(pst_cfg_mac_vap->uc_vap_id, 0, "{wal_init_wlan_vap_etc::hmac add vap fail[%u]}", ul_err_code);
        return -OAL_EFAIL;
    }

#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
    if (OAL_SUCC != wal_set_random_mac_to_mib_etc(pst_net_dev)) {
        OAM_WARNING_LOG0(pst_cfg_mac_vap->uc_vap_id, 0, "{wal_init_wlan_vap_etc::set_random_mac_to_mib fail}");
        return -OAL_EFAUL;
    }
#endif
    ...
    pst_mac_vap = OAL_NET_DEV_PRIV(pst_net_dev);
    if (pst_mac_vap == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_init_wlan_vap_etc::OAL_NET_DEV_PRIV(pst_net_dev) null.}");
        return -OAL_EINVAL;
    }
...
oal_int32 wal_deinit_wlan_vap_etc(oal_net_device_stru *pst_net_dev)
{
    ...
    if (pst_mac_dev == OAL_PTR_NULL) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "wal_deinit_wlan_vap_etc::get mac dev id[%d] FAIL", pst_mac_vap->uc_device_id);
        return -OAL_EFAIL;
    }
    /* 通过device id获取netdev名字 */
    snprintf_s(ac_wlan_netdev_name, MAC_NET_DEVICE_NAME_LENGTH, MAC_NET_DEVICE_NAME_LENGTH - 1,
...
#ifdef _PRE_WLAN_FEATURE_P2P
    OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_deinit_wlan_vap_etc::en_p2p_mode:%d}", en_p2p_mode);
#endif
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_deinit_wlan_vap_etc::return error code %d}", l_ret);
...
OAL_STATIC oal_void wal_set_netdev_priv(oal_netdev_priv_stru *pst_netdev_priv)
{
...
OAL_STATIC oal_void wal_init_wlan_netdev_set_netdev_etc(oal_net_device_stru *pst_net_dev, oal_wireless_dev_stru *pst_wdev)
{
...
oal_int32 wal_init_wlan_netdev_etc(oal_wiphy_stru *pst_wiphy, const char *dev_name)
{
    ...
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_init_wlan_netdev_etc::en_type is %d}", en_type);

    /* 如果创建的net device已经存在，直接返回 */
    /* 根据dev_name找到dev */
    pst_net_dev = wal_config_get_netdev_etc(dev_name, OAL_STRLEN(dev_name));
    if (pst_net_dev != OAL_PTR_NULL) {
        /* 调用oal_dev_get_by_name后，必须调用oal_dev_put使net_dev的引用计数减一 */
        oal_dev_put(pst_net_dev);
    ...
    pst_net_dev = oal_net_alloc_netdev_mqs(OAL_SIZEOF(oal_netdev_priv_stru),
        dev_name, oal_ether_setup, WAL_NETDEV_SUBQUEUE_MAX_NUM, 1);
#elif defined(_PRE_WLAN_FEATURE_OFFLOAD_FLOWCTL)
    /* 此函数第一个入参代表私有长度，此处不涉及为0 */
    pst_net_dev = oal_net_alloc_netdev_mqs(OAL_SIZEOF(oal_netdev_priv_stru),
    ...
    pst_wdev = (oal_wireless_dev_stru *)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
        OAL_SIZEOF(oal_wireless_dev_stru), OAL_FALSE);
    if (OAL_UNLIKELY(pst_wdev == OAL_PTR_NULL)) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_init_wlan_netdev_etc::alloc mem, pst_wdev null!}");
        oal_net_free_netdev(pst_net_dev);
        return OAL_ERR_CODE_PTR_NULL;
    }

    memset_s(pst_wdev, OAL_SIZEOF(oal_wireless_dev_stru), 0, OAL_SIZEOF(oal_wireless_dev_stru));
    wal_init_wlan_netdev_set_netdev_etc(pst_net_dev, pst_wdev);
    pst_wdev->netdev = pst_net_dev;
    ...
    if (OAL_SUCC != wal_set_mac_addr(pst_net_dev)) {
        OAM_WARNING_LOG0(0, OAM_SF_ANY, "{wal_init_wlan_netdev_etc::set mac addr fail}");
    }
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_init_wlan_netdev_etc::hmac_net_register_netdev err:%d!}", l_ret);
...
oal_uint32 wal_hipriv_unregister_inetaddr_notifier_etc(oal_void)
{
    ...
    OAM_ERROR_LOG0(0, 0, "{wal_hipriv_unregister_inetaddr_notifier_etc::hmac_unregister inetaddr notifier fail}");
    return OAL_FAIL;
...
oal_uint32 wal_hipriv_unregister_inet6addr_notifier_etc(oal_void)
{
    ...
    OAM_ERROR_LOG0(0, OAM_SF_PWR, "{wal_hipriv_unregister_inet6addr_notifier_etc::unreg inetaddr6 notifier fail}");
    return OAL_FAIL;
...
oal_int32 wal_hipriv_inetaddr_notifier_call_etc(struct notifier_block *this, oal_uint event, oal_void *ptr)
{
    ...
    if (OAL_UNLIKELY(pst_mac_vap == NULL)) {
        OAM_WARNING_LOG1(0, OAM_SF_PWR, "{wal_hipriv_inetaddr_notifier_call_etc::Get mac vap failed, \
            when %d(UP:1 DOWN:2 UNKNOWN:others) ipv4 address.}", event);
        return NOTIFY_DONE;
    }

    if (ipv4_is_linklocal_169(pst_ifa->ifa_address)) {
        OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_PWR, "{wal_hipriv_inetaddr_notifier_call_etc:: \
            Invalid IPv4[%d.X.X.%d], MASK[0x%08X].}", ((oal_uint8 *)&(pst_ifa->ifa_address))[0],
            ((oal_uint8 *)&(pst_ifa->ifa_address))[3], pst_ifa->ifa_mask); /* 3 netaddr */
        return NOTIFY_DONE;
    }
    ...
    switch (event) {
        case NETDEV_UP: {
            OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_PWR, "{wal_hipriv_inetaddr_notifier_call_etc:: \
                Up IPv4[%d.X.X.%d], MASK[0x%08X].}", ((oal_uint8 *)&(pst_ifa->ifa_address))[0],
                ((oal_uint8 *)&(pst_ifa->ifa_address))[3], pst_ifa->ifa_mask); /* 3 netaddr */
            hmac_arp_offload_set_ip_addr_etc(pst_mac_vap, DMAC_CONFIG_IPV4,
            ...
            if (pst_mac_vap->en_vap_mode == WLAN_VAP_MODE_BSS_STA) {
                ...
                if (pst_hmac_vap == OAL_PTR_NULL) {
                    OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG,
                        "{wal_hipriv_inetaddr_notifier_call_etc::hmac_vap null.vap[%d]}", pst_mac_vap->uc_vap_id);
                ...
                if ((pst_hmac_vap->uc_ps_mode == MAX_FAST_PS) || (pst_hmac_vap->uc_ps_mode == AUTO_FAST_PS)) {
                    wlan_pm_set_timeout_etc((wlan_min_fast_ps_idle > 1) ?
                        (wlan_min_fast_ps_idle - 1) : wlan_min_fast_ps_idle);
                } else {
        ...
        case NETDEV_DOWN: {
...
#endif
            OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_PWR, "{wal_hipriv_inetaddr_notifier_call_etc::\
                Down IPv4[%d.X.X.%d], MASK[0x%08X]..}", ((oal_uint8 *)&(pst_ifa->ifa_address))[0],
                ((oal_uint8 *)&(pst_ifa->ifa_address))[3], pst_ifa->ifa_mask); /* 3 netaddr */
            hmac_arp_offload_set_ip_addr_etc(pst_mac_vap, DMAC_CONFIG_IPV4, DMAC_IP_ADDR_DEL,
            ...
            if (pst_mac_vap->en_vap_mode == WLAN_VAP_MODE_BSS_STA) {
                ...
                if (pst_hmac_vap == OAL_PTR_NULL) {
                    OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG,
                        "{wal_hipriv_inetaddr_notifier_call_etc::hmac_vap null.[%d]}", pst_mac_vap->uc_vap_id);
...
oal_int32 wal_hipriv_inet6addr_notifier_call_etc(struct notifier_block *this, oal_uint event, oal_void *ptr)
{
    ...
    if (OAL_UNLIKELY(pst_mac_vap == NULL)) {
        OAM_WARNING_LOG1(0, OAM_SF_PWR,
            "{wal_hipriv_inet6addr_notifier_call_etc::vap null,when %d(UP:1 DOWN:2 UNKNOWN:others) ipv6 addr}", event);
        return NOTIFY_DONE;
    }
    ...
    switch (event) {
        case NETDEV_UP: {
            OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_PWR,
                "{wal_hipriv_inet6addr_notifier_call_etc::UP IPv6[%04x:%04x:XXXX:XXXX:XXXX:XXXX:%04x:%04x].}",
            ...
            hmac_arp_offload_set_ip_addr_etc(pst_mac_vap, DMAC_CONFIG_IPV6, DMAC_IP_ADDR_ADD,
        ...
        case NETDEV_DOWN: {
            OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_PWR,
                "{wal_hipriv_inet6addr_notifier_call_etc::DOWN IPv6[%04x:%04x:XXXX:XXXX:XXXX:XXXX:%04x:%04x].}",
                OAL_NET2HOST_SHORT((pst_ifa->addr.s6_addr16)[0]), OAL_NET2HOST_SHORT((pst_ifa->addr.s6_addr16)[1]),
                OAL_NET2HOST_SHORT((pst_ifa->addr.s6_addr16)[6]),  /* 6 net6addr */
                OAL_NET2HOST_SHORT((pst_ifa->addr.s6_addr16)[7])); /* 7 net6addr */
            hmac_arp_offload_set_ip_addr_etc(pst_mac_vap, DMAC_CONFIG_IPV6, DMAC_IP_ADDR_DEL,
                &(pst_ifa->addr), &(pst_ifa->addr));
            break;
        }

        default: {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, 0, "{wal_hipriv_inet6addr_notifier_call_etc::event:%d}", event);
            break;
        }
    }
    ...
    for (uc_cfg_id = VOWIFI_SET_MODE; uc_cfg_id < VOWIFI_CMD_BUTT; uc_cfg_id++) {
        if ((0 == oal_strncmp(puc_command, g_ast_vowifi_cmd_table[uc_cfg_id].pc_priv_cmd,
            ...
            uc_param = (oal_uint8)oal_atoi((oal_int8*)puc_command +
                OAL_STRLEN((oal_uint8 *)g_ast_vowifi_cmd_table[uc_cfg_id].pc_priv_cmd) + 1);
...
#ifdef _PRE_WLAN_FEATURE_HIEX
    pst_mac_dev = mac_res_get_dev_etc(pst_hmac_vap->st_vap_base_info.uc_device_id);
...
oal_int32 wal_set_assigned_filter_enable_etc(oal_int32 l_filter_id, oal_int32 l_on)
{
    ...
    if (l_on < 0) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_set_assigned_filter_enable_etc::Invalid input, on/off %d!}", l_on);
        return -OAL_EINVAL;
    }
    ...
    if (pst_mac_vap->st_cap_flag.bit_icmp_filter != OAL_TRUE) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_set_assigned_filter_enable_etc::Func not enable!}");
        return -OAL_EINVAL;
    }
    ...
    OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
        "{wal_set_assigned_filter_enable_etc::assigned_filter on/off(%d)}", st_assigned_filter_cmd.en_enable);
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
            "{wal_set_assigned_filter_enable_etc::send cfg event fail[%d]!}", l_ret);
        return l_ret;
    }
...
oal_int32 wal_set_ip_filter_enable_etc(oal_int32 l_on)
{
    ...
    if (pst_mac_vap->st_cap_flag.bit_ip_filter != OAL_TRUE) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_set_ip_filter_enable_etc::Func not enable,ignore!}");
        return -OAL_EINVAL;
    }
    ...
    if (pst_netbuf == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
            "{wal_set_ip_filter_enable_etc::netbuf alloc null,size %d.}", ul_netbuf_len);
        return -OAL_EINVAL;
    }
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + us_len, (oal_uint8 *)&st_write_msg, OAL_FALSE, OAL_PTR_NULL);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, 0, "{wal_set_ip_filter_enable_etc::send_cfg_event fail:%d}", l_ret);
        oal_netbuf_free(pst_netbuf);
        return l_ret;
    }
...
oal_int32 wal_add_ip_filter_items_etc(wal_hw_wifi_filter_item *pst_items, oal_int32 l_count)
{
    ...
    if ((pst_items == OAL_PTR_NULL) || (l_count <= 0)) {
        OAM_ERROR_LOG2(0, OAM_SF_ANY, "{wal_add_ip_filter_items_etc::Invalid input para, pst_items %p, l_count %d!}",
    ...
    if (pst_mac_vap->st_cap_flag.bit_ip_filter != OAL_TRUE) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_add_ip_filter_items_etc::Func disable, ignore cmd}");
        return -OAL_EINVAL;
    }
    ...
    if (st_ip_filter_cmd.uc_item_count < l_count) {
        OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
            "{wal_add_ip_filter_items_etc::Btable(%d) is too small to store %d items!}",
            st_ip_filter_cmd.uc_item_count, l_count);
    }

    OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
        "{wal_add_ip_filter_items_etc::Start updating btable, items_cnt(%d).}",
        st_ip_filter_cmd.uc_item_count);
    ...
    if (pst_netbuf == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
            "{wal_add_ip_filter_items_etc::netbuf alloc null,size %d.}", ul_netbuf_len);
        return -OAL_EINVAL;
    }
    memset_s(((oal_uint8 *)OAL_NETBUF_DATA(pst_netbuf)), ul_netbuf_len, 0, ul_netbuf_len);
    pst_cmd_info = (mac_ip_filter_cmd_stru *)OAL_NETBUF_DATA(pst_netbuf);
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
            "{wal_add_ip_filter_items_etc::wal_send_cfg_event_etc fail[%d]!}", l_ret);
        oal_netbuf_free(pst_netbuf);
        return l_ret;
    }
...
oal_int32 wal_clear_ip_filter_etc()
{
    ...
    if (pst_mac_vap->st_cap_flag.bit_ip_filter != OAL_TRUE) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_clear_ip_filter_etc::Func disable,ignore the cmd}");
        return -OAL_EINVAL;
    }
    ...
    pst_netbuf = OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, ul_netbuf_len, OAL_NETBUF_PRIORITY_MID);
    if (pst_netbuf == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, 0, "{wal_clear_ip_filter_etc::netbuf[%d] alloc fail}", ul_netbuf_len);
        return -OAL_EINVAL;
    }
    memset_s(((oal_uint8 *)OAL_NETBUF_DATA(pst_netbuf)), ul_netbuf_len, 0, ul_netbuf_len);
    pst_cmd_info = (mac_ip_filter_cmd_stru *)OAL_NETBUF_DATA(pst_netbuf);
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   OAL_PTR_NULL);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_clear_ip_filter_etc::send cfg event fail:%d}", l_ret);
        oal_netbuf_free(pst_netbuf);
        return l_ret;
    }
...
OAL_STATIC oal_int32 wal_ioctl_set_probe_resp_mode(oal_bool_enum_uint8 en_light_suspend)
{
    oal_uint16 us_len;
    oal_int32 l_ret;
    mac_vap_stru *pst_mac_vap = OAL_PTR_NULL;
    ...
    /* 查找p2p dev */
    pst_net_dev = wal_config_get_netdev_etc("p2p0", OAL_STRLEN("p2p0"));
    if (pst_net_dev == OAL_PTR_NULL) {
    ...
    /* 将申请的netbuf首地址填写到msg消息体内 */
    if (EOK != memcpy_s(st_write_msg.auc_value, us_len, (oal_uint8 *)&en_probe_resp_status, us_len)) {
...
oal_int32 wlan_enter_light_suspend()
{
...
oal_int32 wlan_exit_light_suspend()
{
...
oal_void wal_register_lights_suspend()
{
#ifdef _PRE_PRODUCT_HI3751V811
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 9, 0)) && (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    PMOC_LIGHT_SUSPEND_CB_FUNC_S stLightSuspendCb;

    stLightSuspendCb.u32ModuleID = (oal_uint32)HI_ID_USER;
...
oal_void wal_unregister_lights_suspend()
{
#ifdef _PRE_PRODUCT_HI3751V811
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 9, 0)) && (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    PMOC_DRV_LightSuspendCallbackUnregister((oal_uint32)HI_ID_USER);
#endif // #if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 9, 0))
...
#endif
oal_module_symbol(wal_hipriv_get_mac_addr_etc); /*lint +e19*/
...
OAL_STATIC oal_uint32 wal_hipriv_auto_cali(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    pst_mac_device = mac_res_get_dev_etc(pst_mac_vap->uc_device_id);
    if (pst_mac_device == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_SCAN, "{wal_hipriv_auto_cali::mac_res_get_dev_etc fail.dev:%u}",
            pst_mac_vap->uc_device_id);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++) {
        ...
        if (pst_vap->en_vap_state != MAC_VAP_STATE_INIT) {
            OAM_ERROR_LOG2(0, OAM_SF_ANY, "{wal_hipriv_auto_cali::device busy,down it first,vap[%d],state:%d}",
    ...
    *(st_write_msg.auc_value) = uc_cali_type;
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_auto_cali::cali type = %x!}", uc_cali_type);
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_auto_cali::return err code %d!}", l_ret);
        return (oal_uint32)l_ret;
    }
    ...
    ul_ret = wal_check_and_release_msg_resp_etc(pst_rsp_msg);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_DFR, "{wal_hipriv_auto_cali fail, err code[%u]!}", ul_ret);
        return ul_ret;
    }

    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_auto_cali::wal_send_cfg_event_etc err [%d]!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_set_cali_vref(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_arg, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_cali_ref::wal_get_cmd_one_arg_etc vap name err %d!}", ul_ret);
        return ul_ret;
    }
    ...
    OAL_IO_PRINT("chain(%d):us_cali_ref(%d) = %u.", uc_chain_idx, uc_band_idx, us_vref_value);
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   OAL_PTR_NULL);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_cali_ref::return err code %d!}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_wds_vap_mode(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_vap_mode::get cmd one arg err%d!}", ul_ret);
        return ul_ret;
    }
    ...
    *((oal_uint8 *)(st_write_msg.auc_value)) = uc_wds_vap_mode; /* 获取WDS模式 */
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_vap_mode::return err code %d!}", ul_ret);
    }
...
OAL_STATIC oal_uint32 wal_hipriv_wds_vap_show(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_vap_show::return err code %d!}", ul_ret);
    }
...
OAL_STATIC oal_uint32 wal_hipriv_wds_sta_add(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_sta_add::wal_get_cmd_one_arg_etc 1 err %d!}", ul_ret);
        return ul_ret;
    }
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_sta_add::wal_get_cmd_one_arg_etc 2 err %d!}", ul_ret);
        return ul_ret;
    }
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_sta_add::return err code %d!}", ul_ret);
    }
...
OAL_STATIC oal_uint32 wal_hipriv_wds_sta_del(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_sta_del::get cmd one arg err%d!}", ul_ret);
        return ul_ret;
    }
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_sta_del::return err code %d!}", ul_ret);
    }
...
OAL_STATIC oal_uint32 wal_hipriv_wds_sta_age(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    oal_int8 ac_name[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    oal_uint32 ul_ret;
    oal_uint32 ul_sta_aging;

    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_sta_age::get cmd one arg err%d!}", ul_ret);
        return ul_ret;
    }
    ...
    *((oal_uint32 *)(st_write_msg.auc_value)) = ul_sta_aging; /* 获取WDS模式 */
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_wds_sta_age::return err code %d!}", ul_ret);
    }
...
OAL_STATIC oal_uint32 wal_hipriv_rssi_limit(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    pc_param = pc_param + ul_off_set;
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_rssi_limit::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    switch (pst_rssi_limit->en_rssi_limit_type) {
        ...
        case MAC_RSSI_LIMIT_THRESHOLD:
            ...
            if (pst_rssi_limit->c_rssi > WLAN_FAR_DISTANCE_RSSI) {
                OAM_WARNING_LOG2(0, OAM_SF_ANY, "{wal_hipriv_rssi_limit::rssi[%d],exceed WLAN_FAR_DISTANCE_RSSI[%d]}",
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CAR, "{wal_hipriv_rssi_limit::return err code [%d]!}", ul_ret);
        return (oal_uint32)ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_report_product_log_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    pc_param = pc_param + ul_off_set;
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_report_product_log_cfg::wal_get_cmd_one_arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if ((uc_flag != 0) && (uc_flag != 1) && (uc_flag != 2)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_report_product_log_cfg:: input invalid[%d]}", uc_flag);
        return OAL_FAIL;
    }

    *pst_product_log_param = uc_flag;

    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_report_product_log_cfg:: param=%d}", *pst_product_log_param);
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_report_product_log_cfg::return err code [%d]!}", ul_ret);
        return (oal_uint32)ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_tcp_ack_buf_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (pst_tcp_ack_param->en_cmd == MAC_TCP_ACK_BUF_ENABLE) {
        if (((oal_uint8)l_tmp == OAL_FALSE) || ((oal_uint8)l_tmp == OAL_TRUE)) {
            ...
            OAM_WARNING_LOG1(0, OAM_SF_CFG, "{wal_hipriv_tcp_ack_buf_cfg::fast_aging_flag[%d]:0/1}", (oal_uint8)l_tmp);
            return OAL_FAIL;
        }
    }
...
OAL_STATIC oal_uint32 wal_hipriv_fast_aging_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    pc_param = pc_param + ul_off_set;
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CAR, "{wal_hipriv_fast_aging_cfg::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    // 参数需要 >= 0 且< 10*1000
    if ((l_tmp < 0) || (l_tmp > 10 * 1000)) {
        OAM_WARNING_LOG1(0, OAM_SF_CAR, "{wal_hipriv_fast_aging_cfg::  car param[%d] invalid! }", oal_atoi(ac_name));
        return OAL_FAIL;
    }
    ...
    if (pst_aging_cfg_param->en_cmd == MAC_FAST_AGING_ENABLE) {
        if (((oal_uint8)l_tmp == OAL_FALSE) || ((oal_uint8)l_tmp == OAL_TRUE)) {
            ...
            OAM_WARNING_LOG1(0, OAM_SF_CAR, "{wal_hipriv_fast_aging_cfg::fast_aging_flag[%d] err}", (oal_uint8)l_tmp);
            return OAL_FAIL;
        }
    }
    ...
    OAM_WARNING_LOG4(0, OAM_SF_CAR, "{wal_hipriv_fast_aging_cfg::cmd[%d], fast_aging[%d], timer[%d] count_limit[%d]!}",
                     pst_aging_cfg_param->en_cmd, pst_aging_cfg_param->en_enable,
                     pst_aging_cfg_param->us_timeout_ms, pst_aging_cfg_param->uc_count_limit);
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CAR, "{wal_hipriv_fast_aging_cfg::return err code [%d]!}", ul_ret);
        return (oal_uint32)ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_car_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    memset_s((oal_void *)pst_car_cfg_param, OAL_SIZEOF(mac_cfg_car_stru), 0, OAL_SIZEOF(mac_cfg_car_stru));

    // 获取device 或者 vap 或者 user 或者 timer 或者 enable
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    pc_param = pc_param + ul_off_set;
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CAR, "{wal_hipriv_car_cfg::get cmd one arg err[%d]!}", ul_ret);
        return ul_ret;
    }
    ...
    if ((pst_car_cfg_param->en_car_flag == MAC_CAR_DEVICE_LIMIT) ||
        (pst_car_cfg_param->en_car_flag == MAC_CAR_VAP_LIMIT) ||
        (pst_car_cfg_param->en_car_flag == MAC_CAR_USER_LIMIT)) {
        ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
        pc_param = pc_param + ul_off_set;
    ...
    if ((pst_car_cfg_param->en_car_flag != MAC_CAR_SHOW_INFO)) {
        ...
        if ((0 > oal_atoi(ac_name)) || (1000 * 1024 < oal_atoi(ac_name))) {
            OAM_WARNING_LOG1(0, OAM_SF_CAR, "{wal_hipriv_car_cfg::  car param[%d] invalid! }", oal_atoi(ac_name));
            return OAL_FAIL;
        }
    ...
    OAM_WARNING_LOG4(0, OAM_SF_CAR, "{wal_hipriv_car_cfg::car_flag[%d], car_up_down_type[%d], timer[%d] kbps[%d]!}",
        pst_car_cfg_param->en_car_flag, pst_car_cfg_param->uc_car_up_down_type,
        pst_car_cfg_param->us_car_timer_cycle_ms, pst_car_cfg_param->ul_bw_limit_kbps);
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_CAR, "{wal_hipriv_car_cfg::return err code [%d]!}", ul_ret);
        return (oal_uint32)ul_ret;
    }
...
#ifdef _PRE_FEATURE_FAST_AGING
oal_int32 wal_ioctl_get_fast_aging(oal_net_device_stru *pst_net_dev,
    oal_iw_request_info_stru *pst_info, oal_void *p_param, oal_int8 *pc_extra)
{
    oal_int32 l_ret;
    ...
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_ioctl_get_ppm::return err code %d!}", l_ret);
        return -l_ret;
    }
    ...
    pst_hmac_vap = mac_res_get_hmac_vap(pst_mac_vap->uc_vap_id);
    if (pst_hmac_vap == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "wal_ioctl_get_param_char:hmac vap null");
        return 0;
    }
    ...
    /*lint -e730*/
    l_ret = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT((pst_hmac_vap->query_wait_q),
        (OAL_TRUE == pst_hmac_vap->auc_query_flag[QUERY_ID_FAST_AGING]), (5 * OAL_TIME_HZ)); /* 5 延时 */
    /*lint +e730*/
    if (l_ret <= 0) { /* 等待超时或异常 */
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "wal_ioctl_get_param_char:query rssi timeout:%d", l_ret);
    }
    ...
    oal_uint8 *puc_buf, oal_uint32 ul_buf_len, oal_uint8 uc_m2s_blacklist_cnt)
{
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   OAL_PTR_NULL);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_M2S, "{wal_ioctl_set_m2s_blacklist::wal_send_cfg_event_etc err[%d]}", l_ret);
        return (oal_uint32)l_ret;
    }
...
oal_uint32 wal_ioctl_set_m2s_mss(oal_net_device_stru *pst_net_dev, oal_uint8 uc_m2s_mode)
{
    ...
    *((oal_int32 *)(st_write_msg.auc_value)) = uc_m2s_mode; /* 设置配置命令参数 */
    ...
    l_ret = wal_send_cfg_event_etc(pst_net_dev,
                                   ...
                                   OAL_PTR_NULL);
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_M2S, "{wal_ioctl_set_m2s_mss::wal_send_cfg_event_etc err:[%d]}", l_ret);
        return (oal_uint32)l_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_remove_app_ie(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_remove_app_ie::wal_get_cmd_one_arg_etc err:%d!}", ul_ret);
        return ul_ret;
    }
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_remove_app_ie::wal_get_cmd_one_arg_etc eid err:%d!}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_pkt_time_switch(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = (oal_uint32)wal_send_cfg_event_etc(pst_net_dev, WAL_MSG_TYPE_WRITE,
...
oal_uint32 wal_vendor_cmd_modem_handle_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_command)
{
    wal_msg_write_stru  st_write_msg;
    oal_uint8           uc_modem_mode;
    oal_int32           l_ret;

    if (OAL_STRLEN(pc_command) < (OAL_STRLEN((oal_int8 *)CMD_SET_M2S_MODEM) + 2)) {
        OAM_WARNING_LOG0(0, OAM_SF_M2S, "{wal_vendor_cmd_modem_handle_etc::CMD_SET_M2S_MODEM command len error}");
        return -OAL_EFAIL;
    }

    uc_modem_mode = (oal_uint8)oal_atoi(pc_command + OAL_STRLEN((oal_int8 *)CMD_SET_M2S_MODEM) + 1);

    /* st_write_msg作清零操作 */
    memset_s(&st_write_msg, OAL_SIZEOF(wal_msg_write_stru), 0, OAL_SIZEOF(wal_msg_write_stru));

    /* 抛事件到wal层处理 */
    WAL_WRITE_MSG_HDR_INIT(&st_write_msg, WLAN_CFGID_SET_M2S_MODEM, OAL_SIZEOF(oal_int32));
    *((oal_int32 *)(st_write_msg.auc_value)) = uc_modem_mode; /* 设置配置命令参数 */
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_M2S,
            "{wal_vendor_cmd_modem_handle::wal_send_cfg_event_etc return err code = [%d].}", l_ret);
        return (oal_uint32)l_ret;
    }
...
#ifdef _PRE_WLAN_FEATURE_M2S_MODEM
    else if (0 == oal_strncasecmp(pc_command, CMD_SET_M2S_MODEM, OAL_STRLEN(CMD_SET_M2S_MODEM))) {
        l_ret = wal_vendor_cmd_modem_handle_etc(pst_net_dev, pc_command);
        if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
            return -OAL_EFAIL;
        }
    }
...
{
    oal_uint32 ul_ret;
    oal_uint8  auc_para_val[4]; /* 4 cmdpara */
    oal_uint8  auc_str_tmp[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    oal_uint32 pul_cmd_offset;
    oal_uint32 ul_para_cnt;
    ...
    if (!oal_strncasecmp(puc_para_str, "0", 1)) {
        ...
        /* 获取携带的4个参数<min listen时间><max listen时间><亮屏收发包门限><暗屏收发包门限> */
        for (ul_para_cnt = 0; ul_para_cnt < 4; ul_para_cnt++) {
            ul_ret = wal_get_cmd_one_arg_etc(puc_para_str, auc_str_tmp, WAL_HIPRIV_CMD_NAME_MAX_LEN, &pul_cmd_offset);
            if (ul_ret != OAL_SUCC) {
                OAM_WARNING_LOG2(0, OAM_SF_CFG, "{wal_ioctl_set_fastsleep_switch::get para[%d] fail, err_code[%d]}",
                    ul_para_cnt, ul_ret);
                return ul_ret;
            }
            auc_para_val[ul_para_cnt] = (oal_uint8)oal_atoi(auc_str_tmp);
        ...
        OAM_WARNING_LOG4(0, OAM_SF_CFG, "{wal_ioctl_set_fastsleep_switch::wlan_min_fast_ps_idle[%d], \
            max_fast_ps_idle[%d], auto_ps_thresh_screen_on[%d], auto_ps_thresh_screen_off!}", wlan_min_fast_ps_idle,
            wlan_max_fast_ps_idle, wlan_auto_ps_thresh_screen_on, wlan_auto_ps_thresh_screen_off);
#endif
        /* 下发参数 */
...
{
    oal_int8 *puc_para_str = OAL_PTR_NULL;
    oal_uint8 uc_rx_listen_ps_switch;
    oal_uint8 *puc_value;
    oal_int32 l_ret;
    wal_msg_write_stru st_write_msg;
    ...
    uc_rx_listen_ps_switch = (oal_uint8)oal_atoi(puc_para_str);
    ...
    /* 抛事件到wal层处理 */
    WAL_WRITE_MSG_HDR_INIT(&st_write_msg, WLAN_CFGID_RX_LISTEN_PS_SWITCH, OAL_SIZEOF(oal_uint8));
    /* 设置配置命令参数 */
    puc_value = (oal_uint8 *)st_write_msg.auc_value;
